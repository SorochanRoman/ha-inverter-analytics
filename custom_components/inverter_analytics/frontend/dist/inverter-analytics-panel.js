 ...
 */
const L = globalThis, q = L.ShadowRoot && (L.ShadyCSS === void 0 || L.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, V = Symbol(), J = /* @__PURE__ */ new WeakMap();
let ht = class {
  constructor(t, e, s) {
...
const ft = (r) => new ht(typeof r == "string" ? r : r + "", void 0, V), lt = (r, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: gt, defineProperty: yt, getOwnPropertyDescriptor: vt, getOwnPropertyNames: mt, getOwnPropertySymbols: At, getPrototypeOf: bt } = Object, j = globalThis, Y = j.trustedTypes, Et = Y ? Y.emptyScript : "", wt = j.reactiveElementPolyfillSupport, O = (r, t) => r, I = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? Et : null;
      break;
  ...
  return e;
} }, W = (r, t) => !gt(r, t), Q = { attribute: !0, type: String, converter: I, reflect: !1, useDefault: !1, hasChanged: W };
...
let E = class extends HTMLElement {
  ...
  requestUpdate(t, e, s, i = !1, n) {
    if (t !== void 0) {
      ...
      if (i === !1 && (n = this[t]), s ??= o.getPropertyOptions(t), !((s.hasChanged ?? W)(n, e) || s.useDefault && s.reflect && n === this._$Ej?.get(t) && !this.hasAttribute(o._$Eu(t, s)))) return;
      this.C(t, e, s);
    }
...
E.elementStyles = [], E.shadowRootOptions = { mode: "open" }, E[O("elementProperties")] = /* @__PURE__ */ new Map(), E[O("finalized")] = /* @__PURE__ */ new Map(), wt?.({ ReactiveElement: E }), (j.reactiveElementVersions ??= []).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const K = globalThis, X = (r) => r, D = K.trustedTypes, tt = D ? D.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, ct = "$lit$", y = `lit$${Math.random().toFixed(9).slice(2)}$`, dt = "?" + y, St = `<${dt}>`, A = document, U = () => A.createComment(""), T = (r) => r === null || typeof r != "object" && typeof r != "function", Z = Array.isArray, xt = (r) => Z(r) || typeof r?.[Symbol.iterator] == "function", B = `[ 	
\f\r]`, P = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, et = /-->/g, st = />/g, v = RegExp(`>|${B}(?:([^\\s"'>=/]+)(${B}*=${B}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), it = /'/g, rt = /"/g, pt = /^(?:script|style|textarea|title)$/i, Ct = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), u = Ct(1), S = Symbol.for("lit-noChange"), c = Symbol.for("lit-nothing"), nt = /* @__PURE__ */ new WeakMap(), m = A.createTreeWalker(A, 129);
function ut(r, t) {
...
const Pt = (r, t) => {
  ...
  for (let h = 0; h < e; h++) {
    const a = r[h];
    let d, p, l = -1, f = 0;
    for (; f < a.length && (o.lastIndex = f, p = o.exec(a), p !== null); ) f = o.lastIndex, o === P ? p[1] === "!--" ? o = et : p[1] !== void 0 ? o = st : p[2] !== void 0 ? (pt.test(p[2]) && (i = RegExp("</" + p[2], "g")), o = v) : p[3] !== void 0 && (o = v) : o === v ? p[0] === ">" ? (o = i ?? P, l = -1) : p[1] === void 0 ? l = -2 : (l = o.lastIndex - p[2].length, d = p[1], o = p[3] === void 0 ? v : p[3] === '"' ? rt : it) : o === rt || o === it ? o = v : o === et || o === st ? o = P : (o = v, i = void 0);
    const g = o === v && r[h + 1].startsWith("/>") ? " " : "";
    n += o === P ? a + St : l >= 0 ? (s.push(d), a.slice(0, l) + ct + a.slice(l) + y + g) : a + y + (l === -2 ? h : g);
  }
...
class M {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let n = 0, o = 0;
    const h = t.length - 1, a = this.parts, [d, p] = Pt(t, e);
    if (this.el = M.createElement(d, s), m.currentNode = this.el.content, e === 2 || e === 3) {
    ...
    for (; (i = m.nextNode()) !== null && a.length < h; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(ct)) {
          const f = p[o++], g = i.getAttribute(l).split(y), N = /([.?@])?(.*)/.exec(f);
          a.push({ type: 1, index: n, name: N[2], strings: g, ctor: N[1] === "." ? Ut : N[1] === "?" ? Tt : N[1] === "@" ? Mt : k }), i.removeAttribute(l);
        ...
        if (pt.test(i.tagName)) {
          ...
          if (f > 0) {
            ...
            for (let g = 0; g < f; g++) i.append(l[g], U()), m.nextNode(), a.push({ type: 2, index: ++n });
            i.append(l[f], U());
          }
        }
...
class Ot {
  ...
  u(t) {
    ...
    for (; a !== void 0; ) {
      if (o === a.index) {
        let d;
        a.type === 2 ? d = new H(n, n.nextSibling, this, t) : a.type === 1 ? d = new a.ctor(n, a.name, a.strings, this, t) : a.type === 6 && (d = new Ht(n, this, t)), this._$AV.push(d), a = s[++h];
      }
...
class H {
  ...
  _$AI(t, e = this) {
    t = x(this, t, e), T(t) ? t === c || t == null || t === "" ? (this._$AH !== c && this._$AR(), this._$AH = c) : t !== this._$AH && t !== S && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : xt(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== c && T(this._$AH) ? this._$AA.nextSibling.data = t : this.T(A.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    ...
    if (this._$AH?._$AD === i) this._$AH.p(e);
      ...
      const n = new Ot(i, this), o = n.u(this.options);
...
class k {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let o = !1;
    if (n === void 0) t = x(this, t, e, 0), o = !T(t) || t !== this._$AH && t !== S, o && (this._$AH = t);
    else {
      const h = t;
      let a, d;
      for (t = n[0], a = 0; a < n.length - 1; a++) d = x(this, h[s + a], e, a), d === S && (d = this._$AH[a]), o ||= !T(d) || d !== this._$AH[a], d === c ? t = c : t !== c && (t += (d ?? "") + n[a + 1]), this._$AH[a] = d;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
Rt?.(M, H), (K.litHtmlVersions ??= []).push("3.3.3");
const Nt = (r, t, e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const It = { attribute: !0, type: String, converter: I, reflect: !1, hasChanged: W }, Dt = (r = It, t, e) => {
...
const ot = ["24h", "7d", "30d", "month", "year"], kt = {
  "24h": "24 год",
  "7d": "7 днів",
  "30d": "30 днів",
  month: "Цей місяць",
...
var zt = Object.defineProperty, Bt = Object.getOwnPropertyDescriptor, z = (r, t, e, s) => {
...
let C = class extends w {
  constructor() {
    super(...arguments), this.range = "30d";
  }
  render() {
...
var qt = Object.defineProperty, Vt = Object.getOwnPropertyDescriptor, _ = (r, t, e, s) => {
...
let $ = class extends w {
  ...
  async loadConfig() {
    try {
      this.config = await jt(this.hass), this.entryId ??= this.config.entries[0]?.entry_id;
    } catch (r) {
      this.error = String(r);
    }
  }
  ...
  render() {
    return this.error ? u`<div class="notice">Не вдалося завантажити конфігурацію: ${this.error}</div>` : this.config ? this.config.entries.length ? u`
      <div class="header">
        <h1>Аналітика інвертора</h1>
        ${this.config.entries.length > 1 ? u`<select @change=${(r) => {
      this.entryId = r.target.value;
    }}>
              ${this.config.entries.map(
      (r) => u`<option value=${r.entry_id}>${r.title}</option>`
    )}
            </select>` : c}
        <div class="ranges">
          ${ot.map(
      ...
      <main>
        ${this.tab === "load" ? u`<ia-load-tab
              ...
              .range=${this.range}
            ></ia-load-tab>` : u`<div class="notice">Ця вкладка з'явиться в наступних версіях.</div>`}
      </main>
    ` : u`<div class="notice">
        Жодного інвертора не налаштовано. Додайте інтеграцію Inverter Analytics у налаштуваннях.
      </div>` : u`<div class="notice">Завантаження…</div>`;
  }
};
$.styles = lt`
    :host {
...
$ = _([
  $t("inverter-analytics-panel")
], $);
export {
  $ as InverterAnalyticsPanel
};
