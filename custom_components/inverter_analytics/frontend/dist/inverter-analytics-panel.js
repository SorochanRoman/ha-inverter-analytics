 ...
 */
const No = globalThis, Xh = No.ShadowRoot && (No.ShadyCSS === void 0 || No.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, qh = Symbol(), fc = /* @__PURE__ */ new WeakMap();
let Tg = class {
  constructor(t, e, i) {
    if (this._$cssResult$ = !0, i !== qh) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
  ...
  get styleSheet() {
    ...
    if (Xh && t === void 0) {
      ...
      i && (t = fc.get(e)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), i && fc.set(e, t));
    }
    return t;
  }
  toString() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: c_, defineProperty: v_, getOwnPropertyDescriptor: p_, getOwnPropertyNames: d_, getOwnPropertySymbols: g_, getPrototypeOf: y_ } = Object, Ls = globalThis, vc = Ls.trustedTypes, m_ = vc ? vc.emptyScript : "", __ = Ls.reactiveElementPolyfillSupport, na = (r, t) => r, ts = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? m_ : null;
      break;
  ...
  return e;
} }, Zh = (r, t) => !c_(r, t), pc = { attribute: !0, type: String, converter: ts, reflect: !1, useDefault: !1, hasChanged: Zh };
...
let Yi = class extends HTMLElement {
  ...
  static createProperty(t, e = pc) {
    if (e.state && (e.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(t) && ((e = Object.create(e)).wrapped = !0), this.elementProperties.set(t, e), !e.noAccessor) {
      const i = Symbol(), n = this.getPropertyDescriptor(t, i, e);
      n !== void 0 && v_(this.prototype, t, n);
    }
  }
  static getPropertyDescriptor(t, e, i) {
    const { get: n, set: a } = p_(this.prototype, t) ?? { get() {
      return this[e];
    }, set(o) {
      this[e] = o;
    } };
  ...
  static getPropertyOptions(t) {
    return this.elementProperties.get(t) ?? pc;
  }
  static _$Ei() {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(na("properties"))) {
      const e = this.properties, i = [...d_(e), ...g_(e)];
  ...
  createRenderRoot() {
    ...
    return f_(t, this.constructor.elementStyles), t;
  }
  connectedCallback() {
  ...
  _$ET(t, e) {
    ...
    if (n !== void 0 && i.reflect === !0) {
      const a = (i.converter?.toAttribute !== void 0 ? i.converter : ts).toAttribute(e, i.type);
  ...
  _$AK(t, e) {
    ...
    if (n !== void 0 && this._$Em !== n) {
      const a = i.getPropertyOptions(n), o = typeof a.converter == "function" ? { fromAttribute: a.converter } : a.converter?.fromAttribute !== void 0 ? a.converter : ts;
      this._$Em = n;
  ...
  requestUpdate(t, e, i, n = !1, a) {
    if (t !== void 0) {
      ...
      if (n === !1 && (a = this[t]), i ??= o.getPropertyOptions(t), !((i.hasChanged ?? Zh)(a, e) || i.useDefault && i.reflect && a === this._$Ej?.get(t) && !this.hasAttribute(o._$Eu(t, i)))) return;
      this.C(t, e, i);
    }
...
Yi.elementStyles = [], Yi.shadowRootOptions = { mode: "open" }, Yi[na("elementProperties")] = /* @__PURE__ */ new Map(), Yi[na("finalized")] = /* @__PURE__ */ new Map(), __?.({ ReactiveElement: Yi }), (Ls.reactiveElementVersions ??= []).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Kh = globalThis, dc = (r) => r, es = Kh.trustedTypes, gc = es ? es.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, Cg = "$lit$", Mr = `lit$${Math.random().toFixed(9).slice(2)}$`, Mg = "?" + Mr, S_ = `<${Mg}>`, _i = document, ma = () => _i.createComment(""), _a = (r) => r === null || typeof r != "object" && typeof r != "function", Qh = Array.isArray, b_ = (r) => Qh(r) || typeof r?.[Symbol.iterator] == "function", gl = `[ 	
\f\r]`, In = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, yc = /-->/g, mc = />/g, $r = RegExp(`>|${gl}(?:([^\\s"'>=/]+)(${gl}*=${gl}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), _c = /'/g, Sc = /"/g, Dg = /^(?:script|style|textarea|title)$/i, w_ = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), k = w_(1), fn = Symbol.for("lit-noChange"), U = Symbol.for("lit-nothing"), bc = /* @__PURE__ */ new WeakMap(), fi = _i.createTreeWalker(_i, 129);
function Ag(r, t) {
  if (!Qh(r) || !r.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return gc !== void 0 ? gc.createHTML(t) : t;
}
const x_ = (r, t) => {
  const e = r.length - 1, i = [];
  let n, a = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", o = In;
  for (let s = 0; s < e; s++) {
    const l = r[s];
    let u, h, f = -1, v = 0;
    for (; v < l.length && (o.lastIndex = v, h = o.exec(l), h !== null); ) v = o.lastIndex, o === In ? h[1] === "!--" ? o = yc : h[1] !== void 0 ? o = mc : h[2] !== void 0 ? (Dg.test(h[2]) && (n = RegExp("</" + h[2], "g")), o = $r) : h[3] !== void 0 && (o = $r) : o === $r ? h[0] === ">" ? (o = n ?? In, f = -1) : h[1] === void 0 ? f = -2 : (f = o.lastIndex - h[2].length, u = h[1], o = h[3] === void 0 ? $r : h[3] === '"' ? Sc : _c) : o === Sc || o === _c ? o = $r : o === yc || o === mc ? o = In : (o = $r, n = void 0);
    const c = o === $r && r[s + 1].startsWith("/>") ? " " : "";
    a += o === In ? l + S_ : f >= 0 ? (i.push(u), l.slice(0, f) + Cg + l.slice(f) + Mr + c) : l + Mr + (f === -2 ? s : c);
  }
  return [Ag(r, a + (r[e] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), i];
};
class Sa {
  constructor({ strings: t, _$litType$: e }, i) {
    ...
    this.parts = [];
    let a = 0, o = 0;
    const s = t.length - 1, l = this.parts, [u, h] = x_(t, e);
    if (this.el = Sa.createElement(u, i), fi.currentNode = this.el.content, e === 2 || e === 3) {
      const f = this.el.content.firstChild;
      f.replaceWith(...f.childNodes);
    }
    for (; (n = fi.nextNode()) !== null && l.length < s; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) for (const f of n.getAttributeNames()) if (f.endsWith(Cg)) {
          const v = h[o++], c = n.getAttribute(f).split(Mr), p = /([.?@])?(.*)/.exec(v);
          l.push({ type: 1, index: a, name: p[2], strings: c, ctor: p[1] === "." ? C_ : p[1] === "?" ? M_ : p[1] === "@" ? D_ : Ps }), n.removeAttribute(f);
        } else f.startsWith(Mr) && (l.push({ type: 6, index: a }), n.removeAttribute(f));
        if (Dg.test(n.tagName)) {
          const f = n.textContent.split(Mr), v = f.length - 1;
          if (v > 0) {
            n.textContent = es ? es.emptyScript : "";
            for (let c = 0; c < v; c++) n.append(f[c], ma()), fi.nextNode(), l.push({ type: 2, index: ++a });
            n.append(f[v], ma());
          }
        }
      } else if (n.nodeType === 8) if (n.data === Mg) l.push({ type: 2, index: a });
      else {
        let f = -1;
        for (; (f = n.data.indexOf(Mr, f + 1)) !== -1; ) l.push({ type: 7, index: a }), f += Mr.length - 1;
      }
      a++;
    }
  }
  static createElement(t, e) {
    const i = _i.createElement("template");
...
function cn(r, t, e = r, i) {
  ...
  const a = _a(t) ? void 0 : t._$litDirective$;
...
class T_ {
  ...
  u(t) {
    const { el: { content: e }, parts: i } = this._$AD, n = (t?.creationScope ?? _i).importNode(e, !0);
    fi.currentNode = n;
    let a = fi.nextNode(), o = 0, s = 0, l = i[0];
    for (; l !== void 0; ) {
      if (o === l.index) {
        let u;
        l.type === 2 ? u = new $a(a, a.nextSibling, this, t) : l.type === 1 ? u = new l.ctor(a, l.name, l.strings, this, t) : l.type === 6 && (u = new A_(a, this, t)), this._$AV.push(u), l = i[++s];
      }
      o !== l?.index && (a = fi.nextNode(), o++);
    }
    return fi.currentNode = _i, n;
  }
  p(t) {
    let e = 0;
...
class $a {
  ...
  _$AI(t, e = this) {
    t = cn(this, t, e), _a(t) ? t === U || t == null || t === "" ? (this._$AH !== U && this._$AR(), this._$AH = U) : t !== this._$AH && t !== fn && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : b_(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== U && _a(this._$AH) ? this._$AA.nextSibling.data = t : this.T(_i.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    const { values: e, _$litType$: i } = t, n = typeof i == "number" ? this._$AC(t) : (i.el === void 0 && (i.el = Sa.createElement(Ag(i.h, i.h[0]), this.options)), i);
    if (this._$AH?._$AD === n) this._$AH.p(e);
    else {
      const a = new T_(n, this), o = a.u(this.options);
      a.p(e), this.T(o), this._$AH = a;
    }
  }
  _$AC(t) {
    let e = bc.get(t.strings);
    return e === void 0 && bc.set(t.strings, e = new Sa(t)), e;
  }
  k(t) {
    Qh(this._$AH) || (this._$AH = [], this._$AR());
    const e = this._$AH;
    let i, n = 0;
    for (const a of t) n === e.length ? e.push(i = new $a(this.O(ma()), this.O(ma()), this, this.options)) : i = e[n], i._$AI(a), n++;
    n < e.length && (this._$AR(i && i._$AB.nextSibling, n), e.length = n);
  }
  _$AR(t = this._$AA.nextSibling, e) {
    for (this._$AP?.(!1, !0, e); t !== this._$AB; ) {
      const i = dc(t).nextSibling;
      dc(t).remove(), t = i;
    }
  }
  setConnected(t) {
...
class Ps {
  ...
  constructor(t, e, i, n, a) {
    this.type = 1, this._$AH = U, this._$AN = void 0, this.element = t, this.name = e, this._$AM = n, this.options = a, i.length > 2 || i[0] !== "" || i[1] !== "" ? (this._$AH = Array(i.length - 1).fill(new String()), this.strings = i) : this._$AH = U;
  }
  _$AI(t, e = this, i, n) {
    const a = this.strings;
    let o = !1;
    if (a === void 0) t = cn(this, t, e, 0), o = !_a(t) || t !== this._$AH && t !== fn, o && (this._$AH = t);
    else {
      const s = t;
      let l, u;
      for (t = a[0], l = 0; l < a.length - 1; l++) u = cn(this, s[i + l], e, l), u === fn && (u = this._$AH[l]), o ||= !_a(u) || u !== this._$AH[l], u === U ? t = U : t !== U && (t += (u ?? "") + a[l + 1]), this._$AH[l] = u;
    }
    o && !n && this.j(t);
  }
  j(t) {
...
class D_ extends Ps {
  ...
  _$AI(t, e = this) {
    if ((t = cn(this, t, e, 0) ?? U) === fn) return;
...
const I_ = Kh.litHtmlPolyfillSupport;
I_?.(Sa, $a), (Kh.litHtmlVersions ??= []).push("3.3.3");
const L_ = (r, t, e) => {
  const i = e?.renderBefore ?? t;
  let n = i._$litPart$;
  if (n === void 0) {
    const a = e?.renderBefore ?? null;
    i._$litPart$ = n = new $a(t.insertBefore(ma(), a), a, void 0, e ?? {});
  }
  return n._$AI(r), n;
};
/**
...
class ve extends Yi {
  ...
  update(t) {
    const e = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = L_(e, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
ve._$litElement$ = !0, ve.finalized = !0, jh.litElementHydrateSupport?.({ LitElement: ve });
const P_ = jh.litElementPolyfillSupport;
P_?.({ LitElement: ve });
(jh.litElementVersions ??= []).push("4.2.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const R_ = { attribute: !0, type: String, converter: ts, reflect: !1, hasChanged: Zh }, E_ = (r = R_, t, e) => {
...
function yt(r) {
  return (t, e) => typeof e == "object" ? E_(r, t, e) : ((i, n, a) => {
 ...
 */
function Ht(r) {
  return yt({ ...r, state: !0, attribute: !1 });
}
function O_(r) {
...
const Rs = "—";
function gt(r, t) {
  return r === null || Number.isNaN(r) ? Rs : Math.abs(r) >= 1e3 ? `${new Intl.NumberFormat(t, { maximumFractionDigits: 1 }).format(
    r / 1e3
  )} kW` : `${new Intl.NumberFormat(t, { maximumFractionDigits: 0 }).format(r)} W`;
}
function ct(r, t) {
  return r === null || Number.isNaN(r) ? Rs : `${new Intl.NumberFormat(t, { maximumFractionDigits: 1 }).format(r * 100)}%`;
}
function aa(r, t) {
  return r === null || Number.isNaN(r) ? Rs : r <= 0 ? "0%" : r < 1e-3 ? "<0.1%" : ct(r, t);
}
const z_ = 10 * 60;
function wc(r, t) {
  return r === null || Number.isNaN(r) ? Rs : `${new Intl.NumberFormat(t, { maximumFractionDigits: 1 }).format(r)} kWh`;
}
function tn(r) {
...
const Ig = ["24h", "7d", "30d", "month", "year"], F_ = {
  "24h": "24 h",
  "7d": "7 days",
  "30d": "30 days",
  month: "This month",
  year: "Year"
}, qa = 24 * 3600 * 1e3, xc = 60 * 1e3;
function tf(r, t) {
  const e = new Date(Math.floor(t.getTime() / xc) * xc);
  switch (r) {
    case "24h":
      return { start: new Date(e.getTime() - qa), end: e };
    case "7d":
      return { start: new Date(e.getTime() - 7 * qa), end: e };
    case "30d":
      return { start: new Date(e.getTime() - 30 * qa), end: e };
    case "month":
      return { start: new Date(e.getFullYear(), e.getMonth(), 1, 0, 0, 0, 0), end: e };
    case "year":
      return { start: new Date(e.getTime() - 365 * qa), end: e };
  }
}
function V_(r, t, e, i) {
  ...
  return {
    ...
    range: s && Ig.includes(s) ? s : i.range,
    entryId: l || i.entryId
  };
}
function H_(r, t) {
...
const At = (r, t) => Number(r.toFixed(t));
function G_(r, t) {
  const { base: e, axis: i } = Ue(), n = r.histogram.buckets, a = n.map(
    (o) => String(t === "watts" ? At(o.start, 0) : At(o.start / r.rated_power * 100, 1))
  );
  return {
    ...e,
    xAxis: {
    ...
    series: [
      {
        type: "bar",
        data: n.map((o) => At(o.fraction * 100, 2)),
        itemStyle: { color: mt.load },
        barCategoryGap: "10%"
      }
    ]
  };
...
function U_(r) {
  const { base: t, axis: e } = Ue(), i = [...r.bands].reverse();
  return {
    ...t,
    xAxis: { ...e, type: "value", name: "% of time", min: 0, max: 100 },
    ...
    series: [
      {
        type: "bar",
        data: i.map((n) => At(n.fraction * 100, 2)),
        itemStyle: {
          color: (n) => i[n.dataIndex].key === "100+" ? mt.overload : mt.load
        }
      }
    ]
  };
...
function Y_(r) {
  const { base: t, axis: e } = Ue(), i = r.histogram;
  return {
    ...t,
    xAxis: {
      ...e,
      type: "category",
      data: i.map((n) => String(At(n.start * 100, 0))),
      name: "% imbalance",
      nameLocation: "end"
    },
    ...
    series: [
      {
        ...
        itemStyle: {
          color: (n) => i[n.dataIndex].start >= r.threshold ? mt.overload : mt.load
        },
        barCategoryGap: "10%"
      }
    ]
    ...
    series: [
      {
        name: "Mean",
        type: "bar",
        data: r.map((n) => n.mean === null ? null : At(n.mean, 1)),
        itemStyle: { color: t }
      },
      {
        name: "Peak",
        type: "bar",
        data: r.map((n) => n.peak === null ? null : At(n.peak, 1)),
        itemStyle: { color: mt.muted }
      }
    ]
  };
}
function q_(r) {
  const { base: t, axis: e } = Ue(), i = r.histogram.buckets;
  return {
    ...t,
    xAxis: {
      ...e,
      type: "category",
      data: i.map((n) => String(At(n.start, 0))),
      name: "% charge",
      nameLocation: "end"
    },
    yAxis: { ...e, type: "value", name: "% of time" },
    series: [
      {
        ...
        itemStyle: {
          color: (n) => i[n.dataIndex].end <= r.low_pct ? mt.overload : mt.battery
        },
        barCategoryGap: "10%"
      }
    ]
...
function Z_(r) {
  const { base: t, axis: e } = Ue(), i = [...r].reverse();
  return {
    ...t,
    xAxis: { ...e, type: "value", name: "% of time", min: 0, max: 100 },
    yAxis: { ...e, type: "category", data: i.map((n) => n.key) },
    series: [
      {
        ...
        data: i.map((n) => At(n.fraction * 100, 2)),
        itemStyle: {
          color: (n) => i[n.dataIndex].key === "0-20" ? mt.overload : mt.battery
        }
      }
    ]
  };
...
function K_(r, t) {
  const { base: e, axis: i } = Ue(), n = r.map((o, s) => ef(o.key, r[s - 1]?.key)), a = [
    {
      name: "Load",
      type: "bar",
      data: r.map((o) => o.load_mean === null ? null : At(o.load_mean, 1)),
      ...
      itemStyle: {
        color: (o) => r[o.dataIndex].complete ? mt.load : mt.muted
      }
    }
  ];
  return t && a.push({
    name: "PV",
    type: "bar",
    data: r.map((o) => o.pv_mean === null ? null : At(o.pv_mean, 1)),
    itemStyle: { color: mt.pv }
  }), {
    ...e,
  ...
  const { base: e, axis: i } = Ue(), n = [
    {
      ...
      lineStyle: { color: mt.load },
      itemStyle: { color: mt.load },
      data: r.map((a) => a.load_mean === null ? null : At(a.load_mean, 1))
    }
  ];
  return t && n.push({
    name: "PV",
    type: "line",
    showSymbol: !1,
    lineStyle: { color: mt.pv },
    itemStyle: { color: mt.pv },
    data: r.map((a) => a.pv_mean === null ? null : At(a.pv_mean, 1))
  }), {
    ...e,
    legend: t ? { data: ["Load", "PV"], top: 0, textStyle: e.textStyle } : void 0,
    grid: { ...e.grid, top: t ? 48 : 24 },
...
function j_(r, t) {
  const { base: e, axis: i } = Ue(), n = t.map((u) => u.key), a = n.map((u, h) => ef(u, n[h - 1])), o = new Map(n.map((u, h) => [u, h])), s = r.filter((u) => u.load_mean !== null && o.has(u.month)).map((u) => [o.get(u.month), u.hour, At(u.load_mean, 1)]), l = s.map((u) => u[2]);
  return {
    ...e,
    ...
    visualMap: {
      ...
      inRange: { color: [mt.battery, mt.pv, mt.overload] }
    },
...
***************************************************************************** */
var Fu = function(r, t) {
  return Fu = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, i) {
    e.__proto__ = i;
  } || function(e, i) {
...
var J_ = /* @__PURE__ */ function() {
  ...
  function r() {
    this.browser = new J_(), this.node = !1, this.wxa = !1, this.worker = !1, this.svgSupported = !1, this.touchEventsSupported = !1, this.pointerEventsSupported = !1, this.domSupported = !1, this.transformSupported = !1, this.transform3dSupported = !1, this.hasGlobalWindow = typeof window < "u";
  }
  return r;
}(), Y = new t1();
...
var rf = 12, r1 = "sans-serif", Si = rf + "px " + r1, i1 = 20, n1 = 100, a1 = "007LLmW'55;N0500LLLLLLLLLL00NNNLzWW\\\\WQb\\0FWLg\\bWb\\WQ\\WrWWQ000CL5LLFLL0LL**F*gLLLL5F0LF\\FFF5.5N";
function o1(r) {
  var t = {};
  if (typeof JSON > "u")
    return t;
...
var s1 = o1(a1), Er = {
  ...
  measureText: /* @__PURE__ */ function() {
    ...
    return function(e, i) {
      if (!r) {
        var n = Er.createCanvas();
        r = n && n.getContext("2d");
      }
      if (r)
        return t !== i && (t = r.font = i || Si), r.measureText(e);
      e = e || "", i = i || Si;
      var a = /((?:\d+)?\.?\d*)px/.exec(i), o = a && +a[1] || rf, s = 0;
      if (i.indexOf("mono") >= 0)
        s = o * e.length;
      else
...
}, {}), Fa = Object.prototype.toString, Os = Array.prototype, l1 = Os.forEach, u1 = Os.filter, nf = Os.slice, h1 = Os.map, Tc = function() {
}.constructor, Za = Tc ? Tc.prototype : null, af = "__proto__", f1 = 2311;
function Rg() {
  return f1++;
}
function of() {
...
function X(r) {
  ...
  } else if (!Lg[e] && !oa(r) && !ba(r)) {
    t = {};
    for (var o in r)
      r.hasOwnProperty(o) && o !== af && (t[o] = X(r[o]));
  }
  return t;
}
function rt(r, t, e) {
  if (!V(t) || !V(r))
    return e ? X(t) : r;
  for (var i in t)
    if (t.hasOwnProperty(i) && i !== af) {
      var n = r[i], a = t[i];
      V(a) && V(n) && !z(a) && !z(n) && !ba(a) && !ba(n) && !Cc(a) && !Cc(n) && !oa(a) && !oa(n) ? rt(n, a, e) : (e || !(i in r)) && (r[i] = X(t[i]));
    }
  return r;
}
function B(r, t) {
  if (Object.assign)
    ...
    for (var e in t)
      t.hasOwnProperty(e) && e !== af && (r[e] = t[e]);
  return r;
}
function ot(r, t, e) {
...
function v1(r, t) {
  for (var e = [], i = 2; i < arguments.length; i++)
    e[i - 2] = arguments[i];
  return function() {
    return r.apply(t, e.concat(nf.call(arguments)));
  };
}
var j = Za && q(Za.bind) ? Za.call.bind(Za.bind) : v1;
function Ct(r) {
  for (var t = [], e = 1; e < arguments.length; e++)
    t[e - 1] = arguments[e];
  return function() {
    return r.apply(this, t.concat(nf.call(arguments)));
  };
}
function z(r) {
  return Array.isArray ? Array.isArray(r) : Fa.call(r) === "[object Array]";
}
function q(r) {
...
function Vu(r) {
  return Fa.call(r) === "[object String]";
}
function pt(r) {
...
}(), kg = typeof Map == "function";
function g1() {
  return kg ? /* @__PURE__ */ new Map() : new d1();
}
var y1 = function() {
  function r(t) {
    var e = z(t);
...
function Wu(r, t, e, i, n, a) {
  ...
  for (var f = 0, v = 0, c = 0; v < s; v++) {
    var p = 1 << v;
    p & n || (f += (c % 2 ? -1 : 1) * r[e][v] * Wu(r, t - 1, h, u, n | p, a), c++);
  }
  return a[o] = f, f;
}
function Dc(r, t) {
  ...
  if (n !== 0) {
    for (var a = [], o = 0; o < 8; o++)
      for (var s = 0; s < 8; s++)
        a[s] == null && (a[s] = 0), a[s] += ((o + s) % 2 ? -1 : 1) * Wu(e, 7, o === 0 ? 1 : 0, 1 << o, 1 << s, i) / n * t[o];
...
var Ac = "___zrEVENTSAVED", ml = [];
function I1(r, t, e, i, n) {
  return Uu(ml, t, i, n, !0) && Uu(r, e, ml[0], ml[1]);
}
function Uu(r, t, e, i, n) {
  if (t.getBoundingClientRect && Y.domSupported && !Ng(t)) {
    var a = t[Ac] || (t[Ac] = {}), o = L1(t, a), s = P1(o, a, n);
    if (s)
      return s(r, e, i), !0;
  }
  return !1;
...
function P1(r, t, e) {
  ...
  return l && n ? n : (t.srcCoords = o, t[i] = e ? Dc(s, o) : Dc(o, s));
}
function Ng(r) {
...
var O1 = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, _l = [], k1 = Y.browser.firefox && +Y.browser.version.split(".")[0] < 39;
function Yu(r, t, e, i) {
  return e = e || {}, i ? Ic(r, t, e) : k1 && t.layerX != null && t.layerX !== t.offsetX ? (e.zrX = t.layerX, e.zrY = t.layerY) : t.offsetX != null ? (e.zrX = t.offsetX, e.zrY = t.offsetY) : Ic(r, t, e), e;
}
function Ic(r, t, e) {
...
}(), Ka = Math.min, Qa = Math.max, Fr = new ft(), Vr = new ft(), Hr = new ft(), Gr = new ft(), Ln = new ft(), Pn = new ft(), at = function() {
  function r(t, e, i, n) {
    i < 0 && (t = t + i, i = -i), n < 0 && (e = e + n, n = -n), this.x = t, this.y = e, this.width = i, this.height = n;
  }
  return r.prototype.union = function(t) {
    var e = Ka(t.x, this.x), i = Ka(t.y, this.y);
    isFinite(this.x) && isFinite(this.width) ? this.width = Qa(t.x + t.width, this.x + this.width) - e : this.width = t.width, isFinite(this.y) && isFinite(this.height) ? this.height = Qa(t.y + t.height, this.y + this.height) - i : this.height = t.height, this.x = e, this.y = i;
  }, r.prototype.applyTransform = function(t) {
    r.applyTransform(this, this, t);
  }, r.prototype.calculateTransform = function(t) {
    var e = this, i = t.width / e.width, n = t.height / e.height, a = rn();
    return Xu(a, a, [-e.x, -e.y]), H1(a, a, [i, n]), Xu(a, a, [t.x, t.y]), a;
    ...
    if (e) {
      var c = 1 / 0, p = 0, g = Math.abs(a - l), d = Math.abs(u - n), y = Math.abs(s - h), m = Math.abs(f - o), _ = Math.min(g, d), S = Math.min(y, m);
      a < l || u < n ? _ > p && (p = _, g < d ? ft.set(Pn, -g, 0) : ft.set(Pn, d, 0)) : _ < c && (c = _, g < d ? ft.set(Ln, g, 0) : ft.set(Ln, -d, 0)), s < h || f < o ? S > p && (p = S, y < m ? ft.set(Pn, 0, -y) : ft.set(Pn, 0, m)) : _ < c && (c = _, y < m ? ft.set(Ln, 0, y) : ft.set(Ln, 0, -m));
    }
    return e && ft.copy(e, v ? Ln : Pn), v;
    ...
    Fr.x = Hr.x = e.x, Fr.y = Gr.y = e.y, Vr.x = Gr.x = e.x + e.width, Vr.y = Hr.y = e.y + e.height, Fr.transform(i), Gr.transform(i), Vr.transform(i), Hr.transform(i), t.x = Ka(Fr.x, Vr.x, Hr.x, Gr.x), t.y = Ka(Fr.y, Vr.y, Hr.y, Gr.y);
    var l = Qa(Fr.x, Vr.x, Hr.x, Gr.x), u = Qa(Fr.y, Vr.y, Hr.y, Gr.y);
...
var U1 = function(r) {
  ...
  "mousemove",
  "contextmenu"
], bl = new at(0, 0, 0, 0), $g = function(r) {
  N(t, r);
  function t(e, i, n, a, o) {
    var s = r.call(this) || this;
    return s._hovered = new Rn(0, 0), s.storage = e, s.painter = i, s.painterRoot = a, s._pointerSize = o, n = n || new U1(), s.proxy = null, s.setHandlerProxy(n), s._draggingMgr = new D1(s), s;
  }
  return t.prototype.setHandlerProxy = function(e) {
    ...
    var i = e.zrX, n = e.zrY, a = Fg(this, i, n), o = this._hovered, s = o.target;
    s && !s.__zr && (o = this.findHover(o.x, o.y), s = o.target);
    var l = this._hovered = a ? new Rn(i, n) : this.findHover(i, n), u = l.target, h = this.proxy;
    ...
    var a = this.storage.getDisplayList(), o = new Rn(e, i);
    if (Pc(a, o, e, i, n), this._pointerSize && !o.target) {
      for (var s = [], l = this._pointerSize, u = l / 2, h = new at(e - u, i - u, l, l), f = a.length - 1; f >= 0; f--) {
        var v = a[f];
        v !== n && !v.ignore && !v.ignoreCoarsePointer && (!v.parent || !v.parent.ignoreCoarsePointer) && (bl.copy(v.getBoundingRect()), v.transform && bl.applyTransform(v.transform), bl.intersect(h) && s.push(v));
      }
      if (s.length)
        for (var c = 4, p = Math.PI / 12, g = Math.PI * 2, d = 0; d < u; d += c)
          for (var y = 0; y < g; y += p) {
            var m = e + d * Math.cos(y), _ = i + d * Math.sin(y);
            if (Pc(s, o, m, _, n), o.target)
              return o;
          }
    }
    return o;
  }, t.prototype.processGesture = function(e, i) {
    this._gestureMgr || (this._gestureMgr = new $1());
...
C(["click", "mousedown", "mouseup", "mousewheel", "dblclick", "contextmenu"], function(r) {
  $g.prototype[r] = function(t) {
    var e = t.zrX, i = t.zrY, n = Fg(this, e, i), a, o;
...
function Pc(r, t, e, i, n) {
  for (var a = r.length - 1; a >= 0; a--) {
    var o = r[a], s = void 0;
    if (o !== n && !o.ignore && (s = X1(o, e, i)) && (!t.topTarget && (t.topTarget = o), s !== zg)) {
      t.target = o;
      break;
    }
  }
...
function K1(r, t) {
  ...
  function h(c) {
    ...
    var m = xl(r[d], r, p, g, 0, t);
    p += m, g -= m, g !== 0 && (y = wl(r[p + g - 1], r, d, y, y - 1, t), y !== 0 && (g <= y ? f(p, g, d, y) : v(p, g, d, y)));
  }
  function f(c, p, g, d) {
    var y = 0;
    for (y = 0; y < p; y++)
  ...
  function v(c, p, g, d) {
    ...
    for (y = 0; y < d; y++)
      o[y] = r[g + y];
    var m = c + p - 1, _ = d - 1, S = g + d - 1, w = 0, b = 0;
    if (r[S--] = r[m--], --p === 0) {
      for (w = S - (d - 1), y = 0; y < d; y++)
        r[w + y] = o[y];
      return;
    }
    if (d === 1) {
    ...
    for (var x = e; ; ) {
      ...
      do
        if (t(o[_], r[m]) < 0) {
          if (r[S--] = r[m--], M++, D = 0, --p === 0) {
            A = !0;
            break;
          }
        } else if (r[S--] = o[_--], D++, M = 0, --d === 1) {
          A = !0;
          break;
        }
      while ((M | D) < x);
      if (A)
        break;
      do {
        if (M = p - xl(o[_], r, c, p, p - 1, t), M !== 0) {
          for (S -= M, m -= M, p -= M, b = S + 1, w = m + 1, y = M - 1; y >= 0; y--)
            r[b + y] = r[w + y];
          if (p === 0) {
            A = !0;
            break;
        ...
        if (D = d - wl(r[m], o, 0, d, d - 1, t), D !== 0) {
          for (S -= D, _ -= D, d -= D, b = S + 1, w = _ + 1, y = 0; y < D; y++)
            r[b + y] = o[w + y];
          if (d <= 1) {
            A = !0;
            break;
...
var te = 1, Qn = 2, Xi = 4, Oc = !1;
function Tl() {
  Oc || (Oc = !0, console.warn("z / z2 / zlevel of displayable is invalid, which may cause unexpected errors"));
}
function kc(r, t) {
...
var Q1 = function() {
  function r() {
    this._roots = [], this._displayList = [], this._displayListLen = 0, this.displayableSortFunc = kc;
  }
  return r.prototype.traverse = function(t, e) {
    ...
    i.length = this._displayListLen, $o(i, kc);
    ...
    if (!(t.ignore && !i)) {
      ...
      if (t.childrenRef) {
        ...
        var h = t;
        e && e.length ? h.__clipPaths = e : h.__clipPaths && h.__clipPaths.length > 0 && (h.__clipPaths = []), isNaN(h.z) && (Tl(), h.z = 0), isNaN(h.z2) && (Tl(), h.z2 = 0), isNaN(h.zlevel) && (Tl(), h.zlevel = 0), this._displayList[this._displayListLen++] = h;
      }
...
ns = Y.hasGlobalWindow && (window.requestAnimationFrame && window.requestAnimationFrame.bind(window) || window.msRequestAnimationFrame && window.msRequestAnimationFrame.bind(window) || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame) || function(r) {
...
}, ja = Math.pow, Lr = Math.sqrt, as = 1e-8, Hg = 1e-4, Bc = Lr(3), Ja = 1 / 3, Be = xn(), ue = xn(), an = xn();
function Dr(r) {
  return r > -as && r < as;
}
function Gg(r) {
...
function os(r, t, e, i, n, a) {
  ...
  if (Dr(h) && Dr(f))
    ...
    if (Dr(g)) {
      ...
      var m = Lr(g), _ = h * s + 1.5 * o * (-f + m), S = h * s + 1.5 * o * (-f - m);
      _ < 0 ? _ = -ja(-_, Ja) : _ = ja(_, Ja), S < 0 ? S = -ja(-S, Ja) : S = ja(S, Ja);
      var p = (-s - (_ + S)) / (3 * o);
      p >= 0 && p <= 1 && (a[c++] = p);
    } else {
      var w = (2 * h * s - 3 * o * f) / (2 * Lr(h * h * h)), b = Math.acos(w) / 3, x = Lr(h), M = Math.cos(b), p = (-s - 2 * x * M) / (3 * o), y = (-s + x * (M + Bc * Math.sin(b))) / (3 * o), D = (-s + x * (M - Bc * Math.sin(b))) / (3 * o);
...
function Wg(r, t, e, i, n) {
  ...
  if (Dr(o)) {
    ...
    if (Dr(h))
      ...
      var f = Lr(h), u = (-a + f) / (2 * o), v = (-a - f) / (2 * o);
...
function j1(r, t, e, i, n, a, o, s, l, u, h) {
  ...
  for (var m = 0; m < 1; m += 0.05)
    ue[0] = Pt(r, e, n, o, m), ue[1] = Pt(t, i, a, s, m), d = en(Be, ue), d < c && (f = m, c = d);
  c = 1 / 0;
  for (var _ = 0; _ < 32 && !(v < Hg); _++)
    p = f - v, g = f + v, ue[0] = Pt(r, e, n, o, p), ue[1] = Pt(t, i, a, s, p), d = en(ue, Be), p >= 0 && d < c ? (f = p, c = d) : (an[0] = Pt(r, e, n, o, g), an[1] = Pt(t, i, a, s, g), y = en(an, Be), g <= 1 && y < c ? (f = g, c = y) : v *= 0.5);
  return Lr(c);
}
function J1(r, t, e, i, n, a, o, s, l) {
  for (var u = r, h = t, f = 0, v = 1 / l, c = 1; c <= l; c++) {
    var p = c * v, g = Pt(r, e, n, o, p), d = Pt(t, i, a, s, p), y = g - u, m = d - h;
...
function tS(r, t, e, i, n) {
  ...
  if (Dr(a)) {
    ...
    if (Dr(h)) {
      ...
      var f = Lr(h), u = (-o + f) / (2 * a), v = (-o - f) / (2 * a);
      u >= 0 && u <= 1 && (n[l++] = u), v >= 0 && v <= 1 && (n[l++] = v);
    }
  }
  return l;
...
function eS(r, t, e, i, n, a, o, s, l) {
  ...
  for (var v = 0; v < 1; v += 0.05) {
    ue[0] = Yt(r, e, n, v), ue[1] = Yt(t, i, a, v);
    var c = en(Be, ue);
    c < f && (u = v, f = c);
  }
  f = 1 / 0;
  for (var p = 0; p < 32 && !(h < Hg); p++) {
    var g = u - h, d = u + h;
    ue[0] = Yt(r, e, n, g), ue[1] = Yt(t, i, a, g);
    var c = en(ue, Be);
    if (g >= 0 && c < f)
      u = g, f = c;
    else {
      an[0] = Yt(r, e, n, d), an[1] = Yt(t, i, a, d);
      var y = en(an, Be);
...
function Yg(r) {
  ...
  if (t) {
    ...
    var s = [];
    return function(l) {
      return l <= 0 ? 0 : l >= 1 ? 1 : os(0, i, a, 1, l, s) && Pt(0, n, o, 1, s[0]);
    };
  }
}
var nS = function() {
  ...
  return r.prototype.step = function(t, e) {
    ...
    this.easing = t, this.easingFunc = q(t) ? t : sa[t] || Yg(t);
  }, r;
  ...
  function r(t) {
    this._list = new aS(), this._maxSize = 10, this._map = {}, this._maxSize = t;
  }
  return r.prototype.put = function(t, e) {
    ...
    if (n[t] == null) {
      ...
      s ? s.value = e : s = new Xg(e), s.key = t, i.insertEntry(s), n[t] = s;
    }
    return a;
  }, r.prototype.get = function(t) {
...
function di(r) {
  var t = r;
  return t.length && t.charAt(t.length - 1) === "%" ? xa(parseFloat(t) / 100) : xa(parseFloat(t));
}
function Ml(r, t, e) {
...
var qg = new Va(20), to = null;
function Li(r, t) {
  to && qu(to, t), to = qg.put(r, to || t.slice());
}
function de(r, t) {
  if (r) {
    t = t || [];
    ...
    if (i.charAt(0) === "#") {
      if (n === 4 || n === 5) {
        ...
        return ae(t, (a & 3840) >> 4 | (a & 3840) >> 8, a & 240 | (a & 240) >> 4, a & 15 | (a & 15) << 4, n === 5 ? parseInt(i.slice(4), 16) / 15 : 1), Li(r, t), t;
      } else if (n === 7 || n === 9) {
        ...
        return ae(t, (a & 16711680) >> 16, (a & 65280) >> 8, a & 255, n === 9 ? parseInt(i.slice(7), 16) / 255 : 1), Li(r, t), t;
      }
      return;
    }
    ...
    if (o !== -1 && s + 1 === n) {
      ...
      switch (l) {
        ...
        case "rgb":
          if (u.length >= 3)
            return ae(t, Cl(u[0]), Cl(u[1]), Cl(u[2]), u.length === 3 ? h : di(u[3])), Li(r, t), t;
          ae(t, 0, 0, 0, 1);
          return;
        case "hsla":
          if (u.length !== 4) {
          ...
          return u[3] = di(u[3]), Zu(u, t), Li(r, t), t;
        case "hsl":
          if (u.length !== 3) {
            ae(t, 0, 0, 0, 1);
            return;
          }
          return Zu(u, t), Li(r, t), t;
        default:
          return;
      }
    }
...
function Zu(r, t) {
  var e = (parseFloat(r[0]) % 360 + 360) % 360 / 360, i = di(r[1]), n = di(r[2]), a = n <= 0.5 ? n * (i + 1) : n + i - n * i, o = n * 2 - a;
  return t = t || [], ae(t, Ce(Ml(o, a, e + 1 / 3) * 255), Ce(Ml(o, a, e) * 255), Ce(Ml(o, a, e - 1 / 3) * 255), 1), r.length === 4 && (t[3] = r[3]), t;
}
function sS(r) {
  if (r) {
...
function Fc(r, t) {
  ...
  if (e) {
    ...
    return ir(e, e.length === 4 ? "rgba" : "rgb");
  }
}
function Dl(r, t, e) {
  if (!(!(t && t.length) || !(r >= 0 && r <= 1))) {
    ...
    return e[0] = Ce(Ar(o[0], s[0], l)), e[1] = Ce(Ar(o[1], s[1], l)), e[2] = Ce(Ar(o[2], s[2], l)), e[3] = xa(Ar(o[3], s[3], l)), e;
  }
}
function lS(r, t, e) {
  if (!(!(t && t.length) || !(r >= 0 && r <= 1))) {
    var i = r * (t.length - 1), n = Math.floor(i), a = Math.ceil(i), o = de(t[n]), s = de(t[a]), l = i - n, u = ir([
      Ce(Ar(o[0], s[0], l)),
      Ce(Ar(o[1], s[1], l)),
      Ce(Ar(o[2], s[2], l)),
      xa(Ar(o[3], s[3], l))
...
function Al(r, t, e, i) {
  var n = de(r);
  if (r)
    return n = sS(n), t != null && (n[0] = oS(t)), e != null && (n[1] = di(e)), i != null && (n[2] = di(i)), ir(Zu(n), "rgba");
}
function uS(r, t) {
  var e = de(r);
  if (e && t != null)
    return e[3] = xa(t), ir(e, "rgba");
}
function ir(r, t) {
  if (!(!r || !r.length)) {
    var e = r[0] + "," + r[1] + "," + r[2];
...
function Hc(r) {
  if (F(r)) {
    var t = Vc.get(r);
    return t || (t = Fc(r, -0.1), Vc.put(r, t)), t;
  } else if (ks(r)) {
    var e = B({}, r);
...
var ro = 0, Ho = 1, Zg = 2, jn = 3, Qu = 4, ju = 5, Wc = 6;
function Uc(r) {
  return r === Qu || r === ju;
}
function io(r) {
...
var On = [0, 0, 0, 0], gS = function() {
  ...
  return r.prototype.isFinished = function() {
    ...
    this._needsSort = !0;
    var n = this.keyframes, a = n.length, o = !1, s = Wc, l = e;
    if (Zt(e)) {
      var u = dS(e);
      ...
      }), hS(e) ? s = Qu : fS(e) && (s = ju), l = f;
    }
    a === 0 ? this.valType = s : (s !== this.valType || s === Wc) && (o = !0), this.discrete = this.discrete || o;
    var v = {
      time: t,
      value: l,
      rawValue: e,
    ...
    return i && (v.easing = i, v.easingFunc = q(i) ? i : sa[i] || Yg(i)), n.push(v), v;
  }, r.prototype.prepare = function(t, e) {
    var i = this.keyframes;
    this._needsSort && i.sort(function(g, d) {
      return g.time - d.time;
    });
    for (var n = this.valType, a = i.length, o = i[a - 1], s = this.discrete, l = io(n), u = Uc(n), h = 0; h < a; h++) {
      var f = i[h], v = f.value, c = o.value;
      f.percent = f.time / t, s || (l && h !== a - 1 ? pS(v, c, n) : u && vS(v.colorStops, c.colorStops));
    }
    if (!s && n !== ju && e && this.needsAnimate() && e.needsAnimate() && n === e.valType && !e._finished) {
      this._additiveTrack = e;
      for (var p = i[0].value, h = 0; h < a; h++)
        n === ro ? i[h].additiveValue = i[h].value - p : n === jn ? i[h].additiveValue = eo([], i[h].value, p, -1) : io(n) && (i[h].additiveValue = n === Ho ? eo([], i[h].value, p, -1) : Gc([], i[h].value, p, -1));
    }
  }, r.prototype.step = function(t, e) {
    if (!this._finished) {
      this._additiveTrack && this._additiveTrack._finished && (this._additiveTrack = null);
      var i = this._additiveTrack != null, n = i ? "additiveValue" : "value", a = this.valType, o = this.keyframes, s = o.length, l = this.propName, u = a === jn, h, f = this._lastFr, v = Math.min, c, p;
      if (s === 1)
        c = p = o[0];
      else {
        if (e < 0)
      ...
      if (c && p) {
        ...
        var m = i ? this._additiveValue : u ? On : t[l];
        if ((io(a) || u) && !m && (m = this._additiveValue = []), this.discrete)
          t[l] = y < 1 ? c.rawValue : p.rawValue;
        else if (io(a))
          a === Ho ? Il(m, c[n], p[n], y) : cS(m, c[n], p[n], y);
        else if (Uc(a)) {
          var _ = c[n], S = p[n], w = a === Qu;
          t[l] = {
            type: w ? "linear" : "radial",
            x: Je(_.x, S.x, y),
            y: Je(_.y, S.y, y),
            colorStops: W(_.colorStops, function(x, M) {
              var D = S.colorStops[M];
              return {
                offset: Je(x.offset, D.offset, y),
                color: Vo(Il([], x.color, D.color, y))
              };
            }),
            global: S.global
          }, w ? (t[l].x2 = Je(_.x2, S.x2, y), t[l].y2 = Je(_.y2, S.y2, y)) : t[l].r = Je(_.r, S.r, y);
        } else if (u)
          Il(m, c[n], p[n], y), i || (t[l] = Vo(m));
        else {
          var b = Je(c[n], p[n], y);
    ...
    e === ro ? t[i] = t[i] + n : e === jn ? (de(t[i], On), eo(On, On, n, 1), t[i] = Vo(On)) : e === Ho ? eo(t[i], t[i], n, 1) : e === Zg && Gc(t[i], t[i], n, 1);
  }, r;
}(), cf = function() {
  function r(t, e, i, n) {
    if (this._tracks = {}, this._trackKeys = [], this._maxTime = 0, this._started = 0, this._clip = null, this._target = t, this._loop = e, e && n) {
      of("Can' use additive animation on looped animation.");
      return;
    }
    ...
    for (var a = this._tracks, o = 0; o < i.length; o++) {
      ...
      if (!l) {
        ...
        if (h) {
          ...
          u = v && v.value, h.valType === jn && u && (u = Vo(u));
        } else
          u = this._target[s];
        if (u == null)
          continue;
...
var yS = function(r) {
  ...
  return t.prototype.addClip = function(e) {
    ...
    for (var i = Qi() - this._pausedTime, n = i - this._time, a = this._head; a; ) {
    ...
    this._running = !0;
    function i() {
      e._running && (ns(i), !e._paused && e.update());
    }
    ns(i);
    ...
    i = i || {}, this.start();
    var n = new cf(e, i.loop);
    return this.addAnimator(n), n;
  }, t;
}(Xe), mS = 300, Ll = Y.domSupported, Pl = function() {
  var r = [
    "click",
    "dblclick",
    "mousewheel",
...
var bS = /* @__PURE__ */ function() {
  ...
  mouseout: function(r) {
    ...
    Kg(this, t) || (this.__pointerCapturing && (r.zrEventControl = "no_globalout"), this.trigger("mouseout", r));
  },
  wheel: function(r) {
    Xc = !0, r = oe(this.dom, r), this.trigger("mousewheel", r);
  },
  mousewheel: function(r) {
    Xc || (r = oe(this.dom, r), this.trigger("mousewheel", r));
  },
  touchstart: function(r) {
    r = oe(this.dom, r), Rl(r), this.__lastTouchMoment = /* @__PURE__ */ new Date(), this.handler.processGesture(r, "start"), we.mousemove.call(this, r), we.mousedown.call(this, r);
  },
  touchmove: function(r) {
    r = oe(this.dom, r), Rl(r), this.handler.processGesture(r, "change"), we.mousemove.call(this, r);
  },
  touchend: function(r) {
    r = oe(this.dom, r), Rl(r), this.handler.processGesture(r, "end"), we.mouseup.call(this, r), +/* @__PURE__ */ new Date() - +this.__lastTouchMoment < mS && we.click.call(this, r);
  },
  pointerdown: function(r) {
    we.mousedown.call(this, r);
  },
  pointermove: function(r) {
    Ju(r) || we.mousemove.call(this, r);
  },
  pointerup: function(r) {
    we.mouseup.call(this, r);
  },
  pointerout: function(r) {
    Ju(r) || we.mouseout.call(this, r);
  }
};
...
function wS(r, t) {
  var e = t.domHandlers;
  Y.pointerEventsSupported ? C(Pl.pointer, function(i) {
    Go(t, i, function(n) {
      e[i].call(r, n);
    });
  }) : (Y.touchEventsSupported && C(Pl.touch, function(i) {
    Go(t, i, function(n) {
      e[i].call(r, n), _S(t);
    });
  }), C(Pl.mouse, function(i) {
    Go(t, i, function(n) {
      n = lf(n), t.touching || e[i].call(r, n);
    });
  }));
}
function xS(r, t) {
  Y.pointerEventsSupported ? C(Yc.pointer, e) : Y.touchEventsSupported || C(Yc.mouse, e);
  function e(i) {
    function n(a) {
      a = lf(a), Kg(r, a.target) || (a = SS(r, a), t.domHandlers[i].call(r, a));
    }
    Go(t, i, n, { capture: !0 });
  }
}
...
var qc = /* @__PURE__ */ function() {
  ...
  function t(e, i) {
    ...
    return n.__pointerCapturing = !1, n.dom = e, n.painterRoot = i, n._localHandlerScope = new qc(e, we), Ll && (n._globalHandlerScope = new qc(document, th)), wS(n, n._localHandlerScope), n;
  }
  return t.prototype.dispose = function() {
    El(this._localHandlerScope), Ll && El(this._globalHandlerScope);
  }, t.prototype.setCursor = function(e) {
    this.dom.style && (this.dom.style.cursor = e || "default");
  }, t.prototype.__togglePointerCapture = function(e) {
    if (this.__mayPointerCapture = null, Ll && +this.__pointerCapturing ^ +e) {
...
Y.hasGlobalWindow && (Qg = Math.max(window.devicePixelRatio || window.screen && window.screen.deviceXDPI / window.screen.logicalXDPI || 1, 1));
var hs = Qg, eh = 0.4, rh = "#333", ih = "#ccc", CS = "#eee", Zc = uf, Kc = 5e-5;
function Wr(r) {
  return r > Kc || r < -Kc;
}
var Ur = [], Pi = [], Ol = rn(), kl = Math.abs, vf = function() {
  function r() {
  }
  return r.prototype.getLocalTransform = function(t) {
    ...
    return Wr(this.rotation) || Wr(this.x) || Wr(this.y) || Wr(this.scaleX - 1) || Wr(this.scaleY - 1) || Wr(this.skewX) || Wr(this.skewY);
  }, r.prototype.updateTransform = function() {
    var t = this.parent && this.parent.transform, e = this.needLocalTransform(), i = this.transform;
    if (!(e || t)) {
      i && (Zc(i), this.invTransform = null);
      return;
    }
    i = i || rn(), e ? this.getLocalTransform(i) : Zc(i), t && (e ? nn(i, t, i) : V1(i, t)), this.transform = i, this._resolveGlobalScaleRatio(i);
  }, r.prototype._resolveGlobalScaleRatio = function(t) {
    var e = this.globalScaleRatio;
    if (e != null && e !== 1) {
      this.getGlobalScale(Ur);
      var i = Ur[0] < 0 ? -1 : 1, n = Ur[1] < 0 ? -1 : 1, a = ((Ur[0] - i) * e + i) / Ur[0] || 0, o = ((Ur[1] - n) * e + n) / Ur[1] || 0;
      t[0] *= a, t[1] *= a, t[2] *= o, t[3] *= o;
    }
    this.invTransform = this.invTransform || rn(), ff(this.invTransform, t);
    ...
    if (this.transform) {
      ...
      t && t.transform && (t.invTransform = t.invTransform || rn(), nn(Pi, t.invTransform, e), e = Pi);
      var i = this.originX, n = this.originY;
      (i || n) && (Ol[4] = i, Ol[5] = n, nn(Pi, e, Ol), Pi[4] -= i, Pi[5] -= n, e = Pi), this.setLocalTransform(e);
    }
    ...
    if (i || n || s || l) {
      ...
      e[4] = e[5] = 0;
    return e[0] = a, e[3] = o, e[1] = c * a, e[2] = v * o, u && hf(e, e, u), e[4] += i + h, e[5] += n + f, e;
...
function ee(r, t) {
  ...
  e || (e = Qc[t] = new Va(500));
  var i = e.get(r);
  return i == null && (i = Er.measureText(r, t).width, e.put(r, i)), i;
}
function jc(r, t, e, i) {
  var n = ee(r, t), a = df(t), o = Jn(0, n, e), s = qi(0, a, i), l = new at(o, s, n, a);
  return l;
}
function pf(r, t, e, i) {
  var n = ((r || "") + "").split(`
...
function fs(r, t, e) {
  ...
  if (i instanceof Array)
    l += Ve(i[0], e.width), u += Ve(i[1], e.height), h = null, f = null;
  else
    switch (i) {
      case "left":
...
var Bl = "__zr_normal__", Nl = Ta.concat(["ignore"]), DS = wn(Ta, function(r, t) {
  return r[t] = !0, r;
}, { ignore: !1 }), Ri = {}, AS = new at(0, 0, 0, 0), Ns = function() {
  function r(t) {
    this.id = Rg(), this.animators = [], this.currentStates = [], this.states = {}, this._init(t);
  }
  return r.prototype._init = function(t) {
    ...
    if (e && (!e.ignore || t)) {
      ...
      if (a.copyTransform(e), i.position != null) {
        var h = AS;
        i.layoutRect ? h.copy(i.layoutRect) : h.copy(this.getBoundingRect()), n || h.applyTransform(this.transform), this.calculateTextPosition ? this.calculateTextPosition(Ri, i, h) : fs(Ri, i, h), a.x = Ri.x, a.y = Ri.y, o = Ri.align, s = Ri.verticalAlign;
        var f = i.origin;
        if (f && i.rotation != null) {
          var v = void 0, c = void 0;
          f === "center" ? (v = h.width * 0.5, c = h.height * 0.5) : (v = Ve(f[0], h.width), c = Ve(f[1], h.height)), u = !0, a.originX = -a.x + v + (n ? 0 : h.x), a.originY = -a.y + c + (n ? 0 : h.y);
        }
      }
    ...
    return this.__zr && this.__zr.isDarkMode() ? ih : rh;
  }, r.prototype.getOutsideStroke = function(t) {
    var e = this.__zr && this.__zr.getBackgroundColor(), i = typeof e == "string" && de(e);
    i || (i = [255, 255, 255, 1]);
    for (var n = i[3], a = this.__zr.isDarkMode(), o = 0; o < 3; o++)
      i[o] = i[o] * n + (a ? 0 : 255) * (1 - n);
    return i[3] = 1, ir(i, "rgba");
    ...
    for (var l = {}, u = !1, h = 0; h < Nl.length; h++) {
      var f = Nl[h], v = a && DS[f];
    ...
    var e = this._textContent;
    e !== t && (e && e !== t && this.removeTextContent(), t.innerTransformable = new vf(), this._attachComponent(t), this._textContent = t, this.markRedraw());
    ...
    var n = t ? this[t] : this, a = new cf(n, e, i);
    ...
    for (var a = zl(this, e, i, n), o = 0; o < a.length; o++)
...
function LS(r, t, e) {
  if (Zt(t[e]))
    if (Zt(r[e]) || (r[e] = []), Kt(t[e])) {
      var i = t[e].length;
      r[e].length !== i && (r[e] = new t[e].constructor(i), $l(r[e], t[e], i));
    } else {
      var n = t[e], a = r[e], o = n.length;
      if (IS(n))
        for (var s = n[0].length, l = 0; l < o; l++)
          a[l] ? $l(a[l], n[l], s) : a[l] = Array.prototype.slice.call(n[l]);
      else
        $l(a, n, o);
      a.length = n.length;
    }
...
function jg(r, t, e, i, n, a, o, s) {
  for (var l = vt(i), u = n.duration, h = n.delay, f = n.additive, v = n.setToFinal, c = !V(a), p = r.animators, g = [], d = 0; d < l.length; d++) {
    var y = l[d], m = i[y];
  ...
  if (n.force || (g = Lt(g, function(T) {
    ...
    var w = new cf(e, !1, !1, f ? Lt(p, function(I) {
...
var kS = function() {
  function r(t, e, i) {
    ...
    Wo[o] || (o = vt(Wo)[0]), i.useDirtyRect = i.useDirtyRect == null ? !1 : i.useDirtyRect;
    var s = new Wo[o](e, a, i, t), l = i.ssr || s.ssrOnly;
    this.storage = a, this.painter = s;
    var u = !Y.node && !Y.worker && !l ? new TS(s.getViewportRoot(), s.root) : null, h = i.useCoarsePointer, f = h == null || h === "auto" ? Y.touchEventsSupported : !!h, v = 44, c;
    f && (c = J(i.pointerSize, v)), this.handler = new $g(a, s, u, s.root, c), this.animation = new yS({
      stage: {
  ...
  return r.prototype.add = function(t) {
    ...
    this._disposed || (this.animation.stop(), this.clear(), this.storage.dispose(), this.painter.dispose(), this.handler.dispose(), this.animation = this.storage = this.painter = this.handler = null, this._disposed = !0, ES(this.id));
  }, r;
}();
function Jc(r, t) {
  var e = new kS(Rg(), r, t);
...
function Ft(r, t) {
  ...
  return F(r) ? NS(r).match(/%$/) ? parseFloat(r) / 100 * t : parseFloat(r) : r == null ? NaN : +r;
}
function Tt(r, t, e) {
  return t == null && (t = 10), t = Math.min(Math.max(0, t), ty), r = (+r).toFixed(t), e ? r : +r;
}
function ey(r) {
...
function FS(r, t) {
  var e = Math.max(tr(r), tr(t)), i = r + t;
  return e > ty ? i : Tt(i, e);
}
function ry(r) {
  var t = Math.PI * 2;
  return (r % t + t) % t;
...
var VS = /^(?:(\d{4})(?:[-\/](\d{1,2})(?:[-\/](\d{1,2})(?:[T ](\d{1,2})(?::(\d{1,2})(?::(\d{1,2})(?:[.,](\d+))?)?)?(Z|[\+\-]\d\d:?\d\d)?)?)?)?)?$/;
function or(r) {
...
function iy(r, t) {
  var e = gf(r), i = Math.pow(10, e), n = r / i, a;
...
var av = ["fontStyle", "fontWeight", "fontSize", "fontFamily", "rich", "tag", "color", "textBorderColor", "textBorderWidth", "width", "height", "lineHeight", "align", "verticalAlign", "baseline", "shadowColor", "shadowBlur", "shadowOffsetX", "shadowOffsetY", "textShadowColor", "textShadowBlur", "textShadowOffsetX", "textShadowOffsetY", "backgroundColor", "borderColor", "borderWidth", "borderRadius", "padding"];
function Ha(r) {
...
function YS(r, t, e) {
  ...
  var s = XS(r, o, e);
  return (i || n) && qS(s, r, o, t), i && ZS(s, t), i || n ? KS(s, t, n) : a && QS(s, t), jS(s), s;
}
function XS(r, t, e) {
  var i = [];
  if (e === "replaceAll")
  ...
  for (var n = 0; n < r.length; n++) {
    ...
    a && a.id != null && t.set(a.id, n), i.push({
      existing: e === "replaceMerge" || Ca(a) ? null : a,
      newOption: null,
      keyInfo: null,
      brandNew: null
    });
...
function qS(r, t, e, i) {
  C(i, function(n, a) {
    if (!(!n || n.id == null)) {
      var o = la(n.id), s = e.get(o);
      if (s != null) {
        var l = r[s];
        Fe(!l.newOption, 'Duplicated option on id "' + o + '".'), l.newOption = n, l.existing = t[s], i[a] = null;
      }
    }
  });
}
function ZS(r, t) {
  C(t, function(e, i) {
    if (!(!e || e.name == null))
      for (var n = 0; n < r.length; n++) {
        var a = r[n].existing;
        if (!r[n].newOption && a && (a.id == null || e.id == null) && !Ca(e) && !Ca(a) && sy("name", a, e)) {
  ...
  C(t, function(i) {
    if (i) {
      for (
        ...
        (n = r[a]) && (n.newOption || Ca(n.existing) || // In mode "replaceMerge", here no not-mapped-non-internal-existing.
        n.existing && i.id != null && !sy("id", i, n.existing));
      )
        a++;
...
function jS(r) {
  ...
  C(r, function(e) {
    ...
    var i = e.newOption;
    Fe(!i || i.id == null || !t.get(i.id) || t.get(i.id) === e, "id duplicates: " + (i && i.id)), i && i.id != null && t.set(i.id, e), !e.keyInfo && (e.keyInfo = {});
  }), C(r, function(e, i) {
    var n = e.existing, a = e.newOption, o = e.keyInfo;
    if (V(a)) {
      if (o.name = a.name != null ? la(a.name) : n ? n.name : oy + i, n)
        o.id = la(n.id);
      else if (a.id != null)
        o.id = la(a.id);
      else {
...
function sy(r, t, e) {
  var i = Me(t[r], null), n = Me(e[r], null);
...
function Me(r, t) {
  return r == null ? t : F(r) ? r : pt(r) || Vu(r) ? r + "" : t;
}
function yf(r) {
  var t = r.name;
  return !!(t && t.indexOf(oy));
}
function Ca(r) {
  return r && r.id != null && la(r.id).indexOf(WS) === 0;
}
function JS(r, t, e) {
  C(r, function(i) {
    var n = i.newOption;
    V(n) && (i.keyInfo.mainType = t, i.keyInfo.subType = tb(t, n, i.existing, e));
  });
}
function tb(r, t, e, i) {
...
function eb(r, t) {
  ...
  function n(o, s, l) {
    for (var u = 0, h = o.length; u < h; u++) {
      var f = Me(o[u].seriesId, null);
      if (f == null)
        return;
      for (var v = Rt(o[u].dataIndex), c = l && l[f], p = 0, g = v.length; p < g; p++) {
        var d = v[p];
...
function wi(r, t) {
  ...
  if (t.dataIndex != null)
    return z(t.dataIndex) ? W(t.dataIndex, function(e) {
      return r.indexOfRawIndex(e);
    }) : r.indexOfRawIndex(t.dataIndex);
  if (t.name != null)
    return z(t.name) ? W(t.name, function(e) {
      return r.indexOfName(e);
    }) : r.indexOfName(t.name);
}
function Dt() {
  var r = "__ec_inner_" + rb++;
  return function(t) {
    return t[r] || (t[r] = {});
  };
}
var rb = ny();
function Fl(r, t, e) {
  var i = mf(t, e), n = i.mainTypeSpecified, a = i.queryOptionMap, o = i.others, s = o, l = e ? e.defaultMainType : null;
...
function Ga(r, t, e, i) {
  ...
  return n === "none" || n === !1 ? (Fe(i.enableNone, '`"none"` or `false` is not a valid value on index option.'), s.models = [], s) : (n === "all" && (Fe(i.enableAll, '`"all"` is not a valid value on index option.'), n = a = o = null), s.models = r.queryComponents({
    mainType: t,
    index: n,
    id: a,
    name: o
...
function ab(r, t, e, i, n) {
  var a = t == null || t === "auto";
  if (i == null)
    return i;
  if (pt(i)) {
    var o = iv(e || 0, i, n);
    return Tt(o, a ? Math.max(tr(e || 0), tr(i)) : t);
  } else {
    if (F(i))
      return n < 1 ? e : i;
    for (var s = [], l = e, u = i, h = Math.max(l ? l.length : 0, u.length), f = 0; f < h; ++f) {
      ...
      if (v && v.type === "ordinal")
        ...
        var c = l && l[f] ? l[f] : 0, p = u[f], o = iv(c, p, n);
        s[f] = Tt(o, a ? Math.max(tr(c), tr(p)) : t);
      }
    }
    return s;
  }
}
var ob = ".", Yr = "___EC__COMPONENT__CONTAINER___", uy = "___EC__EXTENDED_CLASS___";
function ze(r) {
  var t = {
    main: "",
    sub: ""
...
function sb(r) {
  Fe(/^[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)?$/.test(r), 'componentType "' + r + '" illegal');
}
function lb(r) {
  return !!(r && r[uy]);
}
function _f(r, t) {
  r.$constructor = r, r.extend = function(e) {
    ...
    }, c1(n, this)), B(n.prototype, e), n[uy] = !0, n.extend = this.extend, n.superCall = cb, n.superApply = vb, n.superClass = i, n;
  };
}
function ub(r) {
...
var hb = Math.round(Math.random() * 10);
function fb(r) {
  var t = ["__\0is_clz", hb++].join("_");
...
function zs(r) {
  ...
  r.registerClass = function(i) {
    ...
    var n = ze(i), a = t[n.main];
    return a && a[Yr];
  };
  function e(i) {
    var n = t[i.main];
    return (!n || !n[Yr]) && (n = t[i.main] = {}, n[Yr] = !0), n;
  }
}
function Ma(r, t) {
  for (var e = 0; e < r.length; e++)
  ...
  if (r)
    if (typeof r == "string") {
      if (t && t.__zrImageSrc === r || !e)
        return t;
      var a = nh.get(r), o = { hostEl: e, cb: i, cbPayload: n };
      return a ? (t = a.image, !$s(t) && a.pending.push(o)) : (t = Er.loadImage(r, ov, ov), t.__zrImageSrc = r, nh.put(r, t.__cachedImgObj = {
        image: t,
        pending: [o]
      })), t;
    } else
...
`);
  ...
  for (var s = !1, l = {}, u = 0, h = o.length; u < h; u++)
    vy(l, o[u], a), o[u] = l.textLine, s = s || l.isTruncated;
  r.text = o.join(`
`), r.isTruncated = s;
}
function cy(r, t, e, i) {
  ...
  n.cnCharWidth = ee("国", t);
  var o = n.ascCharWidth = ee("a", t);
...
function vy(r, t, e) {
  ...
  for (var s = 0; ; s++) {
    ...
    var l = s === 0 ? _b(t, a, e.ascCharWidth, e.cnCharWidth) : o > 0 ? Math.floor(t.length * a / o) : 0;
    t = t.substr(0, l), o = ee(t, n);
  }
...
function Sb(r, t) {
  r != null && (r += "");
  var e = t.overflow, i = t.padding, n = t.font, a = e === "truncate", o = df(n), s = J(t.lineHeight, o), l = !!t.backgroundColor, u = t.lineOverflow === "truncate", h = !1, f = t.width, v;
  f != null && (e === "break" || e === "breakAll") ? v = r ? py(r, t.font, f, e === "breakAll", 0).lines : [] : v = r ? r.split(`
`) : [];
  ...
  if (r && a && f != null)
    for (var d = cy(f, n, t.ellipsis, {
      minChar: t.truncateMinChar,
      placeholder: t.placeholder
    }), y = {}, m = 0; m < v.length; m++)
      vy(y, v[m], d), v[m] = y.textLine, h = h || y.isTruncated;
  for (var _ = p, S = 0, m = 0; m < v.length; m++)
    S = Math.max(ee(v[m], n), S);
  f == null && (f = S);
  var w = S;
...
function xb(r, t) {
  ...
  if (r != null && (r += ""), !r)
    return e;
  for (var i = t.width, n = t.height, a = t.overflow, o = (a === "break" || a === "breakAll") && i != null ? { width: i, accumWidth: 0, breakAll: a === "breakAll" } : null, s = Vl.lastIndex = 0, l; (l = Vl.exec(r)) != null; ) {
    var u = l.index;
    u > s && Hl(e, r.substring(s, u), t, o), Hl(e, l[2], t, o, l[1]), s = Vl.lastIndex;
  }
  s < r.length && Hl(e, r.substring(s, r.length), t, o);
  var h = [], f = 0, v = 0, c = t.padding, p = a === "truncate", g = t.lineOverflow === "truncate", d = {};
  function y(G, K, tt) {
    G.width = K, G.lineHeight = tt, f += tt, v = Math.max(v, K);
  }
  t: for (var m = 0; m < e.lines.length; m++) {
    for (var _ = e.lines[m], S = 0, w = 0, b = 0; b < _.tokens.length; b++) {
      var x = _.tokens[b], M = x.styleName && t.rich[x.styleName] || {}, D = x.textPadding = M.padding, A = D ? D[1] + D[3] : 0, T = x.font = M.font || t.font;
      ...
      if (x.innerHeight = I, D && (I += D[0] + D[2]), x.height = I, x.lineHeight = zo(M.lineHeight, t.lineHeight, I), x.align = M && M.align || t.align, x.verticalAlign = M && M.verticalAlign || "middle", g && n != null && f + x.lineHeight > n) {
        ...
        b > 0 ? (_.tokens = _.tokens.slice(0, b), y(_, w, S), e.lines = e.lines.slice(0, m + 1)) : e.lines = e.lines.slice(0, m), e.isTruncated = e.isTruncated || e.lines.length < L;
        break t;
      }
      var P = M.width, R = P == null || P === "auto";
      if (typeof P == "string" && P.charAt(P.length - 1) === "%")
        x.percentWidth = P, h.push(x), x.contentWidth = ee(x.text, T);
      else {
        if (R) {
          var E = M.backgroundColor, H = E && E.image;
          H && (H = yb(H), $s(H) && (x.width = Math.max(x.width, H.width * I / H.height)));
        }
        var O = p && i != null ? i - w : null;
        O != null && O < x.width ? !R || O < A ? (x.text = "", x.width = x.contentWidth = 0) : (mb(d, x.text, O - A, T, t.ellipsis, { minChar: t.truncateMinChar }), x.text = d.text, e.isTruncated = e.isTruncated || d.isTruncated, x.width = x.contentWidth = ee(x.text, T)) : x.contentWidth = ee(x.text, T);
      }
      x.width += A, w += x.width, M && (S = Math.max(S, x.lineHeight));
    }
    y(_, w, S);
  }
  ...
  for (var m = 0; m < h.length; m++) {
    var x = h[m], $ = x.percentWidth;
    x.width = parseInt($, 10) / 100 * e.width;
  }
  return e;
}
function Hl(r, t, e, i, n) {
  var a = t === "", o = n && e.rich[n] || {}, s = r.lines, l = o.font || e.font, u = !1, h, f;
  if (i) {
    var v = o.padding, c = v ? v[1] + v[3] : 0;
    if (o.width != null && o.width !== "auto") {
      var p = Ve(o.width, i.width) + c;
      s.length > 0 && p + i.accumWidth > i.width && (h = t.split(`
`), u = !0), i.accumWidth = p;
    } else {
      var g = py(t, l, i.width, i.breakAll, i.accumWidth);
...
`);
  for (var d = 0; d < h.length; d++) {
    var y = h[d], m = new bb();
    if (m.styleName = n, m.text = y, m.isLineHolder = !y && !a, typeof o.width == "number" ? m.width = o.width : m.width = f ? f[d] : ee(y, l), !d && !u) {
...
var ah = "__zr_style_" + Math.round(Math.random() * 10), gi = {
  shadowBlur: 0,
  shadowOffsetX: 0,
  shadowOffsetY: 0,
  shadowColor: "#000",
...
gi[ah] = !0;
var lv = ["z", "z2", "invisible"], Db = ["invisible"], Wa = function(r) {
  N(t, r);
  function t(e) {
  ...
  return t.prototype._init = function(e) {
    ...
    if (this.ignore || this.invisible || this.style.opacity === 0 || this.culling && Ab(this, e, i) || o && !o[0] && !o[3])
      return !1;
    ...
    e || this.markRedraw(), this.__dirty |= Qn, this._rect && (this._rect = null);
    ...
    if (i && i.style ? o ? a ? u = i.style : (u = this._mergeStyle(this.createStyle(), n.style), this._mergeStyle(u, i.style)) : (u = this._mergeStyle(this.createStyle(), a ? this.style : n.style), this._mergeStyle(u, i.style)) : l && (u = n.style), u)
      if (o) {
        ...
        if (this.style = this.createStyle(l ? {} : h), l)
          for (var f = vt(h), v = 0; v < f.length; v++) {
            var c = f[v];
            c in u && (u[c] = u[c], this.style[c] = h[c]);
          }
        for (var p = vt(u), v = 0; v < p.length; v++) {
          var c = p[v];
        ...
        this.useStyle(u);
    for (var g = this.__inHover ? Db : lv, v = 0; v < g.length; v++) {
      var c = g[v];
    ...
    var e = t.prototype;
    e.type = "displayable", e.invisible = !1, e.z = 0, e.z2 = 0, e.zlevel = 0, e.culling = !1, e.cursor = "pointer", e.rectHover = !1, e.incremental = !1, e._rect = null, e.dirtyRectTolerance = 0, e.__dirty = te | Qn;
  }(), t;
}(Ns), Gl = new at(0, 0, 0, 0), Wl = new at(0, 0, 0, 0);
function Ab(r, t, e) {
  return Gl.copy(r.getBoundingRect()), r.transform && Gl.applyTransform(r.transform), Wl.width = t, Wl.height = e, !Gl.intersect(Wl);
}
var he = Math.min, fe = Math.max, Ul = Math.sin, Yl = Math.cos, Xr = Math.PI * 2, no = xn(), ao = xn(), oo = xn();
function uv(r, t, e, i, n, a) {
  n[0] = he(r, e), n[1] = he(t, i), a[0] = fe(r, e), a[1] = fe(t, i);
}
var hv = [], fv = [];
function Ib(r, t, e, i, n, a, o, s, l, u) {
  var h = Wg, f = Pt, v = h(r, e, n, o, hv);
  l[0] = 1 / 0, l[1] = 1 / 0, u[0] = -1 / 0, u[1] = -1 / 0;
  for (var c = 0; c < v; c++) {
    var p = f(r, e, n, o, hv[c]);
    l[0] = he(p, l[0]), u[0] = fe(p, u[0]);
  }
  v = h(t, i, a, s, fv);
  for (var c = 0; c < v; c++) {
    var g = f(t, i, a, s, fv[c]);
    l[1] = he(g, l[1]), u[1] = fe(g, u[1]);
  }
  l[0] = he(r, l[0]), u[0] = fe(r, u[0]), l[0] = he(o, l[0]), u[0] = fe(o, u[0]), l[1] = he(t, l[1]), u[1] = fe(t, u[1]), l[1] = he(s, l[1]), u[1] = fe(s, u[1]);
}
function Lb(r, t, e, i, n, a, o, s) {
  var l = Ug, u = Yt, h = fe(he(l(r, e, n), 1), 0), f = fe(he(l(t, i, a), 1), 0), v = u(r, e, n, h), c = u(t, i, a, f);
  o[0] = he(r, n, v), o[1] = he(t, a, c), s[0] = fe(r, n, v), s[1] = fe(t, a, c);
}
function Pb(r, t, e, i, n, a, o, s, l) {
  var u = Zi, h = Ki, f = Math.abs(n - a);
  if (f % Xr < 1e-4 && f > 1e-4) {
    s[0] = r - e, s[1] = t - i, l[0] = r + e, l[1] = t + i;
    return;
  }
  if (no[0] = Yl(n) * e + r, no[1] = Ul(n) * i + t, ao[0] = Yl(a) * e + r, ao[1] = Ul(a) * i + t, u(s, no, ao), h(l, no, ao), n = n % Xr, n < 0 && (n = n + Xr), a = a % Xr, a < 0 && (a = a + Xr), n > a && !o ? a += Xr : n < a && o && (n += Xr), o) {
    var v = a;
    a = n, n = v;
  }
  for (var c = 0; c < a; c += Math.PI / 2)
    c > n && (oo[0] = Yl(c) * e + r, oo[1] = Ul(c) * i + t, u(s, oo, s), h(l, oo, l));
}
var nt = {
  M: 1,
  L: 2,
  ...
  Z: 6,
  R: 7
}, qr = [], Zr = [], Pe = [], dr = [], Re = [], Ee = [], Xl = Math.min, ql = Math.max, Kr = Math.cos, Qr = Math.sin, Qe = Math.abs, oh = Math.PI, Tr = oh * 2, Zl = typeof Float32Array < "u", kn = [];
function Kl(r) {
...
function Rb(r, t) {
  ...
  e < 0 && (e += Tr);
  var i = e - r[0], n = r[1];
  n += i, !t && n - e >= Tr ? n = e + Tr : t && e - n >= Tr ? n = e - Tr : !t && e > n ? n = e + (Tr - Kl(e - n)) : t && e < n && (n = e - (Tr - Kl(n - e))), r[0] = e, r[1] = n;
}
var xi = function() {
  function r(t) {
  ...
  return r.prototype.increaseVersion = function() {
    ...
    i = i || 0, i > 0 && (this._ux = Qe(i / hs / t) || 0, this._uy = Qe(i / hs / e) || 0);
    ...
    var i = Qe(t - this._xi), n = Qe(e - this._yi), a = i > this._ux || n > this._uy;
    ...
    this._drawPendingPt(), kn[0] = n, kn[1] = a, Rb(kn, o), n = kn[0], a = kn[1];
    var s = a - n;
    return this.addData(nt.A, t, e, i, i, n, s, 0, o ? 0 : 1), this._ctx && this._ctx.arc(t, e, i, n, a, o), this._xi = Kr(a) * i + t, this._yi = Qr(a) * i + e, this;
    ...
    var e = t.length;
    !(this.data && this.data.length === e) && Zl && (this.data = new Float32Array(e));
    for (var i = 0; i < e; i++)
      this.data[i] = t[i];
    this._len = e;
    ...
    for (var e = t.length, i = 0, n = this._len, a = 0; a < e; a++)
      i += t[a].len();
    Zl && this.data instanceof Float32Array && (this.data = new Float32Array(n + i));
    for (var a = 0; a < e; a++)
    ...
    if (this._saveData) {
      this._drawPendingPt();
      var t = this.data;
      t instanceof Array && (t.length = this._len, Zl && this._len > 11 && (this.data = new Float32Array(t)));
    }
  }, r.prototype.getBoundingRect = function() {
    Pe[0] = Pe[1] = Re[0] = Re[1] = Number.MAX_VALUE, dr[0] = dr[1] = Ee[0] = Ee[1] = -Number.MAX_VALUE;
    var t = this.data, e = 0, i = 0, n = 0, a = 0, o;
    for (o = 0; o < this._len; ) {
      var s = t[o++], l = o === 1;
      switch (l && (e = t[o], i = t[o + 1], n = e, a = i), s) {
        case nt.M:
          e = n = t[o++], i = a = t[o++], Re[0] = n, Re[1] = a, Ee[0] = n, Ee[1] = a;
          break;
        case nt.L:
          uv(e, i, t[o], t[o + 1], Re, Ee), e = t[o++], i = t[o++];
          break;
        case nt.C:
          Ib(e, i, t[o++], t[o++], t[o++], t[o++], t[o], t[o + 1], Re, Ee), e = t[o++], i = t[o++];
          break;
        case nt.Q:
          Lb(e, i, t[o++], t[o++], t[o], t[o + 1], Re, Ee), e = t[o++], i = t[o++];
          break;
        case nt.A:
          var u = t[o++], h = t[o++], f = t[o++], v = t[o++], c = t[o++], p = t[o++] + c;
          o += 1;
          var g = !t[o++];
          l && (n = Kr(c) * f + u, a = Qr(c) * v + h), Pb(u, h, f, v, c, p, g, Re, Ee), e = Kr(p) * f + u, i = Qr(p) * v + h;
          break;
        case nt.R:
          n = e = t[o++], a = i = t[o++];
          var d = t[o++], y = t[o++];
          uv(n, a, n + d, a + y, Re, Ee);
          break;
        case nt.Z:
          e = n, i = a;
          break;
      }
      Zi(Pe, Pe, Re), Ki(dr, dr, Ee);
    }
    return o === 0 && (Pe[0] = Pe[1] = dr[0] = dr[1] = 0), new at(Pe[0], Pe[1], dr[0] - Pe[0], dr[1] - Pe[1]);
    ...
    for (var u = this._pathSegLen, h = 0, f = 0, v = 0; v < e; ) {
      ...
      switch (c) {
        ...
        case nt.L: {
          ...
          (Qe(m) > i || Qe(_) > n || v === e - 1) && (g = Math.sqrt(m * m + _ * _), a = d, o = y);
          break;
        }
        case nt.C: {
          var S = t[v++], w = t[v++], d = t[v++], y = t[v++], b = t[v++], x = t[v++];
          g = J1(a, o, S, w, d, y, b, x, 10), a = b, o = x;
          break;
        }
        case nt.Q: {
          var S = t[v++], w = t[v++], d = t[v++], y = t[v++];
          g = rS(a, o, S, w, d, y, 10), a = d, o = y;
          break;
        }
        case nt.A:
          var M = t[v++], D = t[v++], A = t[v++], T = t[v++], I = t[v++], L = t[v++], P = L + I;
          v += 1, p && (s = Kr(I) * A + M, l = Qr(I) * T + D), g = ql(A, T) * Xl(Tr, Math.abs(L)), a = Kr(P) * A + M, o = Qr(P) * T + D;
          break;
        case nt.R: {
          s = a = t[v++], l = o = t[v++];
          var R = t[v++], E = t[v++];
    ...
    var i = this.data, n = this._ux, a = this._uy, o = this._len, s, l, u, h, f, v, c = e < 1, p, g, d = 0, y = 0, m, _ = 0, S, w;
    if (!(c && (this._pathSegLen || this._calculateLength(), p = this._pathSegLen, g = this._pathLen, m = e * g, !m)))
      t: for (var b = 0; b < o; ) {
        var x = i[b++], M = b === 1;
        switch (M && (u = i[b], h = i[b + 1], s = u, l = h), x !== nt.L && _ > 0 && (t.lineTo(S, w), _ = 0), x) {
          case nt.M:
            s = u = i[b++], l = h = i[b++], t.moveTo(u, h);
            break;
          case nt.L: {
            f = i[b++], v = i[b++];
            var D = Qe(f - u), A = Qe(v - h);
            if (D > n || A > a) {
              if (c) {
                var T = p[y++];
                if (d + T > m) {
          ...
          case nt.C: {
            var P = i[b++], R = i[b++], E = i[b++], H = i[b++], O = i[b++], $ = i[b++];
            if (c) {
              var T = p[y++];
              if (d + T > m) {
                var I = (m - d) / T;
                ss(u, P, E, O, I, qr), ss(h, R, H, $, I, Zr), t.bezierCurveTo(qr[1], Zr[1], qr[2], Zr[2], qr[3], Zr[3]);
                break t;
              }
              d += T;
            }
            t.bezierCurveTo(P, R, E, H, O, $), u = O, h = $;
            break;
          }
          case nt.Q: {
            var P = i[b++], R = i[b++], E = i[b++], H = i[b++];
            if (c) {
              var T = p[y++];
              if (d + T > m) {
                var I = (m - d) / T;
                ls(u, P, E, I, qr), ls(h, R, H, I, Zr), t.quadraticCurveTo(qr[1], Zr[1], qr[2], Zr[2]);
                break t;
              }
              d += T;
            }
            t.quadraticCurveTo(P, R, E, H), u = E, h = H;
            break;
          }
          case nt.A:
            var G = i[b++], K = i[b++], tt = i[b++], ut = i[b++], dt = i[b++], St = i[b++], me = i[b++], Nr = !i[b++], Ai = tt > ut ? tt : ut, jt = Qe(tt - ut) > 1e-3, It = dt + St, Z = !1;
            if (c) {
              var T = p[y++];
              d + T > m && (It = dt + St * (m - d) / T, Z = !0), d += T;
            }
            if (jt && t.ellipse ? t.ellipse(G, K, tt, ut, me, dt, It, Nr) : t.arc(G, K, Ai, dt, It, Nr), Z)
              break t;
            M && (s = Kr(dt) * tt + G, l = Qr(dt) * ut + K), u = Kr(It) * tt + G, h = Qr(It) * ut + K;
            break;
          case nt.R:
            s = u = i[b], l = h = i[b + 1], f = i[b++], v = i[b++];
            var et = i[b++], zr = i[b++];
            if (c) {
              var T = p[y++];
              if (d + T > m) {
                var zt = m - d;
                t.moveTo(f, v), t.lineTo(f + Xl(zt, et), v), zt -= et, zt > 0 && t.lineTo(f + et, v + Xl(zt, zr)), zt -= zr, zt > 0 && t.lineTo(f + ql(et - zt, 0), v + zr), zt -= et, zt > 0 && t.lineTo(f, v + ql(zr - zt, 0));
                break t;
              }
              d += T;
            }
...
function Eb(r, t, e, i, n, a, o, s, l, u, h) {
  if (l === 0)
    return !1;
  var f = l;
...
function kb(r, t, e, i, n, a, o, s, l) {
  ...
  return v < 0 && (v += Bn), v >= i && v <= n || v + Bn >= i && v + Bn <= n;
}
function jr(r, t, e, i, n, a) {
...
var gr = xi.CMD, Jr = Math.PI * 2, Bb = 1e-4;
function Nb(r, t) {
  return Math.abs(r - t) < Bb;
}
var $t = [-1, -1, -1], le = [-1, -1];
function zb() {
  var r = le[0];
...
function $b(r, t, e, i, n, a, o, s, l, u) {
  if (u > t && u > i && u > a && u > s || u < t && u < i && u < a && u < s)
    return 0;
  var h = os(t, i, a, s, u, $t);
  if (h === 0)
    return 0;
  for (var f = 0, v = -1, c = void 0, p = void 0, g = 0; g < h; g++) {
    var d = $t[g], y = d === 0 || d === 1 ? 0.5 : 1, m = Pt(r, e, n, o, d);
    m < l || (v < 0 && (v = Wg(t, i, a, s, le), le[1] < le[0] && v > 1 && zb(), c = Pt(t, i, a, s, le[0]), v > 1 && (p = Pt(t, i, a, s, le[1]))), v === 2 ? d < le[0] ? f += c < t ? y : -y : d < le[1] ? f += p < c ? y : -y : f += s < p ? y : -y : d < le[0] ? f += c < t ? y : -y : f += s < c ? y : -y);
  }
  return f;
}
function Fb(r, t, e, i, n, a, o, s) {
  ...
  if (u >= 0 && u <= 1) {
    for (var h = 0, f = Yt(t, i, a, u), v = 0; v < l; v++) {
      var c = $t[v] === 0 || $t[v] === 1 ? 0.5 : 1, p = Yt(r, e, n, $t[v]);
      p < o || ($t[v] < u ? h += f < t ? c : -c : h += a < f ? c : -c);
    }
    return h;
  } else {
    var c = $t[0] === 0 || $t[0] === 1 ? 0.5 : 1, p = Yt(r, e, n, $t[0]);
    return p < o ? 0 : a < t ? c : -c;
  }
}
function Vb(r, t, e, i, n, a, o, s) {
  if (s -= t, s > e || s < -e)
    return 0;
  ...
  for (var v = 0, c = 0; c < 2; c++) {
    ...
    if (p + r > o) {
      ...
      g < 0 && (g = Jr + g), (g >= i && g <= n || g + Jr >= i && g + Jr <= n) && (g > Math.PI / 2 && g < Math.PI * 1.5 && (h = -h), v += h);
    }
  }
  return v;
}
function dy(r, t, e, i, n) {
  for (var a = r.data, o = r.len(), s = 0, l = 0, u = 0, h = 0, f = 0, v, c, p = 0; p < o; ) {
    var g = a[p++], d = p === 1;
    switch (g === gr.M && p > 1 && (e || (s += jr(l, u, h, f, i, n))), d && (l = a[p], u = a[p + 1], h = l, f = u), g) {
      case gr.M:
        h = a[p++], f = a[p++], l = h, u = f;
        break;
      case gr.L:
        if (e) {
          if (Ei(l, u, a[p], a[p + 1], t, i, n))
            return !0;
        } else
          s += jr(l, u, a[p], a[p + 1], i, n) || 0;
        l = a[p++], u = a[p++];
        break;
      case gr.C:
        if (e) {
          if (Eb(l, u, a[p++], a[p++], a[p++], a[p++], a[p], a[p + 1], t, i, n))
            return !0;
        } else
          s += $b(l, u, a[p++], a[p++], a[p++], a[p++], a[p], a[p + 1], i, n) || 0;
        l = a[p++], u = a[p++];
        break;
      case gr.Q:
        if (e) {
          if (Ob(l, u, a[p++], a[p++], a[p], a[p + 1], t, i, n))
            return !0;
        } else
          s += Fb(l, u, a[p++], a[p++], a[p], a[p + 1], i, n) || 0;
        l = a[p++], u = a[p++];
        break;
      case gr.A:
        ...
        p += 1;
        var x = !!(1 - a[p++]);
        v = Math.cos(w) * _ + y, c = Math.sin(w) * S + m, d ? (h = v, f = c) : s += jr(l, u, v, c, i, n);
        var M = (i - y) * S / _ + y;
        if (e) {
          if (kb(y, m, S, w, w + b, x, t, M, n))
            return !0;
        } else
          s += Vb(y, m, S, w, w + b, x, M, n);
      ...
      case gr.R:
        ...
        var D = a[p++], A = a[p++];
        if (v = h + D, c = f + A, e) {
          if (Ei(h, f, v, f, t, i, n) || Ei(v, f, v, c, t, i, n) || Ei(v, c, h, c, t, i, n) || Ei(h, c, h, f, t, i, n))
            return !0;
        } else
          s += jr(v, f, v, c, i, n), s += jr(h, c, h, f, i, n);
        break;
      case gr.Z:
        if (e) {
          if (Ei(l, u, h, f, t, i, n))
  ...
  return !e && !Nb(u, f) && (s += jr(l, u, h, f, i, n) || 0), s !== 0;
}
function Hb(r, t, e) {
  return dy(r, 0, !1, t, e);
}
...
var gy = ot({
  ...
  return t.prototype.update = function() {
    ...
    if (F(i)) {
      var n = this.__zr, a = !!(n && n.isDarkMode()), o = us(e, 0) < eh;
      if (a === o)
        return i;
    }
    ...
    if (n) {
      ...
      var o = this.path;
      (a || this.__dirty & Xi) && (o.beginPath(), this.buildPath(o, this.shape, !1), this.pathUpdated()), e = o.getBoundingRect();
    }
    ...
    if (e = n[0], i = n[1], a.contain(e, i)) {
      ...
      if (this.hasStroke()) {
        ...
        if (u > 1e-10 && (this.hasFill() || (l = Math.max(l, this.strokeContainThreshold)), Gb(s, l / u, e, i)))
          return !0;
      }
      if (this.hasFill())
        return Hb(s, e, i);
    ...
    this.__dirty |= Xi, this._rect && (this._rect = null), this._decalEl && this._decalEl.dirtyShape(), this.markRedraw();
  }, t.prototype.dirty = function() {
    ...
    if (i && i.shape ? o ? a ? u = i.shape : (u = B({}, n.shape), B(u, i.shape)) : (u = B({}, a ? this.shape : n.shape), B(u, i.shape)) : l && (u = n.shape), u)
      if (o) {
        ...
        for (var h = {}, f = vt(u), v = 0; v < f.length; v++) {
          var c = f[v];
    ...
    var e = t.prototype;
    e.type = "path", e.strokeContainThreshold = 5, e.segmentIgnoreThreshold = 0, e.subPixelOptimize = !1, e.autoBatch = !1, e.__dirty = te | Qn | Xi;
  }(), t;
}(Wa), Ub = ot({
  strokeFirst: !0,
  font: Si,
  ...
  return t.prototype.hasStroke = function() {
    ...
    if (!this._rect) {
      var i = e.text;
      i != null ? i += "" : i = "";
      var n = pf(i, e.font, e.textAlign, e.textBaseline);
...
var qe = function(r) {
  ...
  return t.prototype.createStyle = function(e) {
    ...
    if (n != null)
      return n;
    var a = qb(i.image) ? i.image : this.__image;
    if (!a)
      return 0;
...
function yy(r, t, e) {
  if (t) {
    ...
    var s = e && e.lineWidth;
    return s && (ji(i * 2) === ji(n * 2) && (r.x1 = r.x2 = ci(i, s, !0)), ji(a * 2) === ji(o * 2) && (r.y1 = r.y2 = ci(a, s, !0))), r;
  }
}
function my(r, t, e) {
  if (t) {
    ...
    var s = e && e.lineWidth;
    return s && (r.x = ci(i, s, !0), r.y = ci(n, s, !0), r.width = Math.max(ci(i + a, s, !1) - r.x, a === 0 ? 0 : 1), r.height = Math.max(ci(n + o, s, !1) - r.y, o === 0 ? 0 : 1)), r;
  }
}
function ci(r, t, e) {
  if (!t)
    return r;
  var i = ji(r * 2);
  return (i + ji(t)) % 2 === 0 ? i / 2 : (i + (e ? 1 : -1)) / 2;
}
...
var vv = {
  ...
  function t(e) {
    var i = r.call(this) || this;
    return i.type = "text", i._children = [], i._defaultStyle = vv, i.attr(e), i;
  }
  return t.prototype.childrenRef = function() {
    return this._children;
    ...
    this._childCursor = 0, iw(this.style), this.style.rich ? this._updateRichTexts() : this._updatePlainTexts(), this._children.length = this._childCursor, this.styleUpdated();
  }, t.prototype.addSelfToZr = function(e) {
    r.prototype.addSelfToZr.call(this, e);
    for (var i = 0; i < this._children.length; i++)
    ...
    var e = this.style, i = e.font || Si, n = e.padding, a = bv(e), o = Sb(a, e), s = jl(e), l = !!e.backgroundColor, u = o.outerHeight, h = o.outerWidth, f = o.contentWidth, v = o.lines, c = o.lineHeight, p = this._defaultStyle;
    this.isTruncated = !!o.isTruncated;
    var g = e.x || 0, d = e.y || 0, y = e.align || p.align || "left", m = e.verticalAlign || p.verticalAlign || "top", _ = g, S = qi(d, o.contentHeight, m);
    if (s || n) {
      var w = Jn(g, h, y), b = qi(d, u, m);
      s && this._renderBackground(e, e, w, b, h, u);
    }
    S += c / 2, n && (_ = Sv(g, y, n), m === "top" ? S += n[0] : m === "bottom" && (S -= n[2]));
    for (var x = 0, M = !1, D = _v("fill" in e ? e.fill : (M = !0, p.fill)), A = mv("stroke" in e ? e.stroke : !l && (!p.autoStroke || M) ? (x = pv, p.stroke) : null), T = e.textShadowBlur > 0, I = e.width != null && (e.overflow === "truncate" || e.overflow === "break" || e.overflow === "breakAll"), L = o.calculatedLineHeight, P = 0; P < v.length; P++) {
      var R = this._getOrCreateChild(ps), E = R.createStyle();
      R.useStyle(E), E.text = v[P], E.x = _, E.y = S, E.textAlign = y, E.textBaseline = "middle", E.opacity = e.opacity, E.strokeFirst = !0, T && (E.shadowBlur = e.textShadowBlur || 0, E.shadowColor = e.textShadowColor || "transparent", E.shadowOffsetX = e.textShadowOffsetX || 0, E.shadowOffsetY = e.textShadowOffsetY || 0), E.stroke = A, E.fill = D, A && (E.lineWidth = e.lineWidth || x, E.lineDash = e.lineDash, E.lineDashOffset = e.lineDashOffset || 0), E.font = i, gv(E, e), S += c, I && R.setBoundingRect(new at(Jn(E.x, f, E.textAlign), qi(E.y, L, E.textBaseline), f, L));
    }
  }, t.prototype._updateRichTexts = function() {
    var e = this.style, i = bv(e), n = xb(i, e), a = n.width, o = n.outerWidth, s = n.outerHeight, l = e.padding, u = e.x || 0, h = e.y || 0, f = this._defaultStyle, v = e.align || f.align, c = e.verticalAlign || f.verticalAlign;
    this.isTruncated = !!n.isTruncated;
    var p = Jn(u, o, v), g = qi(h, s, c), d = p, y = g;
    l && (d += l[3], y += l[0]);
    var m = d + a;
    jl(e) && this._renderBackground(e, e, p, g, o, s);
    for (var _ = !!e.backgroundColor, S = 0; S < n.lines.length; S++) {
      for (var w = n.lines[S], b = w.tokens, x = b.length, M = w.lineHeight, D = w.width, A = 0, T = d, I = m, L = x - 1, P = void 0; A < x && (P = b[A], !P.align || P.align === "left"); )
      ...
      for (T += (a - (T - d) - (m - I) - D) / 2; A <= L; )
        P = b[A], this._placeToken(P, e, M, y, T + P.width / 2, "center", _), T += P.width, A++;
      y += M;
    }
    ...
    p && (o = Sv(o, s, p), f -= e.height / 2 - p[0] - e.innerHeight / 2);
    var g = this._getOrCreateChild(ps), d = g.createStyle();
    g.useStyle(d);
    var y = this._defaultStyle, m = !1, _ = 0, S = _v("fill" in u ? u.fill : "fill" in i ? i.fill : (m = !0, y.fill)), w = mv("stroke" in u ? u.stroke : "stroke" in i ? i.stroke : !c && !l && (!y.autoStroke || m) ? (_ = pv, y.stroke) : null), b = u.textShadowBlur > 0 || i.textShadowBlur > 0;
    d.text = e.text, d.x = o, d.y = f, b && (d.shadowBlur = u.textShadowBlur || i.textShadowBlur || 0, d.shadowColor = u.textShadowColor || i.textShadowColor || "transparent", d.shadowOffsetX = u.textShadowOffsetX || i.textShadowOffsetX || 0, d.shadowOffsetY = u.textShadowOffsetY || i.textShadowOffsetY || 0), d.textAlign = s, d.textBaseline = "middle", d.font = e.font || Si, d.opacity = zo(u.opacity, i.opacity, 1), gv(d, u), w && (d.lineWidth = zo(u.lineWidth, i.lineWidth, _), d.lineDash = J(u.lineDash, i.lineDash), d.lineDashOffset = i.lineDashOffset || 0, d.stroke = w), S && (d.fill = S);
    var x = e.contentWidth, M = e.contentHeight;
    g.setBoundingRect(new at(Jn(d.x, x, d.textAlign), qi(d.y, M, d.textBaseline), x, M));
    ...
    if (v) {
      ...
      d = this._getOrCreateChild(qe), d.onload = function() {
        p.dirtyStyle();
      };
      var _ = d.style;
    ...
    var S = (g || d).style;
    S.shadowBlur = e.shadowBlur || 0, S.shadowColor = e.shadowColor || "transparent", S.shadowOffsetX = e.shadowOffsetX || 0, S.shadowOffsetY = e.shadowOffsetY || 0, S.opacity = zo(e.opacity, i.opacity, 1);
...
}(Wa), Jb = { left: !0, right: 1, center: 1 }, tw = { top: 1, bottom: 1, middle: 1 }, dv = ["fontStyle", "fontWeight", "fontSize", "fontFamily"];
function ew(r) {
  return typeof r == "string" && (r.indexOf("px") !== -1 || r.indexOf("rem") !== -1 || r.indexOf("em") !== -1) ? r : isNaN(+r) ? rf + "px" : r + "px";
}
function gv(r, t) {
...
function yv(r) {
  if (r) {
    ...
    var t = r.align;
    t === "middle" && (t = "center"), r.align = t == null || Jb[t] ? t : "left";
    var e = r.verticalAlign;
    e === "center" && (e = "middle"), r.verticalAlign = e == null || tw[e] ? e : "top";
    var i = r.padding;
    i && (r.padding = Eg(r.padding));
  }
}
function mv(r, t) {
...
}, wv = 1, xv = {}, _y = Dt(), Sf = Dt(), bf = 0, Vs = 1, Hs = 2, He = ["emphasis", "blur", "select"], Tv = ["normal", "emphasis", "blur", "select"], aw = 10, ow = 9, yi = "highlight", Uo = "downplay", ua = "select", Yo = "unselect", ha = "toggleSelect";
function Oi(r) {
...
function by(r) {
  r.hoverState === Hs && Gs(r, "normal", bf);
}
function wf(r) {
  Gs(r, "blur", Vs);
}
function wy(r) {
  r.hoverState === Vs && Gs(r, "normal", bf);
}
function sw(r) {
  r.selected = !0;
}
...
function cr(r, t, e) {
  Cv(r, t, e), r.isGroup && r.traverse(function(i) {
    Cv(i, t, e);
  });
}
function Mv(r, t) {
...
function hw(r, t, e, i) {
  ...
  if (r instanceof lt) {
    var o = _y(r), s = n && o.selectFill || o.normalFill, l = n && o.selectStroke || o.normalStroke;
    if (Oi(s) || Oi(l)) {
      i = i || {};
      var u = i.style || {};
      u.fill === "inherit" ? (a = !0, i = B({}, i), u = B({}, u), u.fill = s) : !Oi(u.fill) && Oi(s) ? (a = !0, i = B({}, i), u = B({}, u), u.fill = Hc(s)) : !Oi(u.stroke) && Oi(l) && (a || (i = B({}, i), u = B({}, u)), u.stroke = Hc(l)), i.style = u;
    }
  }
  if (i && i.z2 == null) {
    a || (i = B({}, i));
...
function cw(r, t, e) {
  var i = ht(r.currentStates, t) >= 0, n = r.style.opacity, a = i ? null : uw(r, ["opacity"], t, {
    opacity: 1
  });
  e = e || {};
  var o = e.style || {};
...
function vw(r) {
  ...
  t && (t.stateProxy = Jl), e && (e.stateProxy = Jl);
}
function Dv(r, t) {
  !My(r, t) && !r.__highByOuter && cr(r, Sy);
}
function Av(r, t) {
  !My(r, t) && !r.__highByOuter && cr(r, by);
}
function ds(r, t) {
  r.__highByOuter |= 1 << (t || 0), cr(r, Sy);
}
function gs(r, t) {
  !(r.__highByOuter &= ~(1 << (t || 0))) && cr(r, by);
}
function pw(r) {
  cr(r, wf);
}
...
function Dy(r) {
  ...
  t.eachComponent(function(n, a) {
    var o = Sf(a), s = n === "series", l = s ? r.getViewOfSeriesModel(a) : r.getViewOfComponentModel(a);
    ...
    n.eachSeries(function(u) {
      ...
      (e === "series" && !h || e === "coordinateSystem" && !v || t === "series" && h)) {
        ...
        if (c.group.traverse(function(d) {
          d.__highByOuter && h && t === "self" || wf(d);
        }), Zt(t))
          a(u.getData(), t);
        else if (V(t))
          for (var p = vt(t), g = 0; g < p.length; g++)
            a(u.getData(p[g]), t[p[g]]);
        l.push(u), Sf(u).isBlured = !0;
      }
...
function gw(r, t, e) {
  var i = it(r), n = xf(i.componentMainType, i.componentIndex, i.componentHighDownName, e), a = n.dispatchers, o = n.focusSelf;
  a ? (o && lh(i.componentMainType, i.componentIndex, e), C(a, function(s) {
    return Dv(s, t);
  })) : (sh(i.seriesIndex, i.focus, i.blurScope, e), i.focus === "self" && lh(i.componentMainType, i.componentIndex, e), Dv(r, t));
}
function yw(r, t, e) {
  Dy(e);
  var i = it(r), n = xf(i.componentMainType, i.componentIndex, i.componentHighDownName, e).dispatchers;
  n ? C(n, function(a) {
    return Av(a, t);
  }) : Av(r, t);
}
function mw(r, t, e) {
  if (ch(t)) {
    var i = t.dataType, n = r.getData(i), a = wi(n, t);
    z(a) || (a = [a]), r[t.type === ha ? "toggleSelect" : t.type === ua ? "select" : "unselect"](a, i);
  }
}
function Iv(r) {
  var t = r.getAllData();
...
var Lv = ["emphasis", "blur", "select"], ww = {
...
function hh(r, t, e, i) {
  ...
  for (var n = 0; n < Lv.length; n++) {
    var a = Lv[n], o = t.getModel([a, e]), s = r.ensureState(a);
    s.style = o[ww[e]]();
  }
}
function Tf(r, t) {
...
function xw(r) {
  var t = xv[r];
  return t == null && wv <= 32 && (t = xv[r] = wv++), t;
}
function ch(r) {
  var t = r.type;
  return t === ua || t === Yo || t === ha;
}
function Pv(r) {
  var t = r.type;
  return t === yi || t === Uo;
...
var ki = xi.CMD, Cw = [[], [], []], Rv = Math.sqrt, Mw = Math.atan2;
function Dw(r, t) {
  if (t) {
    var e = r.data, i = r.len(), n, a, o, s, l, u, h = ki.M, f = ki.C, v = ki.L, c = ki.R, p = ki.A, g = ki.Q;
    for (o = 0, s = 0; o < i; ) {
      switch (n = e[o++], s = o, a = 0, n) {
        ...
        case g:
          ...
          break;
        case p:
          var d = t[4], y = t[5], m = Rv(t[0] * t[0] + t[1] * t[1]), _ = Rv(t[2] * t[2] + t[3] * t[3]), S = Mw(-t[1] / _, t[0] / m);
          e[o] *= m, e[o++] += d, e[o] *= _, e[o++] += y, e[o++] *= m, e[o++] *= _, e[o++] += S, e[o++] += S, o += 2, s = o;
          break;
        case c:
          u[0] = e[o++], u[1] = e[o++], pe(u, u, t), e[s++] = u[0], e[s++] = u[1], u[0] += e[o++], u[1] += e[o++], pe(u, u, t), e[s++] = u[0], e[s++] = u[1];
      }
      for (l = 0; l < a; l++) {
        var w = Cw[l];
        w[0] = e[o++], w[1] = e[o++], pe(w, w, t), e[s++] = w[0], e[s++] = w[1];
      }
    }
    r.increaseVersion();
  }
}
var tu = Math.sqrt, lo = Math.sin, uo = Math.cos, Nn = Math.PI;
function Ev(r) {
  return Math.sqrt(r[0] * r[0] + r[1] * r[1]);
}
function vh(r, t) {
  return (r[0] * t[0] + r[1] * t[1]) / (Ev(r) * Ev(t));
}
function Ov(r, t) {
  return (r[0] * t[1] < r[1] * t[0] ? -1 : 1) * Math.acos(vh(r, t));
}
function kv(r, t, e, i, n, a, o, s, l, u, h) {
  var f = l * (Nn / 180), v = uo(f) * (r - e) / 2 + lo(f) * (t - i) / 2, c = -1 * lo(f) * (r - e) / 2 + uo(f) * (t - i) / 2, p = v * v / (o * o) + c * c / (s * s);
  p > 1 && (o *= tu(p), s *= tu(p));
  var g = (n === a ? -1 : 1) * tu((o * o * (s * s) - o * o * (c * c) - s * s * (v * v)) / (o * o * (c * c) + s * s * (v * v))) || 0, d = g * o * c / s, y = g * -s * v / o, m = (r + e) / 2 + uo(f) * d - lo(f) * y, _ = (t + i) / 2 + lo(f) * d + uo(f) * y, S = Ov([1, 0], [(v - d) / o, (c - y) / s]), w = [(v - d) / o, (c - y) / s], b = [(-1 * v - d) / o, (-1 * c - y) / s], x = Ov(w, b);
  if (vh(w, b) <= -1 && (x = Nn), vh(w, b) >= 1 && (x = 0), x < 0) {
    var M = Math.round(x / Nn * 1e6) / 1e6;
    x = Nn * 2 + M % 2 * Nn;
  }
  h.addData(u, m, _, o, s, S, x, f, a);
}
var Aw = /([mlvhzcqtsa])([^mlvhzcqtsa]*)/ig, Iw = /-?([0-9]*\.)?[0-9]+([eE]-?[0-9]+)?/g;
function Lw(r) {
  var t = new xi();
  if (!r)
    return t;
  var e = 0, i = 0, n = e, a = i, o, s = xi.CMD, l = r.match(Aw);
  if (!l)
    return t;
  for (var u = 0; u < l.length; u++) {
    for (var h = l[u], f = h.charAt(0), v = void 0, c = h.match(Iw) || [], p = c.length, g = 0; g < p; g++)
      c[g] = parseFloat(c[g]);
    for (var d = 0; d < p; ) {
      var y = void 0, m = void 0, _ = void 0, S = void 0, w = void 0, b = void 0, x = void 0, M = e, D = i, A = void 0, T = void 0;
      switch (f) {
        case "l":
        ...
        case "t":
          ...
          break;
        case "A":
          _ = c[d++], S = c[d++], w = c[d++], b = c[d++], x = c[d++], M = e, D = i, e = c[d++], i = c[d++], v = s.A, kv(M, D, e, i, b, x, _, S, w, v, t);
          break;
        case "a":
          _ = c[d++], S = c[d++], w = c[d++], b = c[d++], x = c[d++], M = e, D = i, e += c[d++], i += c[d++], v = s.A, kv(M, D, e, i, b, x, _, S, w, v, t);
          break;
...
function Ly(r, t) {
  ...
  return i.buildPath = function(n) {
    ...
    Dw(e, n), this.dirtyShape();
  }, i;
}
function Pw(r, t) {
  return new Ay(Ly(r, t));
}
function Rw(r, t) {
  var e = Ly(r, t), i = function(n) {
    N(a, n);
    function a(o) {
...
Cf.prototype.type = "ellipse";
var Py = Math.PI, eu = Py * 2, ti = Math.sin, Bi = Math.cos, Bw = Math.acos, Et = Math.atan2, Bv = Math.abs, fa = Math.sqrt, ta = Math.max, Oe = Math.min, be = 1e-4;
function Nw(r, t, e, i, n, a, o, s) {
  var l = e - r, u = i - t, h = o - n, f = s - a, v = f * l - h * u;
  if (!(v * v < be))
    return v = (h * (t - a) - f * (r - n)) / v, [r + v * l, t + v * u];
}
function ho(r, t, e, i, n, a, o) {
  var s = r - e, l = t - i, u = (o ? a : -a) / fa(s * s + l * l), h = u * l, f = -u * s, v = r + h, c = t + f, p = e + h, g = i + f, d = (v + p) / 2, y = (c + g) / 2, m = p - v, _ = g - c, S = m * m + _ * _, w = n - a, b = v * g - p * c, x = (_ < 0 ? -1 : 1) * fa(ta(0, w * w * S - b * b)), M = (b * _ - m * x) / S, D = (-b * m - _ * x) / S, A = (b * _ + m * x) / S, T = (-b * m + _ * x) / S, I = M - d, L = D - y, P = A - d, R = T - y;
...
function $w(r, t) {
  var e, i = ta(t.r, 0), n = ta(t.r0 || 0, 0), a = i > 0, o = n > 0;
  if (!(!a && !o)) {
    if (a || (i = n, n = 0), n > i) {
      var s = i;
      i = n, n = s;
    ...
    if (!(isNaN(l) || isNaN(u))) {
      var h = t.cx, f = t.cy, v = !!t.clockwise, c = Bv(u - l), p = c > eu && c % eu;
      if (p > be && (c = p), !(i > be))
        r.moveTo(h, f);
      else if (c > eu - be)
        r.moveTo(h + i * Bi(l), f + i * ti(l)), r.arc(h, f, i, l, u, !v), n > be && (r.moveTo(h + n * Bi(u), f + n * ti(u)), r.arc(h, f, n, u, l, v));
      else {
        var g = void 0, d = void 0, y = void 0, m = void 0, _ = void 0, S = void 0, w = void 0, b = void 0, x = void 0, M = void 0, D = void 0, A = void 0, T = void 0, I = void 0, L = void 0, P = void 0, R = i * Bi(l), E = i * ti(l), H = n * Bi(u), O = n * ti(u), $ = c > be;
        if ($) {
          var G = t.cornerRadius;
          G && (e = zw(G), g = e[0], d = e[1], y = e[2], m = e[3]);
          var K = Bv(i - n) / 2;
          if (_ = Oe(K, y), S = Oe(K, m), w = Oe(K, g), b = Oe(K, d), D = x = ta(_, S), A = M = ta(w, b), (x > be || M > be) && (T = i * Bi(u), I = i * ti(u), L = n * Bi(l), P = n * ti(l), c < Py)) {
            var tt = Nw(R, E, L, P, T, I, H, O);
            if (tt) {
              var ut = R - tt[0], dt = E - tt[1], St = T - tt[0], me = I - tt[1], Nr = 1 / ti(Bw((ut * St + dt * me) / (fa(ut * ut + dt * dt) * fa(St * St + me * me))) / 2), Ai = fa(tt[0] * tt[0] + tt[1] * tt[1]);
              D = Oe(x, (i - Ai) / (Nr + 1)), A = Oe(M, (n - Ai) / (Nr - 1));
            }
          }
        }
        if (!$)
          ...
          var jt = Oe(y, D), It = Oe(m, D), Z = ho(L, P, R, E, i, jt, v), et = ho(T, I, H, O, i, It, v);
          r.moveTo(h + Z.cx + Z.x0, f + Z.cy + Z.y0), D < x && jt === It ? r.arc(h + Z.cx, f + Z.cy, D, Et(Z.y0, Z.x0), Et(et.y0, et.x0), !v) : (jt > 0 && r.arc(h + Z.cx, f + Z.cy, jt, Et(Z.y0, Z.x0), Et(Z.y1, Z.x1), !v), r.arc(h, f, i, Et(Z.cy + Z.y1, Z.cx + Z.x1), Et(et.cy + et.y1, et.cx + et.x1), !v), It > 0 && r.arc(h + et.cx, f + et.cy, It, Et(et.y1, et.x1), Et(et.y0, et.x0), !v));
        } else
          r.moveTo(h + R, f + E), r.arc(h, f, i, l, u, !v);
        if (!(n > be) || !$)
          r.lineTo(h + H, f + O);
        else if (A > be) {
          var jt = Oe(g, A), It = Oe(d, A), Z = ho(H, O, T, I, n, -It, v), et = ho(R, E, L, P, n, -jt, v);
          r.lineTo(h + Z.cx + Z.x0, f + Z.cy + Z.y0), A < M && jt === It ? r.arc(h + Z.cx, f + Z.cy, A, Et(Z.y0, Z.x0), Et(et.y0, et.x0), !v) : (It > 0 && r.arc(h + Z.cx, f + Z.cy, It, Et(Z.y0, Z.x0), Et(Z.y1, Z.x1), !v), r.arc(h, f, n, Et(Z.cy + Z.y1, Z.cx + Z.x1), Et(et.cy + et.y1, et.cx + et.x1), v), jt > 0 && r.arc(h + et.cx, f + et.cy, jt, Et(et.y1, et.x1), Et(et.y0, et.x0), !v));
        } else
          r.lineTo(h + H, f + O), r.arc(h, f, n, u, l, v);
      }
      r.closePath();
    }
  }
...
function Hw(r, t, e, i) {
  ...
  if (i) {
    ...
    for (var v = 0, c = r.length; v < c; v++)
      Zi(h, h, r[v]), Ki(f, f, r[v]);
    Zi(h, h, i[0]), Ki(f, f, i[1]);
  }
  for (var v = 0, c = r.length; v < c; v++) {
    var p = r[v];
    if (e)
      ...
      l = r[v - 1], u = r[v + 1];
    b1(a, u, l), yl(a, a, t);
    var g = Gu(p, l), d = Gu(p, u), y = g + d;
    y !== 0 && (g /= y, d /= y), yl(o, a, -g), yl(s, a, d);
    var m = Mc([], p, o), _ = Mc([], p, s);
    i && (Ki(m, m, h), Zi(m, m, f), Ki(_, _, h), Zi(_, _, f)), n.push(m), n.push(_);
  }
...
function Nv(r, t, e) {
  ...
  return i != null || n != null ? [
    (e ? Nc : Pt)(r.x1, r.cpx1, r.cpx2, r.x2, t),
    (e ? Nc : Pt)(r.y1, r.cpy1, r.cpy2, r.y2, t)
  ] : [
    (e ? zc : Yt)(r.x1, r.cpx1, r.x2, t),
    (e ? zc : Yt)(r.y1, r.cpy1, r.y2, t)
  ];
}
var Af = function(r) {
  N(t, r);
  ...
  return t.prototype.getDefaultStyle = function() {
    ...
    v !== 0 && (e.moveTo(n, a), h == null || f == null ? (v < 1 && (ls(n, l, o, v, Gt), l = Gt[1], o = Gt[2], ls(a, u, s, v, Gt), u = Gt[1], s = Gt[2]), e.quadraticCurveTo(l, u, o, s)) : (v < 1 && (ss(n, l, h, o, v, Gt), l = Gt[1], h = Gt[2], o = Gt[3], ss(a, u, f, s, v, Gt), u = Gt[1], f = Gt[2], s = Gt[3]), e.bezierCurveTo(l, u, h, f, o, s)));
  }, t.prototype.pointAt = function(e) {
    return Nv(this.shape, e, !1);
  }, t.prototype.tangentAt = function(e) {
    var i = Nv(this.shape, e, !0);
    return T1(i, i);
  }, t;
}(lt);
...
var Zw = function(r) {
  ...
  return t;
}(Ey), ei = [0, 0], ri = [0, 0], fo = new ft(), co = new ft(), ys = function() {
  function r(t, e) {
    this._corners = [], this._axes = [], this._origin = [0, 0];
    for (var i = 0; i < 4; i++)
      this._corners[i] = new ft();
    for (var i = 0; i < 2; i++)
      this._axes[i] = new ft();
  ...
  return r.prototype.fromBoundingRect = function(t, e) {
    ...
    if (i[0].set(a, o), i[1].set(s, o), i[2].set(s, l), i[3].set(a, l), e)
      for (var u = 0; u < 4; u++)
        i[u].transform(e);
    ft.sub(n[0], i[1], i[0]), ft.sub(n[1], i[3], i[0]), n[0].normalize(), n[1].normalize();
    for (var u = 0; u < 2; u++)
      this._origin[u] = n[u].dot(i[0]);
  }, r.prototype.intersect = function(t, e) {
    var i = !0, n = !e;
    return fo.set(1 / 0, 1 / 0), co.set(0, 0), !this._intersectCheckOneSide(this, t, fo, co, n, 1) && (i = !1, n) || !this._intersectCheckOneSide(t, this, fo, co, n, -1) && (i = !1, n) || n || ft.copy(e, i ? fo : co), i;
  }, r.prototype._intersectCheckOneSide = function(t, e, i, n, a, o) {
    for (var s = !0, l = 0; l < 2; l++) {
      var u = this._axes[l];
      if (this._getProjMinMaxOnAxis(l, t._corners, ei), this._getProjMinMaxOnAxis(l, e._corners, ri), ei[1] < ri[0] || ei[0] > ri[1]) {
        if (s = !1, a)
          return s;
        var h = Math.abs(ri[0] - ei[1]), f = Math.abs(ei[0] - ri[1]);
        Math.min(h, f) > n.len() && (h < f ? ft.scale(n, u, -h * o) : ft.scale(n, u, f * o));
      } else if (i) {
        var h = Math.abs(ri[0] - ei[1]), f = Math.abs(ei[0] - ri[1]);
        Math.min(h, f) < i.len() && (h < f ? ft.scale(i, u, h * o) : ft.scale(i, u, -f * o));
      }
    }
    return s;
  ...
  return t.prototype.traverse = function(e, i) {
    ...
    if (!this._rect) {
      for (var e = new at(1 / 0, 1 / 0, -1 / 0, -1 / 0), i = 0; i < this._displayables.length; i++) {
        ...
        n.needLocalTransform() && a.applyTransform(n.getLocalTransform(Qw)), e.union(a);
      }
      this._rect = e;
    }
    return this._rect;
...
function Lf(r, t, e, i, n, a, o) {
  var s = !1, l;
  q(n) ? (o = a, a = n, n = null) : V(n) && (a = n.cb, o = n.during, s = n.isFrom, l = n.removeOpt, n = n.dataIndex);
  var u = r === "leave";
  u || t.stopAnimation("leave");
  var h = tx(r, i, n, u ? l || {} : null, i && i.getAnimationDelayParams ? i.getAnimationDelayParams(t, n) : null);
  if (h && h.duration > 0) {
...
function re(r, t, e, i, n, a) {
  Lf("update", r, t, e, i, n, a);
}
function sr(r, t, e, i, n, a) {
  Lf("enter", r, t, e, i, n, a);
}
function ca(r) {
  if (!r.__zr)
    return !0;
...
function ms(r, t, e, i, n, a) {
  ca(r) || Lf("leave", r, t, e, i, n, a);
}
function zv(r, t, e, i) {
  r.removeTextContent(), r.removeTextGuideLine(), ms(r, {
    style: {
      opacity: 0
    }
  }, t, e, i);
...
function ph(r, t, e) {
  ...
  r.isGroup ? r.traverse(function(n) {
    n.isGroup || zv(n, t, e, i);
  }) : zv(r, t, e, i);
}
function Oy(r) {
  Jw(r).oldStyle = r.style;
}
var _s = Math.max, Ss = Math.min, dh = {};
function ex(r) {
  return lt.extend(r);
}
var rx = Rw;
...
function Pf(r, t, e, i) {
  var n = Pw(r, t);
  return e && (i === "center" && (e = By(e, n.getBoundingRect())), Ny(n, e)), n;
}
function ky(r, t, e) {
  var i = new qe({
    style: {
...
function ox(r) {
  return my(r.shape, r.shape, r.style), r;
}
var sx = ci;
function Xo(r, t) {
  for (var e = uf([]); r && r !== t; )
...
function on(r, t, e) {
  return t && !Zt(t) && (t = vf.getLocalTransform(t)), e && (t = ff([], t)), pe([], r, t);
}
function zy(r, t, e) {
  ...
  return a = on(a, t, e), Math.abs(a[0]) > Math.abs(a[1]) ? a[0] > 0 ? "right" : "left" : a[1] > 0 ? "bottom" : "top";
}
function $v(r) {
  return !r.isGroup;
}
...
function $y(r, t, e) {
  ...
  function n(o) {
    ...
    return lx(o) && (s.shape = B({}, o.shape)), s;
  }
  var a = i(r);
  t.traverse(function(o) {
    if ($v(o) && o.anid) {
      ...
      if (s) {
        var l = n(o);
        o.attr(n(s)), re(o, l, e, it(o).dataIndex);
      }
    }
  });
}
function ux(r, t) {
  return W(r, function(e) {
    var i = e[0];
    i = _s(i, t.x), i = Ss(i, t.x + t.width);
    var n = e[1];
    return n = _s(n, t.y), n = Ss(n, t.y + t.height), [i, n];
  });
}
function hx(r, t) {
  var e = _s(r.x, t.x), i = Ss(r.x + r.width, t.x + t.width), n = _s(r.y, t.y), a = Ss(r.y + r.height, t.y + t.height);
  if (i >= e && a >= n)
    return {
      x: e,
      y: n,
...
function Rf(r, t, e) {
  ...
  if (e = e || {
    ...
    return r.indexOf("image://") === 0 ? (n.image = r.slice(8), ot(n, e), new qe(i)) : Pf(r.replace("path://", ""), i, e, "center");
}
function fx(r, t, e, i, n) {
  for (var a = 0, o = n[n.length - 1]; a < n.length; a++) {
    var s = n[a];
    if (Fy(r, t, e, i, s[0], s[1], o[0], o[1]))
      return !0;
    o = s;
  }
}
function Fy(r, t, e, i, n, a, o, s) {
  var l = e - r, u = i - t, h = o - n, f = s - a, v = ru(h, f, l, u);
  if (cx(v))
    return !1;
  var c = r - n, p = t - a, g = ru(c, p, l, u) / v;
  if (g < 0 || g > 1)
    return !1;
  var d = ru(c, p, h, f) / v;
  return !(d < 0 || d > 1);
...
const vx = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  Group: xt,
  Image: qe,
  IncrementalDisplayable: jw,
  Line: Or,
  LinearGradient: If,
  OrientedBoundingRect: ys,
  Path: lt,
  Point: ft,
  Polygon: Us,
  Polyline: Df,
  ...
  initProps: sr,
  isElementRemoved: ca,
  lineLineIntersect: Fy,
  linePolygonIntersect: fx,
  makeImage: ky,
  makePath: Pf,
  mergePath: ax,
  registerShape: Le,
...
function px(r, t) {
  for (var e = 0; e < He.length; e++) {
    var i = He[e], n = t[i], a = r.ensureState(i);
...
function Ya(r, t, e, i) {
  e = e || qs;
  for (var n = r instanceof Mt, a = !1, o = 0; o < Tv.length; o++) {
    var s = t[Tv[o]];
  ...
  if (a) {
    n || (l || (l = new Mt(), r.setTextContent(l)), r.stateProxy && (l.stateProxy = r.stateProxy));
    var u = Vv(e, t), h = t.normal, f = !!h.getShallow("show"), v = $e(h, i && i.normal, e, !1, !n);
    v.text = u.normal, n || r.setTextConfig(Hv(h, e, !1));
    for (var o = 0; o < He.length; o++) {
      var c = He[o], s = t[c];
      if (s) {
        var p = l.ensureState(c), g = !!J(s.getShallow("show"), f);
        if (g !== f && (p.ignore = !g), p.style = $e(s, i && i[c], e, !0, !n), p.style.text = u[c], !n) {
          var d = r.ensureState(c);
          d.textConfig = Hv(s, e, !0);
        }
      }
    }
    l.silent = !!h.getShallow("silent"), l.style.x != null && (v.x = l.style.x), l.style.y != null && (v.y = l.style.y), l.ignore = !f, l.useStyle(v), l.dirty(), e.enableTextSetter && (Zs(l).setLabelText = function(y) {
      var m = Vv(e, t, y);
      px(l, m);
    });
  } else l && (l.ignore = !0);
...
function $e(r, t, e, i, n) {
  var a = {};
  return dx(a, r, e, i, n), t && B(a, t), a;
}
function Hv(r, t, e) {
  t = t || {};
...
function dx(r, t, e, i, n) {
  ...
  v != null && (r.margin = v), Yv(r, t, o, e, i, n, !0, !1);
}
function gx(r) {
  for (var t; r && r !== r.ecModel; ) {
    var e = (r.option || qs).rich;
    if (e) {
      t = t || {};
      for (var i = vt(e), n = 0; n < i.length; n++) {
        var a = i[n];
...
var Gv = ["fontStyle", "fontWeight", "fontSize", "fontFamily", "textShadowColor", "textShadowBlur", "textShadowOffsetX", "textShadowOffsetY"], Wv = ["align", "lineHeight", "width", "height", "tag", "verticalAlign", "ellipsis"], Uv = ["padding", "borderWidth", "borderRadius", "borderDashOffset", "backgroundColor", "borderColor", "shadowColor", "shadowBlur", "shadowOffsetX", "shadowOffsetY"];
function Yv(r, t, e, i, n, a, o, s) {
  e = !n && e || qs;
  ...
  for (var g = 0; g < Gv.length; g++) {
    var d = Gv[g], y = J(t.getShallow(d), e[d]);
    y != null && (r[d] = y);
  }
  for (var g = 0; g < Wv.length; g++) {
    var d = Wv[g], y = t.getShallow(d);
    y != null && (r[d] = y);
  }
...
var _x = ["textStyle", "color"], iu = ["fontStyle", "fontWeight", "fontSize", "fontFamily", "padding", "lineHeight", "rich", "width", "height", "overflow"], nu = new Mt(), Sx = (
  /** @class */
  function() {
    function r() {
    }
...
Ye(bt, gb);
Ye(bt, Sx);
var Mx = Math.round(Math.random() * 10);
function Ks(r) {
  return [r || "", Mx++].join("_");
}
function Dx(r) {
...
var bs = "ZH", Ef = "EN", sn = Ef, qo = {}, Of = {}, Gy = Y.domSupported ? function() {
  var r = (
    /* eslint-disable-next-line */
    (document.documentElement.lang || navigator.language || navigator.browserLanguage || sn).toUpperCase()
  );
  return r.indexOf(bs) > -1 ? bs : sn;
}() : sn;
function Wy(r, t) {
  r = r.toUpperCase(), Of[r] = new bt(t), qo[r] = t;
}
function Px(r) {
  if (F(r)) {
    var t = qo[r.toUpperCase()] || {};
    return r === bs || r === Ef ? X(t) : rt(X(t), X(qo[sn]), !1);
  } else
    return rt(X(r), X(qo[sn]), !1);
}
function Rx(r) {
  return Of[r];
}
...
Wy(Ef, Ix);
Wy(bs, Lx);
var kf = 1e3, Bf = kf * 60, va = Bf * 60, ce = va * 24, Xv = ce * 365, ea = {
  year: "{yyyy}",
  month: "{MMM}",
  day: "{d}",
  hour: "{HH}:{mm}",
  ...
  second: vo + " " + ea.second,
  millisecond: ea.none
}, au = ["year", "month", "day", "hour", "minute", "second", "millisecond"], Uy = ["year", "half-year", "quarter", "month", "week", "half-week", "day", "half-day", "quarter-day", "hour", "minute", "second", "millisecond"];
function yr(r, t) {
...
function Bx(r, t, e, i, n) {
  ...
  if (F(e))
    ...
    var o = B({}, ea);
    if (r.level > 0)
      for (var s = 0; s < au.length; ++s)
        o[au[s]] = "{primary|" + o[au[s]] + "}";
    var l = e ? e.inherit === !1 ? e : ot(e, o) : o, u = Yy(r.value, n);
    if (l[u])
      a = l[u];
    else if (l.inherit) {
      for (var h = Uy.indexOf(u), s = h - 1; s >= 0; --s)
        if (l[u]) {
          a = l[u];
          break;
        }
  ...
  return js(new Date(r.value), a, n, i);
}
function Yy(r, t) {
  var e = or(r), i = e[un(t)]() + 1, n = e[Js(t)](), a = e[Ia(t)](), o = e[tl(t)](), s = e[el(t)](), l = e[rl(t)](), u = l === 0, h = u && s === 0, f = h && o === 0, v = f && a === 0, c = v && n === 1, p = c && i === 1;
...
function gh(r, t, e) {
  ...
  if (o || s) {
    ...
    if (isNaN(+l)) {
      if (s)
        return "-";
    } else return js(l, i, e);
  }
  if (t === "ordinal")
    return Vu(r) ? n(r) : pt(r) && a(r) ? r + "" : "-";
  var u = vs(r);
  return a(u) ? Jy(u) : Vu(r) ? n(r) : typeof r == "boolean" ? r + "" : "-";
}
var Kv = ["a", "b", "c", "d", "e", "f", "g"], ou = function(r, t) {
  return "{" + r + (t ?? "") + "}";
};
function em(r, t, e) {
  z(t) || (t = [t]);
  ...
  for (var s = 0; s < i; s++)
    for (var l = 0; l < n.length; l++) {
      var u = t[s][n[l]];
      r = r.replace(ou(Kv[l], s), e ? Ut(u) : u);
    }
  return r;
}
function zx(r, t) {
...
var Zo = C, $x = ["left", "right", "top", "bottom", "width", "height"], po = [["width", "left", "right"], ["height", "top", "bottom"]];
...
function dn(r, t, e) {
  e = Xa(e || 0);
  var i = t.width, n = t.height, a = Ft(r.left, i), o = Ft(r.top, n), s = Ft(r.right, i), l = Ft(r.bottom, n), u = Ft(r.width, i), h = Ft(r.height, n), f = e[2] + e[0], v = e[1] + e[3], c = r.aspect;
...
function gn(r, t, e) {
  ...
  !z(i) && (i = [i, i]);
  var n = o(po[0], 0), a = o(po[1], 1);
  u(po[0], r, n), u(po[1], r, a);
  function o(h, f) {
    var v = {}, c = 0, p = {}, g = 0, d = 2;
    if (Zo(h, function(_) {
      p[_] = r[_];
...
var im = Q(["tooltip", "label", "itemName", "itemId", "itemGroupId", "itemChildGroupId", "seriesName"]), ye = "original", Qt = "arrayRows", Ze = "objectRows", vr = "keyedColumns", Pr = "typedArray", nm = "unknown", nr = "column", Cn = "row", Jt = {
  Must: 1,
  Might: 2,
  Not: 3
  // Other cases
...
function Yx(r, t, e) {
  ...
  if (!n || !r)
    return i;
  var a = [], o = [], s = t.ecModel, l = am(s).datasetMap, u = n.uid + "_" + e.seriesLayoutBy, h, f;
...
function sm(r, t) {
  return qx(r.data, r.sourceFormat, r.seriesLayoutBy, r.dimensionsDefine, r.startIndex, t);
}
function qx(r, t, e, i, n, a) {
  var o, s = 5;
  if (Kt(r))
    return Jt.Not;
  var l, u;
...
var go, zn, jv, Jv = "\0_ec_inner", tT = 1, Ff = (
  /** @class */
  function(r) {
    N(t, r);
    function t() {
    ...
    return t.prototype.init = function(e, i, n, a, o, s) {
      a = a || {}, this.option = null, this._theme = new bt(a), this._locale = new bt(o), this._optionManager = s;
      ...
      return this._resetOption(e, rp(i));
    }, t.prototype._resetOption = function(e, i) {
      var n = !1, a = this._optionManager;
      if (!e || e === "recreate") {
        var o = a.mountOption(e === "recreate");
        !this.option || e === "recreate" ? jv(this, o) : (this.restoreData(), this._mergeOption(o, i)), n = !0;
      }
      ...
      function h(f) {
        var v = Kx(this, f, Rt(e[f])), c = a.get(f), p = (
          // `!oldCmptList` means init. See the comment in `mappingToExists`
          c ? u && u.get(f) ? "replaceMerge" : "normalMerge" : "replaceAll"
        ), g = YS(c, v, p);
        JS(g, f, st), n[f] = null, a.set(f, null), o.set(f, 0);
        var d = [], y = [], m = 0, _;
        C(g, function(S, w) {
          ...
          if (!x)
            ...
            if (b && b.constructor === D)
              ...
              b = new D(x, this, this, A), B(b, A), S.brandNew && (b.__requireNewView = !0), b.init(x, this, this), b.optionUpdated(null, !0);
            }
          }
          b ? (d.push(b.option), y.push(b), m++) : (d.push(void 0), y.push(void 0));
        }, this), n[f] = d, a.set(f, y), o.set(f, m), f === "series" && go(this);
      }
      ...
      return n != null ? (l = [], C(Rt(n), function(u) {
        s[u] && l.push(s[u]);
      })) : a != null ? l = tp("id", a, s) : o != null ? l = tp("name", o, s) : l = Lt(s, function(u) {
        return !!u;
      }), ep(l, e);
    }, t.prototype.findComponents = function(e) {
      var i = e.query, n = e.mainType, a = s(i), o = a ? this.queryComponents(a) : Lt(this._componentsMap.get(n), function(u) {
        return !!u;
      });
      return l(ep(o, e));
      function s(u) {
      ...
      if (q(e)) {
        ...
        for (var l = F(e) ? a.get(e) : V(e) ? this.findComponents(e) : null, u = 0; l && u < l.length; u++) {
          var h = l[u];
      ...
      zn(this), C(this._seriesIndices, function(n) {
      ...
      zn(this), C(this._seriesIndices, function(a) {
      ...
      return zn(this), this._seriesIndicesMap.get(e.componentIndex) == null;
      ...
      i.each(function(a, o) {
        ...
        C(i.get(a), function(o) {
          o && (a !== "series" || !eT(o, e)) && o.restoreData();
        });
      });
      ...
      go = function(e) {
        ...
        e.option = {}, e.option[Jv] = tT, e._componentsMap = Q({
          series: []
        }), e._componentsCount = Q();
        var n = i.aria;
        V(n) && n.enabled == null && (n.enabled = !0), rT(i, e._theme.option), rt(i, Wx, !1), e._mergeOption(i, null);
      };
    }(), t;
  }(bt)
);
...
function ep(r, t) {
  return t.hasOwnProperty("subType") ? Lt(r, function(e) {
  ...
  function() {
    ...
    return r.prototype.setOption = function(t, e, i) {
      t && (C(Rt(t.series), function(o) {
        o && o.data && Kt(o.data) && Hu(o.data);
      }), C(Rt(t.dataset), function(o) {
        o && o.source && Kt(o.source) && Hu(o.source);
      })), t = X(t);
      var n = this._optionBackup, a = oT(t, e, !n);
      ...
      for (var l = 0, u = n.length; l < u; l++)
        sT(n[l].query, e, i) && o.push(l);
      return !o.length && a && (o = [-1]), o.length && !uT(o, this._currentMediaIndices) && (s = W(o, function(h) {
...
var _e = C, Pa = V, ip = ["areaStyle", "lineStyle", "nodeStyle", "linkStyle", "chordStyle", "label", "labelLine"];
function lu(r) {
  var t = r && r.itemStyle;
  if (t)
    for (var e = 0, i = ip.length; e < i; e++) {
      var n = ip[e], a = t.normal, o = t.emphasis;
...
function wt(r, t) {
  var e = Pa(r) && r[t], i = Pa(e) && e.textStyle;
  if (i)
    for (var n = 0, a = av.length; n < a; n++) {
      var o = av[n];
      i.hasOwnProperty(o) && (e[o] = i[o]);
    }
}
function se(r) {
  r && (ra(r), wt(r, "label"), r.emphasis && wt(r.emphasis, "label"));
}
function hT(r) {
  if (Pa(r)) {
    lu(r), ra(r), wt(r, "label"), wt(r, "upperLabel"), wt(r, "edgeLabel"), r.emphasis && (wt(r.emphasis, "label"), wt(r.emphasis, "upperLabel"), wt(r.emphasis, "edgeLabel"));
    var t = r.markPoint;
    t && (lu(t), se(t));
    var e = r.markLine;
    e && (lu(e), se(e));
    ...
    r.type === "gauge" ? (wt(r, "axisLabel"), wt(r, "title"), wt(r, "detail")) : r.type === "treemap" ? (Bt(r.breadcrumb, "itemStyle"), C(r.levels, function(u) {
      ra(u);
...
function fT(r, t) {
  _e(je(r.series), function(i) {
    Pa(i) && hT(i);
  });
  var e = ["xAxis", "yAxis", "radiusAxis", "angleAxis", "singleAxis", "parallelAxis", "radar"];
  t && e.push("valueAxis", "categoryAxis", "logAxis", "timeAxis"), _e(e, function(i) {
    _e(je(r[i]), function(n) {
      n && (wt(n, "axisLabel"), wt(n.axisPointer, "label"));
    });
  }), _e(je(r.parallel), function(i) {
    var n = i && i.parallelAxisDefault;
    wt(n, "axisLabel"), wt(n && n.axisPointer, "label");
  }), _e(je(r.calendar), function(i) {
    Bt(i, "itemStyle"), wt(i, "dayLabel"), wt(i, "monthLabel"), wt(i, "yearLabel");
  }), _e(je(r.radar), function(i) {
  ...
  }), _e(je(r.geo), function(i) {
    Pa(i) && (se(i), _e(je(i.regions), function(n) {
      se(n);
    }));
  }), _e(je(r.timeline), function(i) {
    se(i), Bt(i, "label"), Bt(i, "itemStyle"), Bt(i, "controlStyle", !0);
    var n = i.data;
    z(n) && C(n, function(a) {
      V(a) && (Bt(a, "label"), Bt(a, "itemStyle"));
    });
  }), _e(je(r.toolbox), function(i) {
    Bt(i, "iconStyle"), _e(i.feature, function(n) {
      Bt(n, "iconStyle");
    });
  }), wt(np(r.axisPointer), "label"), wt(np(r.tooltip).axisPointer, "label");
}
function cT(r, t) {
...
var pT = [["x", "left"], ["y", "top"], ["x2", "right"], ["y2", "bottom"]], dT = ["grid", "geo", "parallel", "legend", "toolbox", "title", "visualMap", "dataZoom", "timeline"], uu = [["borderRadius", "barBorderRadius"], ["borderColor", "barBorderColor"], ["borderWidth", "barBorderWidth"]];
function $n(r) {
  var t = r && r.itemStyle;
  if (t)
    for (var e = 0; e < uu.length; e++) {
      var i = uu[e][1], n = uu[e][0];
      t[i] != null && (t[n] = t[i]);
    }
}
function op(r) {
...
function um(r, t) {
  if (r)
    for (var e = 0; e < r.length; e++)
      t(r[e]), r[e] && um(r[e].children, t);
}
function hm(r, t) {
  fT(r, t), r.series = Rt(r.series), C(r.series, function(e) {
    if (V(e)) {
      var i = e.type;
      if (i === "line")
        e.clipOverflow != null && (e.clip = e.clipOverflow);
      else if (i === "pie" || i === "gauge") {
        e.clockWise != null && (e.clockwise = e.clockWise), op(e.label);
        var n = e.data;
        if (n && !Kt(n))
        ...
        o != null && vT(e, "itemStyle.color", o);
      } else if (i === "bar") {
        $n(e), $n(e.backgroundStyle), $n(e.emphasis);
        var n = e.data;
        if (n && !Kt(n))
          for (var a = 0; a < n.length; a++)
            typeof n[a] == "object" && ($n(n[a]), $n(n[a] && n[a].emphasis));
      } else if (i === "sunburst") {
        var s = e.highlightPolicy;
        s && (e.emphasis = e.emphasis || {}, e.emphasis.focus || (e.emphasis.focus = s)), sp(e), um(e.data, sp);
      } else i === "graph" || i === "sankey" ? gT(e) : i === "map" && (e.mapType && !e.map && (e.map = e.mapType), e.mapLocation && ot(e, e.mapLocation));
      e.hoverAnimation != null && (e.emphasis = e.emphasis || {}, e.emphasis && e.emphasis.scale == null && (e.emphasis.scale = e.hoverAnimation)), ap(e);
    }
  }), r.dataRange && (r.visualMap = r.dataRange), C(dT, function(e) {
    var i = r[e];
...
var al = (
  ...
  /* @__PURE__ */ function() {
    function r(t) {
      this.data = t.data || (t.sourceFormat === vr ? {} : []), this.sourceFormat = t.sourceFormat || nm, this.seriesLayoutBy = t.seriesLayoutBy || nr, this.startIndex = t.startIndex || 0, this.dimensionsDetectedCount = t.dimensionsDetectedCount, this.metaRawOption = t.metaRawOption;
      var e = this.dimensionsDefine = t.dimensionsDefine;
      if (e)
        for (var i = 0; i < e.length; i++) {
          var n = e[i];
          n.type == null && sm(this, i) === Jt.Must && (n.type = "ordinal");
        }
    }
    return r;
  }()
...
function Vf(r) {
  return r instanceof al;
}
function yh(r, t, e) {
  e = e || cm(r);
  var i = t.seriesLayoutBy, n = ST(r, e, i, t.sourceHeader, t.dimensions), a = new al({
    data: r,
    sourceFormat: e,
    seriesLayoutBy: i,
...
function ST(r, t, e, i, n) {
  ...
  if (!r)
    return {
      dimensionsDefine: lp(n),
      startIndex: o,
      dimensionsDetectedCount: a
    };
  if (t === Qt) {
    var s = r;
    i === "auto" || i == null ? up(function(u) {
      u != null && u !== "-" && (F(u) ? o == null && (o = 1) : o = 0);
    }, e, s, 10) : o = pt(i) ? i : i ? 1 : 0, !n && o === 1 && (n = [], up(function(u, h) {
      n[h] = u != null ? u + "" : "";
    }, e, s, 1 / 0)), a = n ? n.length : e === Cn ? s.length : s[0] ? s[0].length : null;
  } else if (t === Ze)
    n || (n = bT(r));
  else if (t === vr)
...
var ii, ni, ai, hp, fp, pm = (
  ...
  function() {
    function r(t, e) {
      ...
      i.sourceFormat === Pr && (this._offset = 0, this._dimSize = e, this._data = n), fp(this, n, i);
    }
    return r.prototype.getSource = function() {
      ...
      var t;
      fp = function(o, s, l) {
        var u = l.sourceFormat, h = l.seriesLayoutBy, f = l.startIndex, v = l.dimensionsDefine, c = hp[Hf(u, h)];
        if (B(o, c), u === Pr)
  ...
  return r[i];
}, wT = (ii = {}, ii[Qt + "_" + nr] = function(r, t, e, i) {
  return r[i + t];
}, ii[Qt + "_" + Cn] = function(r, t, e, i, n) {
  i += t;
  ...
  return a;
}, ii[Ze] = cp, ii[vr] = function(r, t, e, i, n) {
...
var vp = function(r, t, e) {
  return r.length;
}, xT = (ni = {}, ni[Qt + "_" + nr] = function(r, t, e) {
  return Math.max(0, r.length - t);
}, ni[Qt + "_" + Cn] = function(r, t, e) {
  var i = r[0];
  return i ? Math.max(0, i.length - t) : 0;
}, ni[Ze] = vp, ni[vr] = function(r, t, e) {
...
var hu = function(r, t, e) {
  return r[t];
}, TT = (ai = {}, ai[Qt] = hu, ai[Ze] = function(r, t, e) {
  return r[e];
}, ai[vr] = hu, ai[ye] = function(r, t, e) {
  var i = Ha(r);
...
var CT = /\{@(.+?)\}/g, MT = (
  ...
  function() {
    ...
    return r.prototype.getDataParams = function(t, e) {
      ...
      if (F(a)) {
        var h = em(a, l);
        return h.replace(CT, function(f, v) {
          var c = v.length, p = v;
...
var DT = (
  ...
  function() {
    ...
    return r.prototype.perform = function(t) {
      ...
      dp.reset(e, i, n, a), this._callingProgress = t, this._callingProgress({
        start: e,
        end: i,
        count: i - e,
        next: dp.next
...
function Ko(r, t) {
  var e = t && t.type;
  return e === "ordinal" ? r : (e === "time" && !pt(r) && r != null && r !== "-" && (r = +or(r)), r == null || r === "" ? NaN : Number(r));
}
Q({
  number: function(r) {
    return parseFloat(r);
...
var AT = (
  ...
  function() {
    ...
    return r.prototype.evaluate = function(t, e) {
      var i = pt(t) ? t : vs(t), n = pt(e) ? e : vs(e), a = isNaN(i), o = isNaN(n);
...
function LT(r, t) {
  var e = new IT(), i = r.data, n = e.sourceFormat = r.sourceFormat, a = r.startIndex, o = "";
  r.seriesLayoutBy !== nr && Xt(o);
  ...
  t.__isBuiltIn && (e.getRawDataItem = function(g) {
    return f(i, a, s, g);
  }, e.getRawData = j(PT, null, r)), e.cloneRawData = j(RT, null, r);
  var v = gm(n, nr);
  ...
  return e.getDimensionInfo = j(ET, null, s, l), e.cloneAllDimensionInfo = j(OT, null, s), e;
}
function PT(r) {
  var t = r.sourceFormat;
  if (!Gf(t)) {
...
function kT(r) {
  ...
  i.length !== 2 && Xt(e);
  var n = !1;
  i[0] === "echarts" && (t = i[1], n = !0), r.__isBuiltIn = n, mm.set(t, r);
}
function BT(r, t, e) {
  ...
  for (var o = 0, s = n; o < s; o++) {
    var l = i[o];
    t = NT(l, t), o !== s - 1 && (t.length = Math.max(t.length, 1));
  }
  return t;
}
function NT(r, t, e, i) {
  var n = "";
  t.length || Xt(n), V(r) || Xt(n);
  var a = r.type, o = mm.get(a);
  o || Xt(n);
  ...
  return W(l, function(u, h) {
    ...
    return yh(u.data, c, null);
  });
}
function Gf(r) {
  return r === Qt || r === Ze;
}
var ol = "undefined", zT = typeof Uint32Array === ol ? Array : Uint32Array, $T = typeof Uint16Array === ol ? Array : Uint16Array, _m = typeof Int32Array === ol ? Array : Int32Array, gp = typeof Float64Array === ol ? Array : Float64Array, Sm = {
  float: gp,
  int: _m,
...
var mh = (
  ...
  function() {
    ...
    return r.prototype.initData = function(t, e, i) {
      ...
      var n = t.getSource(), a = this.defaultDimValueGetter = fu[n.sourceFormat];
      this._dimValueGetter = i || a, this._rawExtent = [], vm(n), this._dimensions = W(e, function(o) {
        return {
      ...
      return n[a] = {
        type: e
      }, i.set(t, a), this._chunks[a] = new Sm[e || "float"](this._rawCount), this._rawExtent[a] = $i(), a;
      ...
      for (var f = [], v = s; v < l; v++)
        for (var c = v - s, p = 0; p < a; p++) {
          var h = n[p], g = fu.arrayRows.call(this, t[c] || f, h.property, c, p);
          i[p][v] = g;
          var d = o[p];
      ...
      if (!this._count)
        return this;
      for (var i = this.clone(), n = i.count(), a = zi(i._rawCount), o = new a(n), s = [], l = t.length, u = 0, h = t[0], f = i._chunks, v = 0; v < n; v++) {
      ...
      if (!a)
        return this;
      var o = e.count(), s = zi(e._rawCount), l = new s(o), u = 0, h = n[0], f = t[h][0], v = t[h][1], c = e._chunks, p = !1;
      if (!e._indices) {
        var g = 0;
        if (a === 1) {
          ...
          for (var d = c[n[0]], _ = c[n[1]], S = t[n[1]][0], w = t[n[1]][1], y = 0; y < i; y++) {
            var m = d[y], b = _[y];
            (m >= f && m <= v || isNaN(m)) && (b >= S && b <= w || isNaN(b)) && (l[u++] = g), g++;
          }
          p = !0;
        }
      }
      ...
      var i = this.clone([t], !0), n = i._chunks, a = n[t], o = this.count(), s = 0, l = Math.floor(1 / e), u = this.getRawIndex(0), h, f, v, c = new (zi(this._rawCount))(Math.min((Math.ceil(o / l) + 2) * 2, o));
      c[s++] = u;
      for (var p = 1; p < o - 1; p += l) {
        ...
        m /= d - g;
        var b = p, x = Math.min(p + l, o), M = p - 1, D = a[u];
        h = -1, v = b;
        for (var A = -1, T = 0, _ = b; _ < x; _++) {
          var S = this.getRawIndex(_), w = a[S];
          if (isNaN(w)) {
            T++, A < 0 && (A = S);
            continue;
          }
          f = Math.abs((M - y) * (w - D) - (M - _) * (m - D)), f > h && (h = f, v = S);
        }
        T > 0 && T < x - b && (c[s++] = Math.min(A, v), v = Math.max(A, v)), c[s++] = v, u = v;
      }
      ...
      for (var i = this.clone([t], !0), n = i._chunks, a = Math.floor(1 / e), o = n[t], s = this.count(), l = new (zi(this._rawCount))(Math.ceil(s / a) * 2), u = 0, h = 0; h < s; h += a) {
      ...
      for (var a = this.clone([t], !0), o = a._chunks, s = [], l = Math.floor(1 / e), u = o[t], h = this.count(), f = a._rawExtent[t] = $i(), v = new (zi(this._rawCount))(Math.ceil(h / l)), c = 0, p = 0; p < h; p += l) {
      ...
      var i = new r(), n = this._chunks, a = t && wn(t, function(s, l) {
        return s[l] = !0, s;
      }, {});
      if (a)
        for (var o = 0; o < n.length; o++)
          i._chunks[o] = a[o] ? FT(n[o]) : n[o];
      else
        i._chunks = n;
      ...
      fu = {
        ...
        objectRows: function(e, i, n, a) {
          return Ko(e[i], this._dimensions[a]);
        },
        keyedColumns: t,
    ...
    return r.prototype.dirty = function() {
      ...
      if (yo(t)) {
        ...
        if (i) {
          ...
          n = [yh(_, this._getSourceMetaRawOption(), null)], a = [];
        }
      }
      ...
      return C(t, function(u) {
        ...
        n != null && !h && mp(f), s.push(h), l.push(u._getVersionSign());
      }), i ? o = BT(i, s, {
      ...
      if (!s) {
        ...
        yo(this._sourceHost) && l ? s = l._innerGetDataStore(t, e, i) : (s = new mh(), s.initData(new pm(e, t.length), t)), o[i] = s;
      }
      return s;
...
var HT = "line-height:1";
function bm(r) {
  var t = r.lineHeight;
  return t == null ? HT : "line-height:" + Ut(t + "") + "px";
}
function wm(r, t) {
...
function UT(r, t, e, i) {
  var n = t.noHeader, a = XT(Tm(t)), o = [], s = t.blocks || [];
  Fe(!s || z(s)), s = s || [];
  var l = r.orderMode;
  if (t.sortBlocks && l) {
    s = s.slice();
  ...
  var f = r.renderMode === "richText" ? o.join(a.richText) : Sh(i, o.join(""), n ? e : a.html);
  if (n)
    return f;
  var v = gh(t.header, "ordinal", r.useUTC), c = wm(i, r.renderMode).nameStyle, p = bm(i);
  return r.renderMode === "richText" ? Cm(r, v, c) + a.richText + f : Sh(i, '<div style="' + c + ";" + p + ';">' + Ut(v) + "</div>" + f, e);
}
function YT(r, t, e, i) {
  var n = r.renderMode, a = t.noName, o = t.noValue, s = !t.markerType, l = t.name, u = r.useUTC, h = t.valueFormatter || r.valueFormatter || function(S) {
    return S = z(S) ? S : [S], W(S, function(w, b) {
      return gh(w, z(c) ? c[b] : c, u);
    });
  };
  if (!(a && o)) {
    var f = s ? "" : r.markupStyleCreator.makeTooltipMarker(t.markerType, t.markerColor || "#333", n), v = a ? "" : gh(l, "ordinal", u), c = t.valueType, p = o ? [] : h(t.value, t.dataIndex), g = !s || !a, d = !s && a, y = wm(i, n), m = y.nameStyle, _ = y.valueStyle;
    return n === "richText" ? (s ? "" : f) + (a ? "" : Cm(r, v, m)) + (o ? "" : KT(r, p, g, d, _)) : Sh(i, (s ? "" : f) + (a ? "" : qT(v, !s, m)) + (o ? "" : ZT(p, g, d, _)), e);
  }
}
function _p(r, t, e, i, n, a) {
  if (r) {
    var o = xm(r), s = {
      useUTC: n,
      renderMode: e,
...
function ZT(r, t, e, i) {
  ...
  return r = z(r) ? r : [r], '<span style="' + a + ";" + i + '">' + W(r, function(o) {
    return Ut(o);
  }).join("&nbsp;&nbsp;") + "</span>";
}
function Cm(r, t, e) {
...
var cu = (
  ...
  function() {
    function r() {
      this.richTextStyles = {}, this._nextStyleNameId = ny();
    }
    return r.prototype._generateStyleName = function() {
      return "__EC_aUTo_" + this._nextStyleNameId++;
    }, r.prototype.makeTooltipMarker = function(t, e, i) {
      var n = i === "richText" ? this._generateStyleName() : null, a = zx({
        color: e,
        type: t,
        renderMode: i,
        markerId: n
      });
      return F(a) ? a : (this.richTextStyles[n] = a.style, a.content);
...
function jT(r) {
  var t = r.series, e = r.dataIndex, i = r.multipleSeries, n = t.getData(), a = n.mapDimensionsAll("defaultedTooltip"), o = a.length, s = t.getRawValue(e), l = z(s), u = QT(t, e), h, f, v, c;
  if (o > 1 || l && !o) {
    var p = JT(s, t, e, a, u);
    h = p.inlineValues, f = p.inlineValueTypes, v = p.blocks, c = p.inlineValues[0];
  } else if (o) {
    var g = n.getDimensionInfo(a[0]);
    c = h = yn(n, e, a[0]), f = g.type;
  } else
    c = h = l ? s[0] : s;
  var d = yf(t), y = d && t.name || "", m = n.getName(e), _ = i ? y : m;
  return Ra("section", {
    header: y,
...
function JT(r, t, e, i, n) {
  var a = t.getData(), o = wn(r, function(f, v, c) {
  ...
  function h(f, v) {
    ...
    !c || c.otherDims.tooltip === !1 || (o ? u.push(Ra("nameValue", {
      markerType: "subItem",
      markerColor: n,
      name: c.displayName,
      value: f,
...
var tC = "__universalTransitionEnabled", De = (
  /** @class */
  function(r) {
    N(t, r);
    function t() {
    ...
    return t.prototype.init = function(e, i, n) {
      ...
      var a = mr(this).sourceManager = new VT(this);
      a.prepareSource();
      var o = this.getInitialData(e, n);
      bp(o, this), this.dataTask.context.data = o, mr(this).dataBeforeProcessed = o, Sp(this), this._initSelectedMapFromData(o);
    }, t.prototype.mergeDefaultAndTheme = function(e, i) {
      var n = La(this), a = n ? il(e) : {}, o = this.subType;
      st.hasClass(o) && (o += "Series"), rt(e, i.getTheme().get(this.subType)), rt(e, this.getDefaultOption()), nv(e, "label", ["show"]), this.fillDataTextStyle(e.data), n && gn(e, a, n);
    }, t.prototype.mergeOption = function(e, i) {
      ...
      bp(o, this), this.dataTask.dirty(), this.dataTask.context.data = o, mr(this).dataBeforeProcessed = o, Sp(this), this._initSelectedMapFromData(o);
    }, t.prototype.fillDataTextStyle = function(e) {
      if (e && !Kt(e))
        for (var i = ["show"], n = 0; n < e.length; n++)
          e[n] && e[n].label && nv(e[n], "label", i);
      ...
      var a = this.ecModel, o = $f.prototype.getColorFromPalette.call(this, e, i, n);
      ...
      return (n === "all" || n[mo(a, e)]) && !a.getItemModel(e).get(["select", "disabled"]);
...
var Ae = (
  ...
  function() {
    function r() {
      this.group = new xt(), this.uid = Ks("viewComponent");
    }
...
var Dm = Dt(), oC = Wf(), ge = (
  ...
  function() {
    function r() {
      this.group = new xt(), this.uid = Ks("viewChart"), this.renderTask = pa({
        plan: sC,
        reset: lC
...
function wp(r, t, e) {
  r && fh(r) && (t === "emphasis" ? ds : gs)(r, e);
}
function xp(r, t, e) {
  var i = wi(r, t), n = t && t.highlightKey != null ? xw(t.highlightKey) : null;
  i != null ? C(Rt(i), function(a) {
    wp(r.getItemGraphicEl(a), e, n);
...
function lC(r) {
  var t = r.model, e = r.ecModel, i = r.api, n = r.payload, a = t.pipelineContext.progressiveRender, o = r.view, s = n && Dm(n).updateMethod, l = a ? "incrementalPrepareRender" : s && o[s] ? s : "render";
  return l !== "render" && o[l](t, e, i, n), uC[l];
}
var uC = {
...
}, ws = "\0__throttleOriginMethod", Tp = "\0__throttleRate", Cp = "\0__throttleType";
function Uf(r, t, e) {
...
function Am(r, t, e, i) {
  var n = r[t];
  if (n) {
    var a = n[ws] || n, o = n[Cp], s = n[Tp];
    if (s !== e || o !== i) {
      if (e == null || !i)
        return r[t] = a;
      n = r[t] = Uf(a, e, i === "debounce"), n[ws] = a, n[Cp] = i, n[Tp] = e;
    }
    return n;
  }
}
...
function Im(r, t) {
  var e = r.visualStyleMapper || Dp[t];
  return e || (console.warn("Unknown style type '" + t + "'."), Dp.itemStyle);
}
function Lm(r, t) {
...
var fC = {
  ...
  performRawSeries: !0,
  reset: function(r, t) {
    var e = r.getData(), i = r.visualStyleAccessPath || "itemStyle", n = r.getModel(i), a = Im(r, i), o = a(n), s = n.getShallow("decal");
    s && (e.setVisual("decal", s), s.dirty = !0);
    var l = Lm(r, i), u = o[l], h = q(u) ? u : null, f = o.fill === "auto" || o.stroke === "auto";
    if (!o[l] || h || f) {
  ...
  reset: function(r, t) {
    if (!(r.ignoreStyleOnData || t.isSeriesFiltered(r))) {
      var e = r.getData(), i = r.visualStyleAccessPath || "itemStyle", n = Im(r, i), a = e.getVisual("drawType");
      return {
        dataEach: e.hasItemOption ? function(o, s) {
          var l = o.getRawDataItem(s);
          if (l && l[i]) {
            Fn.option = l[i];
            var u = n(Fn), h = o.ensureUniqueItemVisual(s, "style");
            B(h, u), Fn.option.decal && (o.setItemVisual(s, "decal", Fn.option.decal), Fn.option.decal.dirty = !0), a in u && o.setItemVisual(s, "colorFromPalette", !1);
          }
        } : null
      };
    }
  ...
  overallReset: function(r) {
    ...
    r.eachSeries(function(e) {
      ...
      if (!e.isColorBySeries()) {
        ...
        a || (a = {}, t.set(n, a)), Mp(e).scope = a;
      }
    }), r.eachSeries(function(e) {
      if (!(e.isColorBySeries() || r.isSeriesFiltered(e))) {
        var i = e.getRawData(), n = {}, a = e.getData(), o = Mp(e).scope, s = e.visualStyleAccessPath || "itemStyle", l = Lm(e, s);
        a.each(function(u) {
  ...
  function() {
    ...
    return r.prototype.restoreData = function(t, e) {
      ...
      C(this._allHandlers, function(n) {
        ...
        Fe(!(n.reset && n.overallReset), o), n.reset && this._createSeriesStageTask(n, a, e, i), n.overallReset && this._createOverallStageTask(n, a, e, i);
      }, this);
      ...
      function h(f) {
        var v = f.uid, c = s.set(v, o && o.get(v) || pa({
          plan: _C,
          reset: SC,
          count: wC
        }));
      ...
      Fe(!t.createOnAllSeries, c), u ? i.eachRawSeriesByType(u, p) : h ? h(i, n).each(p) : (f = !1, C(i.getSeries(), p));
      function p(g) {
      ...
      return q(t) && (t = {
        overallReset: t,
        seriesType: xC(t)
      }), t.uid = Ks("stageHandler"), e && (t.visualType = e), t;
    }, r;
  }()
);
function dC(r) {
...
Om(Ea, Ff);
Om(Em, lm);
Ea.eachSeriesByType = Ea.eachRawSeriesByType = function(r) {
  xs = r;
};
Ea.eachComponent = function(r) {
...
var kt = "#B9B8CE", Ip = "#100C2A", So = function() {
  return {
    axisLine: {
      lineStyle: {
        color: kt
...
}, Lp = ["#4992ff", "#7cffb2", "#fddd60", "#ff6e76", "#58d9f9", "#05c091", "#ff8a45", "#8d48e3", "#dd79ff"], km = {
  darkMode: !0,
  color: Lp,
  backgroundColor: Ip,
  axisPointer: {
...
var CC = (
...
), xh = ["symbol", "symbolSize", "symbolRotate", "symbolOffset"], Pp = xh.concat(["symbolKeepAspect"]), MC = {
  createOnAllSeries: !0,
  // For legend.
  performRawSeries: !0,
  reset: function(r, t) {
  ...
  reset: function(r, t) {
    ...
    var e = r.getData();
    function i(n, a) {
      for (var o = n.getItemModel(a), s = 0; s < Pp.length; s++) {
        var l = Pp[s], u = o.getShallow(l, !0);
  ...
  e.isSilent(a) || i.eachComponent({
    ...
    for (var s = o.seriesIndex, l = o.option.selectedMap, u = n.selected, h = 0; h < u.length; h++)
      if (u[h].seriesIndex === s) {
        var f = o.getData(), v = wi(f, n.fromActionPayload);
        e.trigger(a, {
          type: a,
          seriesId: o.id,
...
function IC(r, t, e) {
  r.on("selectchanged", function(i) {
    var n = e.getModel();
    i.isFromClick ? (Fi("map", "selectchanged", t, n, i), Fi("pie", "selectchanged", t, n, i)) : i.fromAction === "select" ? (Fi("map", "selected", t, n, i), Fi("pie", "selected", t, n, i)) : i.fromAction === "unselect" && (Fi("map", "unselected", t, n, i), Fi("pie", "unselected", t, n, i));
  });
}
function Ji(r, t, e) {
...
var LC = Math.round(Math.random() * 9), PC = typeof Object.defineProperty == "function", RC = function() {
  function r() {
  ...
  return r.prototype.get = function(t) {
    ...
    var i = this._guard(t);
    return PC ? Object.defineProperty(i, this._id, {
      value: e,
      enumerable: !1,
      configurable: !0
    }) : i[this._id] = e, this;
...
var $C = lt.extend({
  ...
  buildPath: function(r, t, e) {
    ...
    if (i !== "none") {
      var n = Th[i];
      n || (i = "rect", n = Th[i]), zC[i](t.x, t.y, t.width, t.height, n.shape), n.buildPath(r, n.shape, e);
    }
  }
});
function FC(r, t) {
...
function lr(r, t, e, i, n, a, o) {
  ...
  var l;
  return r.indexOf("image://") === 0 ? l = ky(r.slice(8), new at(t, e, i, n), o ? "center" : "cover") : r.indexOf("path://") === 0 ? l = Pf(r.slice(7), {}, new at(t, e, i, n), o ? "center" : "cover") : l = new $C({
    shape: {
      symbolType: r,
      x: t,
      y: e,
  ...
  }), l.__isEmptyBrush = s, l.setColor = FC, a && l.setColor(a), l;
}
function VC(r) {
...
function zm(r, t) {
  if (r != null)
    return z(r) || (r = [r, r]), [Ft(r[0], t[0]) || 0, Ft(J(r[1], r[0]), t[1]) || 0];
}
function vi(r) {
  return isFinite(r);
}
function HC(r, t, e) {
  ...
  t.global || (i = i * e.width + e.x, n = n * e.width + e.x, a = a * e.height + e.y, o = o * e.height + e.y), i = vi(i) ? i : 0, n = vi(n) ? n : 1, a = vi(a) ? a : 0, o = vi(o) ? o : 0;
...
function GC(r, t, e) {
  ...
  t.global || (o = o * i + e.x, s = s * n + e.y, l = l * a), o = vi(o) ? o : 0.5, s = vi(s) ? s : 0.5, l = l >= 0 && vi(l) ? l : 0.5;
  var u = r.createRadialGradient(o, s, 0, o, s, l);
  return u;
}
function Ch(r, t, e) {
  for (var i = t.type === "radial" ? GC(r, t, e) : HC(r, t, e), n = t.colorStops, a = 0; a < n.length; a++)
...
function wo(r, t, e) {
  ...
  return (r[n] || bo(s[i]) || bo(r.style[i])) - (bo(s[a]) || 0) - (bo(s[o]) || 0) | 0;
}
function UC(r, t) {
  return !r || r === "solid" || !(t > 0) ? null : r === "dashed" ? [4 * t, 2 * t] : r === "dotted" ? [t] : pt(r) ? [r] : z(r) ? r : null;
}
function $m(r) {
  var t = r.style, e = t.lineDash && t.lineWidth > 0 && UC(t.lineDash, t.lineWidth), i = t.lineDashOffset;
  if (e) {
...
function XC(r, t, e, i) {
  var n, a = Ts(e), o = Cs(e), s = e.strokePercent, l = s < 1, u = !t.path;
  (!t.silent || l) && u && t.createPathProxy();
  var h = t.path || YC, f = t.__dirty;
  if (!i) {
    var v = e.fill, c = e.stroke, p = o && !!v.colorStops, g = a && !!c.colorStops, d = o && !!v.image, y = a && !!c.image, m = void 0, _ = void 0, S = void 0, w = void 0, b = void 0;
    (p || g) && (b = t.getBoundingRect()), p && (m = f ? Ch(r, v, b) : t.__canvasFillGradient, t.__canvasFillGradient = m), g && (_ = f ? Ch(r, c, b) : t.__canvasStrokeGradient, t.__canvasStrokeGradient = _), d && (S = f || !t.__canvasFillPattern ? Mh(r, v, t) : t.__canvasFillPattern, t.__canvasFillPattern = S), y && (w = f || !t.__canvasStrokePattern ? Mh(r, c, t) : t.__canvasStrokePattern, t.__canvasStrokePattern = S), p ? r.fillStyle = m : d && (S ? r.fillStyle = S : o = !1), g ? r.strokeStyle = _ : y && (w ? r.strokeStyle = w : a = !1);
  }
  var x = t.getGlobalScale();
  h.setScale(x[0], x[1], t.segmentIgnoreThreshold);
  var M, D;
  r.setLineDash && e.lineDash && (n = $m(t), M = n[0], D = n[1]);
  var A = !0;
  (u || f & Xi) && (h.setDPR(r.dpr), l ? h.setContext(null) : (h.setContext(r), A = !1), h.reset(), t.buildPath(h, t.shape, i), h.toStatic(), t.pathUpdated()), A && h.rebuildPath(r, l ? s : 1), M && (r.setLineDash(M), r.lineDashOffset = D), i || (e.strokeFirst ? (a && Op(r, e), o && Ep(r, e)) : (o && Ep(r, e), a && Op(r, e))), M && r.setLineDash([]);
}
function qC(r, t, e) {
  var i = t.__image = fy(e.image, t.__image, t, t.onload);
  if (!(!i || !$s(i))) {
...
function ZC(r, t, e) {
  ...
  if (n != null && (n += ""), n) {
    ...
    r.setLineDash && e.lineDash && (i = $m(t), a = i[0], o = i[1]), a && (r.setLineDash(a), r.lineDashOffset = o), e.strokeFirst ? (Ts(e) && r.strokeText(n, e.x, e.y), Cs(e) && r.fillText(n, e.x, e.y)) : (Cs(e) && r.fillText(n, e.x, e.y), Ts(e) && r.strokeText(n, e.x, e.y)), a && r.setLineDash([]);
  }
}
var kp = ["shadowBlur", "shadowOffsetX", "shadowOffsetY"], Bp = [
  ["lineCap", "butt"],
  ["lineJoin", "miter"],
  ["miterLimit", 10]
];
function Fm(r, t, e, i, n) {
  ...
  if (i || t.opacity !== e.opacity) {
    ...
    r.globalAlpha = isNaN(o) ? gi.opacity : o;
  }
  (i || t.blend !== e.blend) && (a || (qt(r, n), a = !0), r.globalCompositeOperation = t.blend || gi.blend);
  for (var s = 0; s < kp.length; s++) {
    var l = kp[s];
    (i || t[l] !== e[l]) && (a || (qt(r, n), a = !0), r[l] = r.dpr * (t[l] || 0));
  }
  return (i || t.shadowColor !== e.shadowColor) && (a || (qt(r, n), a = !0), r.shadowColor = t.shadowColor || gi.shadowColor), a;
}
function Np(r, t, e, i, n) {
  var a = Oa(t, n.inHover), o = i ? null : e && Oa(e, n.inHover) || {};
  if (a === o)
    return !1;
  var s = Fm(r, a, o, i, n);
...
function KC(r, t, e, i, n) {
  return Fm(r, Oa(t, n.inHover), e && Oa(e, n.inHover), i, n);
}
function Vm(r, t) {
...
function QC(r, t, e) {
  for (var i = !1, n = 0; n < r.length; n++) {
    var a = r[n];
    i = i || a.isZeroArea(), Vm(t, a), t.beginPath(), a.buildPath(t, a.shape), t.clip();
  }
  e.allClipped = i;
}
function jC(r, t) {
...
function Hm(r, t) {
  pi(r, t, { inHover: !1, viewWidth: 0, viewHeight: 0 }, !0);
}
function pi(r, t, e, i) {
  var n = t.transform;
  ...
  if ((!o || WC(a, o)) && (o && o.length && (qt(r, e), r.restore(), l = s = !0, e.prevElClipPaths = null, e.allClipped = !1, e.prevEl = null), a && a.length && (qt(r, e), r.save(), QC(a, r, e), s = !0), e.prevElClipPaths = a), e.allClipped) {
    t.__isRendered = !1;
    return;
  }
  ...
  var u = e.prevEl;
  u || (l = s = !0);
  var h = t instanceof lt && t.autoBatch && JC(t.style);
  s || jC(n, u.transform) ? (qt(r, e), Vm(r, t)) : h || qt(r, e);
  var f = Oa(t, e.inHover);
  t instanceof lt ? (e.lastDrawType !== zp && (l = !0, e.lastDrawType = zp), Np(r, t, u, l, e), (!h || !e.batchFill && !e.batchStroke) && r.beginPath(), XC(r, t, f, h), h && (e.batchFill = f.fill || "", e.batchStroke = f.stroke || "")) : t instanceof ps ? (e.lastDrawType !== Fp && (l = !0, e.lastDrawType = Fp), Np(r, t, u, l, e), ZC(r, t, f)) : t instanceof qe ? (e.lastDrawType !== $p && (l = !0, e.lastDrawType = $p), KC(r, t, u, l, e), qC(r, t, f)) : t.getTemporalDisplayables && (e.lastDrawType !== Vp && (l = !0, e.lastDrawType = Vp), tM(r, t, e)), h && i && qt(r, e), t.innerAfterBrush(), t.afterBrush && t.afterBrush(), e.prevEl = t, t.__dirty = 0, t.__isRendered = !0;
}
function tM(r, t, e) {
  ...
  for (o = t.getCursor(), s = i.length; o < s; o++) {
    var l = i[o];
    l.beforeBrush && l.beforeBrush(), l.innerBeforeBrush(), pi(r, l, a, o === s - 1), l.innerAfterBrush(), l.afterBrush && l.afterBrush(), a.prevEl = l;
  }
  for (var u = 0, h = n.length; u < h; u++) {
    var l = n[u];
    l.beforeBrush && l.beforeBrush(), l.innerBeforeBrush(), pi(r, l, a, u === h - 1), l.innerAfterBrush(), l.afterBrush && l.afterBrush(), a.prevEl = l;
  }
  t.clearTemporalDisplayables(), t.notClear = !0, r.restore();
}
var vu = new RC(), Hp = new Va(100), Gp = ["symbol", "symbolSize", "symbolKeepAspect", "color", "backgroundColor", "dashArrayX", "dashArrayY", "maxTileWidth", "maxTileHeight"];
function Dh(r, t) {
  if (r === "none")
    return null;
  ...
  return l(s), s.rotation = o.rotation, s.scaleX = s.scaleY = n ? 1 : 1 / e, vu.set(r, s), r.dirty = !1, s;
  function l(u) {
    for (var h = [e], f = !0, v = 0; v < Gp.length; ++v) {
      var c = o[Gp[v]];
      if (c != null && !z(c) && !F(c) && !pt(c) && typeof c != "boolean") {
        f = !1;
        break;
      }
      h.push(c);
    ...
    var d = Wm(o.dashArrayX), y = eM(o.dashArrayY), m = Gm(o.symbol), _ = rM(d), S = Um(y), w = !n && Er.createCanvas(), b = n && {
      tag: "g",
      attrs: {},
      key: "dcl",
      children: []
    }, x = D(), M;
    w && (w.width = x.width * e, w.height = x.height * e, M = w.getContext("2d")), A(), f && Hp.put(p, w || b), u.image = w, u.svgElement = b, u.svgWidth = x.width, u.svgHeight = x.height;
    function D() {
    ...
    function A() {
      ...
      if (T <= 0)
        return;
      for (var L = -S, P = 0, R = 0, E = 0; L < x.height; ) {
        if (P % 2 === 0) {
          for (var H = R / 2 % m.length, O = 0, $ = 0, G = 0; O < x.width * 2; ) {
            for (var K = 0, I = 0; I < d[E].length; ++I)
              K += d[E][I];
            if (K <= 0)
              break;
            if ($ % 2 === 0) {
              var tt = (1 - o.symbolSize) * 0.5, ut = O + d[E][$] * tt, dt = L + y[P] * tt, St = d[E][$] * o.symbolSize, me = y[P] * o.symbolSize, Nr = G / 2 % m[H].length;
              Ai(ut, dt, St, me, m[H][Nr]);
            }
            O += d[E][$], ++G, ++$, $ === d[E].length && ($ = 0);
          }
          ++E, E === d.length && (E = 0);
        }
        L += y[P], ++R, ++P, P === y.length && (P = 0);
      }
      function Ai(jt, It, Z, et, zr) {
        var zt = n ? 1 : e, uc = lr(zr, jt * zt, It * zt, Z * zt, et * zt, o.color, o.symbolKeepAspect);
        if (n) {
          var hc = i.painter.renderOneToVNode(uc);
          hc && b.children.push(hc);
        } else
          Hm(M, uc);
      }
    }
...
var oM = 1, sM = 800, lM = 900, uM = 1e3, hM = 2e3, fM = 5e3, Xm = 1e3, cM = 1100, Yf = 2e3, qm = 3e3, vM = 4e3, sl = 4500, pM = 4600, dM = 5e3, gM = 6e3, Zm = 7e3, yM = {
  PROCESSOR: {
    FILTER: uM,
    SERIES_FILTER: sM,
    STATISTIC: fM
...
}, Ot = "__flagInMainProcess", Wt = "__pendingUpdate", pu = "__needsUpdateStatus", Wp = /^[a-zA-Z0-9_]+$/, du = "__connectUpdateStatus", Up = 0, mM = 1, _M = 2;
function Km(r) {
  return function() {
...
t0.on = Qm("on");
t0.off = Qm("off");
var Vi, gu, xo, _r, yu, mu, _u, Vn, Hn, Yp, Xp, Su, qp, To, Zp, e0, ie, Kp, r0 = (
  /** @class */
  function(r) {
    N(t, r);
    function t(e, i, n) {
      var a = r.call(this, new CC()) || this;
      a._chartsViews = [], a._chartsMap = {}, a._componentsViews = [], a._componentsMap = {}, a._pendingActions = [], n = n || {}, F(i) && (i = i0[i]), a._dom = e;
      ...
      a._ssr = n.ssr, a._throttledZrFlush = Uf(j(u.flush, u), 17), i = X(i), i && hm(i, !0), a._theme = i, a._locale = Px(n.locale || Gy), a._coordSysMgr = new nl();
      var h = a._api = Zp(a);
      function f(v, c) {
        return v.__prio - c.__prio;
      }
      return $o(Ds, f), $o(Ah, f), a._scheduler = new Pm(a, h, Ah, Ds), a._messageCenter = new Jm(), a._initEvents(), a.resize = j(a.resize, a), u.animation.on("frame", a._onframe, a), Yp(u, a), Xp(u, a), Hu(a), a;
    }
    return t.prototype._onframe = function() {
      if (!this._disposed) {
        ...
        if (this[Wt]) {
          ...
          this[Ot] = !0;
          try {
            Vi(this), _r.update.call(this, null, this[Wt].updateParams);
          } catch (l) {
            throw this[Ot] = !1, this[Wt] = null, l;
          }
          this._zr.flush(), this[Ot] = !1, this[Wt] = null, Vn.call(this, i), Hn.call(this, i);
        } else if (e.unfinished) {
          var n = oM, a = this._model, o = this._api;
          e.unfinished = !1;
          do {
            var s = +/* @__PURE__ */ new Date();
            e.performSeriesTasks(a), e.performDataProcessorTasks(a), mu(this, a), e.performVisualTasks(a), To(this, this._model, o, "remain", {}), n -= +/* @__PURE__ */ new Date() - s;
      ...
      if (!this[Ot]) {
        ...
        var a, o, s;
        if (V(i) && (n = i.lazyUpdate, a = i.silent, o = i.replaceMerge, s = i.transition, i = i.notMerge), this[Ot] = !0, !this._model || i) {
          var l = new aT(this._api), u = this._theme, h = this._model = new Ff();
        ...
        if (n)
          this[Wt] = {
            silent: a,
            updateParams: f
          }, this[Ot] = !1, this.getZr().wakeUp();
        else {
          try {
            Vi(this), _r.update.call(this, null, f);
          } catch (v) {
            throw this[Wt] = null, this[Ot] = !1, v;
          }
          this._ssr || this._zr.flush(), this[Wt] = null, this[Ot] = !1, Vn.call(this, a), Hn.call(this, a);
        }
      }
      ...
      if (Qp[n]) {
        ...
        C(ga, function(_, S) {
          if (_.group === n) {
            var w = i ? _.getZr().painter.getSvgDom().innerHTML : _.renderToCanvas(X(e)), b = _.getDom().getBoundingClientRect();
            l = a(b.left, l), u = a(b.top, u), h = o(b.right, h), f = o(b.bottom, f), v.push({
              dom: w,
              left: b.left,
              top: b.top
            });
        ...
        var p = h - l, g = f - u, d = Er.createCanvas(), y = Jc(d, {
      ...
      return yu(this, "convertToPixel", e, i);
    }, t.prototype.convertFromPixel = function(e, i) {
      return yu(this, "convertFromPixel", e, i);
      ...
      }), IC(this._messageCenter, this, this._api);
      ...
      C(i._componentsViews, function(o) {
        ...
        o.dispose(a, n);
      }), i._zr.dispose(), i._dom = i._model = i._chartsMap = i._componentsMap = i._chartsViews = i._componentsViews = i._scheduler = i._api = i._zr = i._throttledZrFlush = i._theme = i._coordSysMgr = i._messageCenter = null, delete ga[i.id];
      ...
      if (!this[Ot]) {
        ...
        if (this._loadingFX && this._loadingFX.resize(), !!i) {
          ...
          this[Wt] && (a == null && (a = this[Wt].silent), n = !0, this[Wt] = null), this[Ot] = !0;
          try {
            n && Vi(this), _r.update.call(this, {
              type: "resize",
              animation: B({
                // Disable animation
                duration: 0
          ...
          this[Ot] = !1, Vn.call(this, a), Hn.call(this, a);
        }
      }
      ...
      if (V(e) && (i = e, e = ""), e = e || "default", this.hideLoading(), !!Lh[e]) {
        var n = Lh[e](this._api, i), a = this._zr;
      ...
      if (V(i) || (i = {
        ...
        _u.call(this, e, n);
        var a = i.flush;
        a ? this._zr.flush() : a !== !1 && Y.browser.weChat && this._throttledZrFlush(), Vn.call(this, n), Hn.call(this, n);
      }
    }, t.prototype.updateLabelLayout = function() {
      xe.trigger("series:layoutlabels", this._model, this._api, {
      ...
      Vi = function(f) {
        var v = f._scheduler;
        v.restorePipelines(f._model), v.prepareStageTasks(), gu(f, !0), gu(f, !1), v.plan();
      }, gu = function(f, v) {
        ...
        function S(b) {
          ...
          var M = "_ec_" + b.id + "_" + b.type, D = !x && d[M];
          if (!D) {
            var A = ze(b.type), T = v ? Ae.getClass(A.main, A.sub) : (
              // FIXME:TS
          ...
          b.__viewId = D.__id = M, D.__alive = !0, D.__model = b, D.group.__ecComponentInfo = {
            mainType: b.mainType,
            index: b.componentIndex
          }, !v && p.prepareView(D, b, c, m);
        }
        ...
        _ != null && (S = Q(), C(Rt(_), function(b) {
          var x = Me(b, null);
          x != null && S.set(x, !0);
        })), d && d.eachComponent(m, function(b) {
          var x = S && S.get(b.id) != null;
          if (!x)
            if (Pv(c))
              if (b instanceof De)
                c.type === yi && !c.notBlur && !b.get(["emphasis", "disabled"]) && dw(b, c, f._api);
              else {
                var M = xf(b.mainType, b.componentIndex, c.name, f._api), D = M.focusSelf, A = M.dispatchers;
                c.type === yi && D && !c.notBlur && lh(b.mainType, b.componentIndex, f._api), A && C(A, function(T) {
                  c.type === yi ? ds(T) : gs(T);
                });
              }
            else ch(c) && b instanceof De && (mw(b, c, f._api), Iv(b), ie(f));
        }, f), d && d.eachComponent(m, function(b) {
          var x = S && S.get(b.id) != null;
          x || w(f[p === "series" ? "_chartsMap" : "_componentsMap"][b.__viewId]);
        }, f);
        function w(b) {
          b && b.__alive && b[v] && b[v](b.__model, d, f._api, c);
        }
      }, _r = {
        prepareAndUpdate: function(f) {
          Vi(this), _r.update.call(this, f, {
        ...
        update: function(f, v) {
          ...
          if (c) {
            c.setUpdatePayload(f), y.restoreData(c, f), y.performSeriesTasks(c), d.create(c, p), y.performDataProcessorTasks(c, f), mu(this, c), d.update(c, p), e(c), y.performVisualTasks(c, f), Su(this, c, p, f, v);
            var m = c.get("backgroundColor") || "transparent", _ = c.get("darkMode");
            g.setBackgroundColor(m), _ != null && _ !== "auto" && g.setDarkMode(_), xe.trigger("afterupdate", c, p);
          }
        },
        updateTransform: function(f) {
          ...
          if (c) {
              ...
              if (y !== "series") {
                ...
                if (_ && _.__alive)
                  if (_.updateTransform) {
                    var S = _.updateTransform(m, c, p, f);
                    S && S.update && g.push(_);
                  } else
                    g.push(_);
              }
            ...
            c.eachSeries(function(y) {
              ...
              setDirty: !0,
              dirtyMap: d
            }), To(this, c, p, f, {}, d), xe.trigger("afterupdate", c, p);
          }
        },
        updateView: function(f) {
          var v = this._model;
          v && (v.setUpdatePayload(f), ge.markUpdateMethod(f, "updateView"), e(v), this._scheduler.performVisualTasks(v, f, {
            setDirty: !0
          }), Su(this, v, this._api, f, {}), xe.trigger("afterupdate", v, this._api));
        },
        updateVisual: function(f) {
          var v = this, c = this._model;
          c && (c.setUpdatePayload(f), c.eachSeries(function(p) {
            p.getData().clearAllVisual();
          }), ge.markUpdateMethod(f, "updateVisual"), e(c), this._scheduler.performVisualTasks(c, f, {
            visualType: "visual",
            setDirty: !0
          ...
          }), xe.trigger("afterupdate", c, this._api));
        },
        updateLayout: function(f) {
          _r.update.call(this, f);
        }
      }, yu = function(f, v, c, p) {
        if (f._disposed) {
          f.id;
        ...
        for (var g = f._model, d = f._coordSysMgr.getCoordinateSystems(), y, m = Fl(g, c), _ = 0; _ < d.length; _++) {
          var S = d[_];
          if (S[v] && (y = S[v](g, m, p)) != null)
            return y;
        }
      }, mu = function(f, v) {
        ...
        var c = this, p = this.getModel(), g = f.type, d = f.escapeConnect, y = Ms[g], m = y.actionInfo, _ = (m.update || "update").split(":"), S = _.pop(), w = _[0] != null && ze(_[0]);
        this[Ot] = !0;
        var b = [f], x = !1;
        f.batch && (x = !0, b = W(f.batch, function(P) {
          return P = ot(B({}, P), f), P.batch = null, P;
        }));
        var M = [], D, A = ch(f), T = Pv(f);
        if (T && Dy(this._api), C(b, function(P) {
          if (D = y.action(P, c._model, c._api), D = D || B({}, P), D.type = m.event || D.type, M.push(D), T) {
            var R = mf(f), E = R.queryOptionMap, H = R.mainTypeSpecified, O = H ? E.keys()[0] : "series";
            xo(c, S, P, O), ie(c);
          } else A ? (xo(c, S, P, "series"), ie(c)) : w && xo(c, S, P, w.main, w.sub);
        }), S !== "none" && !T && !A && !w)
          try {
            this[Wt] ? (Vi(this), _r.update.call(this, f), this[Wt] = null) : _r[S].call(this, f);
          } catch (P) {
            throw this[Ot] = !1, P;
          }
        if (x ? D = {
        ...
        f.on("mouseover", function(c) {
          var p = c.target, g = Ji(p, fh);
          g && (gw(g, c, v._api), ie(v));
        }).on("mouseout", function(c) {
          var p = c.target, g = Ji(p, fh);
          g && (yw(g, c, v._api), ie(v));
        }).on("click", function(c) {
          var p = c.target, g = Ji(p, function(m) {
      ...
      function i(f) {
        ...
        if (f.eachComponent(function(m, _) {
          ...
          $o(g, function(m, _) {
            ...
            d != null && (S = Math.max(d, S)), w ? (S === d && w !== y && S++, y = w) : y && (S === d && S++, y = ""), d = S, _.setZLevel(S);
          });
        }
      }
      Su = function(f, v, c, p, g) {
        i(v), qp(f, v, c, p, g), C(f._chartsViews, function(d) {
          d.__alive = !1;
        }), To(f, v, c, p, g), C(f._chartsViews, function(d) {
          d.__alive || d.remove(v, c);
        });
      }, qp = function(f, v, c, p, g, d) {
        C(d || f._componentsViews, function(y) {
          var m = y.__model;
          u(m, y), y.render(m, v, c, p), s(m, y), h(m, y);
        });
      }, To = function(f, v, c, p, g, d) {
        var y = f._scheduler;
        g = B(g || {}, {
          updatedSeries: v.getSeries()
        }), xe.trigger("series:beforeupdate", v, c, g);
        var m = !1;
        v.eachSeries(function(_) {
          var S = f._chartsMap[_.__viewId];
          S.__alive = !0;
          var w = S.renderTask;
          y.updatePayload(w, p), u(_, S), d && d.get(_.uid) && w.dirty(), w.perform(y.getPerformArgs(w)) && (m = !0), S.group.silent = !!_.get("silent"), o(_, S), Iv(_);
        }), y.unfinished = m || y.unfinished, xe.trigger("series:layoutlabels", v, c, g), xe.trigger("series:transition", v, c, g), v.eachSeries(function(_) {
          var S = f._chartsMap[_.__viewId];
          s(_, S), h(_, S);
        }), a(f, v), xe.trigger("series:afterupdate", v, c, g);
      }, ie = function(f) {
      ...
      function n(f) {
        ...
        f.selected && f.states.select && v.push("select"), f.hoverState === Hs && f.states.emphasis ? v.push("emphasis") : f.hoverState === Vs && f.states.blur && v.push("blur"), f.useStates(v);
      }
      function a(f, v) {
      ...
      function l(f, v, c, p) {
        ...
        if (g && (g.z = v, g.zlevel = c, isFinite(p) && (g.z2 = p + 2)), d) {
          ...
          d.z = v, d.zlevel = c, isFinite(p) && (d.z2 = p + (S && S.showAbove ? 1 : -1));
        }
        return p;
      }
      function u(f, v) {
      ...
      function h(f, v) {
        ...
        v.eachRendered(function(y) {
          if (y.states && y.states.emphasis) {
            if (ca(y))
              return;
            if (y instanceof lt && Tw(y), y.__dirty) {
              var m = y.prevStates;
              m && y.useStates(m);
            }
            if (p) {
              ...
              _ && (_.stateTransition = d), S && (S.stateTransition = d);
            }
            y.__dirty && n(y);
          }
        });
...
var SM = ["click", "dblclick", "mouseover", "mouseout", "mousemove", "mousedown", "mouseup", "globalout", "contextmenu"];
var Ms = {}, da = {}, Ah = [], Ih = [], Ds = [], i0 = {}, Lh = {}, ga = {}, Qp = {}, bM = +/* @__PURE__ */ new Date() - 0, qf = "_echarts_instance_";
function wM(r, t, e) {
  var i = !(e && e.ssr);
  if (i) {
    var n = xM(r);
  ...
  var a = new r0(r, t, e);
  return a.id = "ec_" + bM++, ga[a.id] = a, i && ly(r, qf, a.id), e0(a), xe.trigger("afterinit", a), a;
}
function xM(r) {
  return ga[ib(r, qf)];
}
...
function Mn(r, t, e) {
  ...
  r.event = (r.event || i).toLowerCase(), t = r.event, !da[t] && (Fe(Wp.test(i) && Wp.test(t)), Ms[i] || (Ms[i] = {
    action: e,
    actionInfo: r
  }), da[t] = i);
}
...
function Kf(r, t, e, i, n) {
  if ((q(t) || V(t)) && (e = t, t = i), !(ht(jp, e) >= 0)) {
    jp.push(e);
    var a = Pm.wrapStageHandler(e, n);
...
var LM = (
  ...
  function() {
    function r(t, e, i, n, a, o) {
      this._old = t, this._new = e, this._oldKeyGetter = i || Jp, this._newKeyGetter = n || Jp, this.context = a, this._diffModeMultiple = o === "multiple";
    }
    return r.prototype.add = function(t) {
      ...
      for (var s = 0; s < a.length; s++) {
        var l = a[s], u = i[l], h = n[l], f = Gn(u), v = Gn(h);
        if (f > 1 && v === 1)
...
function RM(r, t) {
  ...
  C(r.dimensions, function(v) {
    ...
    if (p) {
      ...
      bu(i, p)[g] = v, c.isExtraCoord || (n.set(p, 1), OM(c.type) && (a[0] = v), bu(s, p)[g] = r.getDimensionIndex(c.name)), c.defaultTooltip && o.push(v);
    }
    im.each(function(d, y) {
      var m = bu(i, y), _ = c.otherDims[y];
  ...
  var f = i.tooltip;
  return f && f.length ? o = f.slice() : o.length || (o = a.slice()), i.defaultedLabel = a, i.defaultedTooltip = o, e.userOutput = new PM(s, t), e;
}
function bu(r, t) {
...
var Qo = (
  ...
  function() {
    ...
    return r.prototype.isDimensionOmitted = function() {
      ...
      this._dimOmitted = t, t && (this._dimNameMap || (this._dimNameMap = f0(this.source)));
      ...
      for (var t = this._fullDimCount, e = vm(this.source), i = !c0(t), n = "", a = [], o = 0, s = 0; o < t; o++) {
        ...
        a.push({
          ...
          type: u,
          ordinalMeta: h
        }), e && l != null && (!f || !f.isCalculationCoord) && (n += i ? l.replace(/\`/g, "`1").replace(/\$/g, "`2") : l), n += "$", n += BM[u] || "f", h && (n += h.uid), n += "$";
      }
...
var Wn = V, Sr = W, NM = typeof Int32Array > "u" ? Array : Int32Array, zM = "e\0\0", td = -1, $M = ["hasItemOption", "_nameList", "_idList", "_invertedIndicesMap", "_dimSummary", "userOutput", "_rawData", "_dimValueGetter", "_nameDimIdx", "_idDimIdx", "_nameRepeatCount"], FM = ["_approximateExtent"], ed, Co, Un, Yn, wu, Xn, xu, VM = (
  /** @class */
  function() {
    function r(t, e) {
      this.type = "list", this._dimOmitted = !1, this._nameList = [], this._idList = [], this._visual = {}, this._layout = {}, this._itemVisuals = [], this._itemLayouts = [], this._graphicEls = [], this._approximateExtent = {}, this._calculationInfo = {}, this.hasItemOption = !1, this.TRANSFERABLE_METHODS = ["cloneShallow", "downSample", "minmaxDownSample", "lttbDownSample", "map"], this.CHANGABLE_METHODS = ["filterSelf", "selectRange"], this.DOWNSAMPLE_METHODS = ["downSample", "minmaxDownSample", "lttbDownSample"];
      var i, n = !1;
      u0(t) ? (i = t.dimensions, this._dimOmitted = t.isDimensionOmitted(), this._schema = t) : (n = !0, i = t), i = i || ["x", "y"];
      for (var a = {}, o = [], s = {}, l = !1, u = {}, h = 0; h < i.length; h++) {
        var f = i[h], v = F(f) ? new Qo({
          name: f
        }) : f instanceof Qo ? f : new Qo(f), c = v.name;
    ...
    return r.prototype.getDimension = function(t) {
      ...
      var n = this, a;
      if (t instanceof mh && (a = t), !a) {
        var o = this.dimensions, s = Vf(t) || Zt(t) ? new pm(t, o.length) : t;
        a = new mh();
      ...
      this._store = a, this._nameList = (e || []).slice(), this._idList = [], this._nameRepeatCount = {}, this._doInit(0, a.count()), this._dimSummary = RM(this, this._schema), this.userOutput = this._dimSummary.userOutput;
    }, r.prototype.appendData = function(t) {
      ...
      if (this._updateOrdinalMeta(), e)
        for (var s = n; s < a; s++) {
          var l = s - n;
          this._nameList[s] = e[l], o && xu(this, s);
        }
      ...
      if (!(t >= e)) {
        ...
        var a = this._nameList, o = this._idList, s = n.getSource().sourceFormat, l = s === ye;
        if (l && !n.pure)
          for (var u = [], h = t; h < e; h++) {
            var f = n.getItem(h, u);
            if (!this.hasItemOption && US(f) && (this.hasItemOption = !0), f) {
              var v = f.name;
              a[h] == null && v != null && (a[h] = Me(v, null));
              var c = f.id;
              o[h] == null && c != null && (o[h] = Me(c, null));
            }
          }
      ...
      Wn(t) ? B(this._calculationInfo, t) : this._calculationInfo[t] = e;
      ...
      return Co(this, this.getRawIndex(t));
    }, r.prototype.count = function() {
      ...
      return z(t) ? n.getValues(Sr(t, function(a) {
      ...
      var a = i || n || this, o = Sr(Yn(t), this._getStoreDimIndex, this), s = Xn(this);
      return s._store = this._store.map(o, a ? j(e, a) : e), s;
    }, r.prototype.modify = function(t, e, i, n) {
      var a = i || n || this, o = Sr(Yn(t), this._getStoreDimIndex, this);
      ...
      return new bt(i, e, e && e.ecModel);
    }, r.prototype.diff = function(t) {
      var e = this;
      return new LM(t ? t.getStore().getIndices() : [], this.getStore().getIndices(), function(i) {
        return Co(t, i);
      }, function(i) {
        return Co(e, i);
      });
      ...
      this._visual = this._visual || {}, Wn(t) ? B(this._visual, t) : this._visual[t] = e;
      ...
      n || (n = i[t] = {});
      var a = n[e];
      return a == null && (a = this.getVisual(e), z(a) ? a = a.slice() : Wn(a) && (a = B({}, a)), n[e] = a), a;
    }, r.prototype.setItemVisual = function(t, e, i) {
      var n = this._itemVisuals[t] || {};
      this._itemVisuals[t] = n, Wn(e) ? B(n, e) : n[e] = i;
    }, r.prototype.clearAllVisual = function() {
      this._visual = {}, this._itemVisuals = [];
    }, r.prototype.setLayout = function(t, e) {
      Wn(t) ? B(this._layout, t) : this._layout[t] = e;
      ...
      nw(i, this.dataType, t, e), this._graphicEls[t] = e;
      ...
      q(i) && (this.__wrappedMethods = this.__wrappedMethods || [], this.__wrappedMethods.push(t), this[t] = function() {
        ...
        return e.apply(this, [n].concat(sf(arguments)));
      });
    }, r.internalField = function() {
      ed = function(t) {
        ...
        C(e, function(i, n) {
          ...
          if (o) {
            i = e[n] = new NM(o.categories.length);
        ...
        return Me(t._getCategory(e, i), null);
      }, Co = function(t, e) {
        var i = t._idList[e];
        return i == null && t._idDimIdx != null && (i = Un(t, t._idDimIdx, e)), i == null && (i = zM + e), i;
      }, Yn = function(t) {
        ...
        C($M.concat(e.__wrappedMethods || []), function(i) {
          e.hasOwnProperty(i) && (t[i] = e[i]);
        }), t.__wrappedMethods = e.__wrappedMethods, C(FM, function(i) {
          t[i] = X(e[i]);
...
function HM(r, t) {
  Vf(r) || (r = fm(r)), t = t || {};
  var e = t.coordDimensions || [], i = t.dimensionsDefine || r.dimensionsDefine || [], n = Q(), a = [], o = WM(r, e, i, t.dimensionsCount), s = t.canOmitUnusedDimensions && c0(o), l = i === r.dimensionsDefine, u = l ? f0(r) : h0(i), h = t.encodeDefine;
  !h && t.encodeDefaulter && (h = t.encodeDefaulter(r, o));
  for (var f = Q(h), v = new _m(o), c = 0; c < v.length; c++)
    v[c] = -1;
  function p(D) {
    var A = v[D];
    if (A < 0) {
  ...
  C(e, function(D) {
    ...
    if (R !== !1) {
      ...
      C(R, function(H, O) {
        var $ = p(H);
        if (l && L.type != null && ($.type = L.type), d(ot($, L), A, O), $.name == null && T) {
          var G = T[O];
          !V(G) && (G = {
            name: G
  ...
  function d(D, A, T) {
    im.get(A) != null ? D.otherDims[A] = T : (D.coordDim = A, D.coordDimIndex = T, n.set(A, !0));
  }
  ...
  if (s)
    ...
    for (var b = 0; b < o; b++) {
      var x = p(b), M = x.coordDim;
      M == null && (x.coordDim = UM(S, n, _), x.coordDimIndex = 0, (!y || m <= 0) && (x.isExtraCoord = !0), m--), w(x), x.type == null && (sm(r, b) === Jt.Must || x.isExtraCoord && (x.otherDims.itemName != null || x.otherDims.seriesName != null)) && (x.type = "ordinal");
    }
  return GM(a), new l0({
    source: r,
    dimensions: a,
...
function XM(r) {
  var t = r.get("coordinateSystem"), e = new YM(t), i = qM[t];
  if (i)
    return i(r, e, e.axisMap, e.categoryAxisMap), e;
}
var qM = {
  cartesian2d: function(r, t, e, i) {
    var n = r.getReferringComponents("xAxis", Te).models[0], a = r.getReferringComponents("yAxis", Te).models[0];
    t.coordSysDims = ["x", "y"], e.set("x", n), e.set("y", a), Hi(n) && (i.set("x", n), t.firstCategoryDimIndex = 0), Hi(a) && (i.set("y", a), t.firstCategoryDimIndex == null && (t.firstCategoryDimIndex = 1));
  },
  singleAxis: function(r, t, e, i) {
    var n = r.getReferringComponents("singleAxis", Te).models[0];
    t.coordSysDims = ["single"], e.set("single", n), Hi(n) && (i.set("single", n), t.firstCategoryDimIndex = 0);
  },
  polar: function(r, t, e, i) {
    var n = r.getReferringComponents("polar", Te).models[0], a = n.findAxisModel("radiusAxis"), o = n.findAxisModel("angleAxis");
    t.coordSysDims = ["radius", "angle"], e.set("radius", a), e.set("angle", o), Hi(a) && (i.set("radius", a), t.firstCategoryDimIndex = 0), Hi(o) && (i.set("angle", o), t.firstCategoryDimIndex == null && (t.firstCategoryDimIndex = 1));
  },
  ...
  parallel: function(r, t, e, i) {
    ...
    C(a.parallelAxisIndex, function(s, l) {
      ...
      e.set(h, u), Hi(u) && (i.set(h, u), t.firstCategoryDimIndex == null && (t.firstCategoryDimIndex = l));
    });
  }
};
function Hi(r) {
...
function ZM(r, t, e) {
  ...
  KM(t) ? a = t : (o = t.schema, a = o.dimensions, s = t.store);
...
function jM(r, t) {
  var e = r.get("coordinateSystem"), i = nl.get(e), n;
...
function ll(r, t, e) {
  ...
  n = i.getSource(), a = n.sourceFormat === ye;
  var o = XM(t), s = jM(t, o), l = e.useEncodeDefaulter, u = q(l) ? l : l ? Ct(Yx, s, t) : null, h = {
    coordDimensions: s,
    generateCoord: e.generateCoord,
    encodeDefine: t.getEncode(),
    encodeDefaulter: u,
    canOmitUnusedDimensions: !a
  }, f = HM(n, h), v = JM(f.dimensions, e.createInvertedIndices, o), c = a ? null : i.getSharedDataStore(f), p = ZM(t, {
    schema: f,
    store: c
  }), g = new VM(f, t);
  g.setCalculationInfo(p);
  var d = v != null && tD(n) ? function(y, m, _, S) {
...
var rD = 0, Ph = (
  ...
  function() {
    function r(t) {
      this.categories = t.categories || [], this._needCollect = t.needCollect, this._deduplication = t.deduplication, this.uid = ++rD;
    }
    return r.createByAxisModel = function(t) {
      var e = t.option, i = e.data, n = i && W(i, iD);
      return new r({
        categories: n,
        needCollect: !n,
...
function nD(r, t, e, i) {
  var n = {}, a = r[1] - r[0], o = n.interval = iy(a / t);
  e != null && o < e && (o = n.interval = e), i != null && o > i && (o = n.interval = i);
  var s = n.intervalPrecision = v0(o), l = n.niceTickExtent = [Tt(Math.ceil(r[0] / o) * o, s), Tt(Math.floor(r[1] / o) * o, s)];
  return aD(l, r), n;
}
function Tu(r) {
  var t = Math.pow(10, gf(r)), e = r / t;
  return e ? e === 2 ? e = 3 : e === 3 ? e = 5 : e *= 2 : e = 1, Tt(e * t);
}
function v0(r) {
  return tr(r) + 2;
}
...
function aD(r, t) {
  !isFinite(r[0]) && (r[0] = t[0]), !isFinite(r[1]) && (r[1] = t[1]), rd(r, 0, t), rd(r, 1, t), r[0] > r[1] && (r[0] = r[1]);
}
function ul(r, t) {
  return r >= t[0] && r <= t[1];
}
...
var Qf = (
  ...
  function(r) {
    ...
    function t(e) {
      ...
      return n || (n = new Ph({})), z(n) && (n = new Ph({
    ...
    return t.prototype.parse = function(e) {
      ...
      return e = this.parse(e), ul(e, this._extent) && this._ordinalMeta.categories[e] != null;
    }, t.prototype.normalize = function(e) {
      return e = this._getTickNumber(this.parse(e)), hl(e, this._extent);
...
var oi = Tt, Dn = (
  ...
  function(r) {
    ...
    return t.prototype.parse = function(e) {
      ...
      this._interval = e, this._niceExtent = this._extent.slice(), this._intervalPrecision = v0(e);
      ...
      for (var u = a[0]; u <= a[1] && (s.push({
        value: u
      }), u = oi(u + i, o), u !== s[s.length - 1].value); )
        if (s.length > l)
          return [];
      ...
      e.fixMin || (i[0] = oi(Math.floor(i[0] / o) * o)), e.fixMax || (i[1] = oi(Math.ceil(i[1] / o) * o));
...
Ke.registerClass(Dn);
var p0 = typeof Float32Array < "u", oD = p0 ? Float32Array : Array;
function er(r) {
  return z(r) ? p0 ? new Float32Array(r) : r : new oD(r);
}
var sD = "__ec_stack_";
function d0(r) {
...
function y0(r) {
  ...
  return C(r, function(i) {
    ...
    var p = Ft(i.get("barWidth"), s), g = Ft(i.get("barMaxWidth"), s), d = Ft(
      // barMinWidth by default is 0.5 / 1 in cartesian. Because in value axis,
      // the auto-calculated bar width might be less than 0.5 / 1.
      i.get("barMinWidth") || (_0(i) ? 0.5 : 1),
      s
...
function uD(r) {
  ...
  return C(t, function(i, n) {
    ...
    var u = Ft(s, o), h = Ft(i.gap, 1), f = i.remainedWidth, v = i.autoWidthCount, c = (f - u) / (v + (v - 1) * h);
    c = Math.max(c, 0), C(a, function(y) {
      var m = y.maxWidth, _ = y.minWidth;
      if (y.width) {
        var S = y.width;
        m && (S = Math.min(S, m)), _ && (S = Math.max(S, _)), y.width = S, f -= S + h * S, v--;
      } else {
        var S = c;
        m && m < S && (S = Math.min(m, f)), _ && _ > S && (S = _), S !== c && (y.width = S, f -= S + h * S, v--);
      }
...
function fD(r, t) {
  var e = g0(r, t), i = y0(e);
  C(e, function(n) {
    var a = n.getData(), o = n.coordinateSystem, s = o.getBaseAxis(), l = d0(n), u = i[jf(s)][l], h = u.offset, f = u.width;
    a.setLayout({
...
function cD(r) {
  return {
    ...
    reset: function(t) {
      if (m0(t)) {
        var e = t.getData(), i = t.coordinateSystem, n = i.getBaseAxis(), a = i.getOtherAxis(n), o = e.getDimensionIndex(e.mapDimension(a.dim)), s = e.getDimensionIndex(e.mapDimension(n.dim)), l = t.get("showBackground", !0), u = e.mapDimension(a.dim), h = e.getCalculationInfo("stackResultDimension"), f = mn(e, u) && !!e.getCalculationInfo("stackedOnSeries"), v = a.isHorizontal(), c = vD(n, a), p = _0(t), g = t.get("barMinHeight") || 0, d = h && e.getDimensionIndex(h), y = e.getLayout("size"), m = e.getLayout("offset");
        return {
          progress: function(_, S) {
            for (var w = _.count, b = p && er(w * 3), x = p && l && er(w * 3), M = p && er(w), D = i.master.getRect(), A = v ? D.width : D.height, T, I = S.getStore(), L = 0; (T = _.next()) != null; ) {
              var P = I.get(f ? d : o, T), R = I.get(s, T), E = c, H = void 0;
              f && (H = +P - I.get(o, T));
              var O = void 0, $ = void 0, G = void 0, K = void 0;
              if (v) {
                var tt = i.dataToPoint([P, R]);
                if (f) {
                  var ut = i.dataToPoint([H, R]);
                  E = ut[0];
                }
                O = E, $ = tt[1] + m, G = tt[0] - E, K = y, Math.abs(G) < g && (G = (G < 0 ? -1 : 1) * g);
              } else {
                var tt = i.dataToPoint([R, P]);
                if (f) {
                  var ut = i.dataToPoint([R, H]);
                  E = ut[1];
                }
                O = tt[0] + m, $ = E, G = y, K = tt[1] - E, Math.abs(K) < g && (K = (K <= 0 ? -1 : 1) * g);
              }
              p ? (b[L] = O, b[L + 1] = $, b[L + 2] = v ? G : K, x && (x[L] = v ? D.x : O, x[L + 1] = v ? $ : D.y, x[L + 2] = A), M[T] = T) : S.setItemLayout(T, {
                x: O,
                y: $,
                width: G,
                height: K
...
var pD = function(r, t, e, i) {
  ...
  function(r) {
    ...
    return t.prototype.getLabel = function(e) {
      ...
      return js(e.value, qv[kx(ln(this._minLevelUnit))] || qv.second, i, this.getSetting("locale"));
      ...
      var a = this.getSetting("useUTC"), o = bD(this._minLevelUnit, this._approxInterval, a, i);
      ...
      var s = Mo.length, l = Math.min(pD(Mo, this._approxInterval, 0, s), s - 1);
      this._interval = Mo[l][1], this._minLevelUnit = Mo[Math.max(l - 1, 0)][0];
    }, t.prototype.parse = function(e) {
      return pt(e) ? e : +or(e);
    }, t.prototype.contain = function(e) {
      return ul(this.parse(e), this._extent);
    }, t.prototype.normalize = function(e) {
      return hl(this.parse(e), this._extent);
    }, t.prototype.scale = function(e) {
      return fl(e, this._extent);
    }, t.type = "time", t;
  }(Dn)
...
function dD(r, t, e, i) {
  var n = or(t), a = or(e), o = function(p) {
    return Zv(n, p, i) === Zv(a, p, i);
  }, s = function() {
    return o("year");
  }, l = function() {
    return s() && o("month");
...
function mD(r) {
  return r /= va, r > 12 ? 12 : r > 6 ? 6 : r > 3.5 ? 4 : r > 2 ? 2 : 1;
}
function id(r, t) {
  return r /= t ? Bf : kf, r > 30 ? 30 : r > 20 ? 20 : r > 15 ? 15 : r > 10 ? 10 : r > 5 ? 5 : r > 2 ? 2 : 1;
}
function _D(r) {
  return iy(r);
}
...
function bD(r, t, e, i) {
  var n = 1e4, a = Uy, o = 0;
  function s(A, T, I, L, P, R, E) {
    for (var H = new Date(T), O = T, $ = H[L](); O < I && O <= i[1]; )
      E.push({
        value: O
      }), $ += A, H[P]($), O = H.getTime();
    E.push({
  ...
  function l(A, T, I) {
    var L = [], P = !T.length;
    if (!dD(ln(A), i[0], i[1], e)) {
      P && (T = [{
        // TODO Optimize. Not include so may ticks.
        value: SD(new Date(i[0]), A, e)
      }, {
        value: i[1]
      }]);
      for (var R = 0; R < T.length - 1; R++) {
        var E = T[R].value, H = T[R + 1].value;
        if (E !== H) {
          var O = void 0, $ = void 0, G = void 0, K = !1;
          switch (A) {
            case "year":
              O = Math.max(1, Math.round(t / ce / 365)), $ = Nf(e), G = Nx(e);
              break;
            case "half-year":
            case "quarter":
            case "month":
            ...
            case "hour":
              ...
              break;
            case "minute":
              O = id(t, !0), $ = tl(e), G = Ky(e);
              break;
            case "second":
              O = id(t, !1), $ = el(e), G = Qy(e);
              break;
            case "millisecond":
              O = _D(t), $ = rl(e), G = jy(e);
              break;
          }
          s(O, E, H, $, G, K, L), A === "year" && I.length > 1 && R === 0 && I.unshift({
            value: I[0].value - O
          });
        }
      }
  ...
  for (var S = Lt(W(u, function(A) {
    return Lt(A, function(T) {
...
Ke.registerClass(S0);
var nd = Ke.prototype, ya = Dn.prototype, wD = Tt, xD = Math.floor, TD = Math.ceil, Do = Math.pow, Se = Math.log, Jf = (
  /** @class */
  function(r) {
    N(t, r);
    function t() {
      var e = r !== null && r.apply(this, arguments) || this;
      return e.type = "log", e.base = 10, e._originalScale = new Dn(), e._interval = 0, e;
    }
    return t.prototype.getTicks = function(e) {
      var i = this._originalScale, n = this._extent, a = i.getExtent(), o = ya.getTicks.call(this, e);
      return W(o, function(s) {
        var l = s.value, u = Tt(Do(this.base, l));
      ...
      var n = Se(this.base);
      e = Se(Math.max(0, e)) / n, i = Se(Math.max(0, i)) / n, ya.setExtent.call(this, e, i);
    }, t.prototype.getExtent = function() {
      var e = this.base, i = nd.getExtent.call(this);
      i[0] = Do(e, i[0]), i[1] = Do(e, i[1]);
      ...
      var i = this.base;
      e[0] = Se(e[0]) / Se(i), e[1] = Se(e[1]) / Se(i), nd.unionExtent.call(this, e);
    }, t.prototype.unionExtentFromData = function(e, i) {
      this.unionExtent(e.getApproximateExtent(i));
      ...
      if (!(n === 1 / 0 || n <= 0)) {
        ...
        for (o <= 0.5 && (a *= 10); !isNaN(a) && Math.abs(a) < 1 && Math.abs(a) > 0; )
          a *= 10;
        var s = [Tt(TD(i[0] / a) * a), Tt(xD(i[1] / a) * a)];
      ...
      return e = Se(e) / Se(this.base), ul(e, this._extent);
    }, t.prototype.normalize = function(e) {
      return e = Se(e) / Se(this.base), hl(e, this._extent);
    }, t.prototype.scale = function(e) {
      return e = fl(e, this._extent), Do(this.base, e);
    }, t.type = "log", t;
  }(Ke)
), b0 = Jf.prototype;
b0.getMinorTicks = ya.getMinorTicks;
b0.getLabel = ya.getLabel;
function Ao(r, t) {
  return wD(r, tr(t));
}
Ke.registerClass(Jf);
var CD = (
  ...
  function() {
    ...
    return r.prototype._prepareParams = function(t, e, i) {
      ...
      q(o) ? this._modelMinNum = Io(t, o({
        min: i[0],
        max: i[1]
      })) : o !== "dataMin" && (this._modelMinNum = Io(t, o));
      var s = this._modelMaxRaw = e.get("max", !0);
      if (q(s) ? this._modelMaxNum = Io(t, s({
        min: i[0],
        max: i[1]
      })) : s !== "dataMax" && (this._modelMaxNum = Io(t, s)), n)
        this._axisDataLen = e.getCategories().length;
      else {
        var l = e.get("boundaryGap"), u = z(l) ? l : [l || 0, l || 0];
        typeof u[0] == "boolean" || typeof u[1] == "boolean" ? this._boundaryGapInner = [0, 0] : this._boundaryGapInner = [Ve(u[0], 1), Ve(u[1], 1)];
      }
...
function AD(r, t, e) {
  ...
  return i || (i = new CD(r, t, e), r.rawExtentInfo = i, i);
}
function Io(r, t) {
  return t == null ? null : is(t) ? NaN : r.parse(t);
}
function w0(r, t) {
  var e = r.type, i = AD(r, t, r.getExtent()).calculate();
...
function ID(r, t, e, i) {
  var n = e.axis.getExtent(), a = Math.abs(n[1] - n[0]), o = hD(i, e.axis);
  if (o === void 0)
    return {
      min: r,
      max: t
...
function ad(r, t) {
  var e = t, i = w0(r, e), n = i.extent, a = e.get("splitNumber");
  r instanceof Jf && (r.base = e.get("logBase"));
...
function An(r) {
  ...
  return r.scale.type === "time" ? /* @__PURE__ */ function(i) {
    ...
    return function(n, a) {
      return e != null && (a = n.value - e), i(tc(r, n), a, n.level != null ? {
        level: n.level
      } : null);
    };
  }(t) : function(i) {
...
function RD(r) {
  ...
  if (!(!t.get(["axisLabel", "show"]) || e.isBlank())) {
    ...
    e instanceof Qf ? n = e.count() : (i = e.getTicks(), n = i.length);
    var o = r.getLabelModel(), s = An(r), l, u = 1;
    n > 40 && (u = Math.ceil(n / 40));
    for (var h = 0; h < n; h += u) {
      var f = i ? i[h] : {
        value: a[0] + h
      }, v = s(f, h), c = o.getTextRect(v), p = ED(c, o.get("rotate") || 0);
      l ? l.union(p) : l = p;
    }
    return l;
  }
...
function x0(r) {
  return r.type === "category" && ec(r.getLabelModel()) === 0;
}
function OD(r, t) {
  var e = {};
...
var kD = (
  ...
  registerProcessor: o0,
  registerPostInit: TM,
  registerPostUpdate: CM,
  registerUpdateLifecycle: Zf,
  registerAction: Mn,
  registerCoordinateSystem: MM,
  registerLayout: DM,
  registerVisual: Ci,
  registerTransform: IM,
  registerLoading: s0,
  registerMap: AM,
  registerImpl: nM,
  PRIORITY: yM,
...
function ND(r) {
  ...
  if (t) {
    var e = An(r), i = r.scale.getExtent(), n = T0(r, t), a = Lt(n, function(o) {
      return o >= i[0] && o <= i[1];
    });
    return {
  ...
  return r.type === "category" ? $D(r) : VD(r);
}
function zD(r, t) {
  var e = r.getTickModel().get("customValues");
  if (e) {
    var i = r.scale.getExtent(), n = T0(r, e);
    return {
      ticks: Lt(n, function(a) {
        return a >= i[0] && a <= i[1];
      })
    };
  }
  return r.type === "category" ? FD(r, t) : {
...
function $D(r) {
  var t = r.getLabelModel(), e = C0(r, t);
...
function C0(r, t) {
  var e = M0(r, "labels"), i = ec(t), n = D0(e, i);
  if (n)
    return n;
  var a, o;
  return q(i) ? a = L0(r, i) : (o = i === "auto" ? HD(r) : i, a = I0(r, o)), A0(e, i, {
    labels: a,
    labelCategoryInterval: o
  });
}
function FD(r, t) {
  var e = M0(r, "ticks"), i = ec(t), n = D0(e, i);
  if (n)
    return n;
  var a, o;
...
function GD(r) {
  var t = WD(r), e = An(r), i = (t.axisRotate - t.labelRotate) / 180 * Math.PI, n = r.scale, a = n.getExtent(), o = n.count();
  if (a[1] - a[0] < 1)
    return 0;
  var s = 1;
  ...
  var _ = Math.max(0, Math.floor(Math.min(y, m))), S = ka(r.model), w = r.getExtent(), b = S.lastAutoInterval, x = S.lastTickCount;
...
function I0(r, t, e) {
  var i = An(r), n = r.scale, a = n.getExtent(), o = r.getLabelModel(), s = [], l = Math.max((t || 0) + 1, 1), u = a[0], h = n.count();
  u !== 0 && l > 1 && h / l > 2 && (u = Math.round(Math.ceil(u / l) * l));
  var f = x0(r), v = o.get("showMinLabel") || f, c = o.get("showMaxLabel") || f;
  v && u !== a[0] && g(a[0]);
...
var sd = [0, 1], UD = (
  ...
  function() {
    ...
    return r.prototype.contain = function(t) {
      ...
      return $S(t || this.scale.getExtent(), this._extent);
    }, r.prototype.setExtent = function(t, e) {
      var i = this._extent;
      i[0] = t, i[1] = e;
    }, r.prototype.dataToCoord = function(t, e) {
      var i = this._extent, n = this.scale;
      return t = n.normalize(t), this.onBand && n.type === "ordinal" && (i = i.slice(), ld(i, n.count())), ar(t, sd, i, e);
      ...
      t = t || {};
      var e = t.tickModel || this.getTickModel(), i = zD(this, e), n = i.ticks, a = W(n, function(s) {
        return {
...
function YD(r, t, e, i) {
  ...
  function v(c, p) {
    return c = Tt(c), p = Tt(p), f ? c > p : c < p;
  }
}
function XD(r) {
  ...
  for (var n = 0; n < r.length; n++) {
    ...
    for (var f = a.obb, v = !1, c = 0; c < t.length; c++) {
      ...
      if (e.intersect(p.rect)) {
        ...
        if (p.obb || (p.obb = new ys(p.localRect, p.transform)), f || (f = new ys(s, l)), f.intersect(p.obb)) {
          v = !0;
          break;
        }
      }
...
var ZD = (
  ...
  function(r) {
    ...
    return t.prototype.getInitialData = function(e) {
      ...
      var i = new xt(), n = lr("line", 0, e.itemHeight / 2, e.itemWidth, 0, e.lineStyle.stroke, !1);
      i.add(n), n.setStyle(e.lineStyle);
      var a = this.getData().getVisual("symbol"), o = this.getData().getVisual("symbolRotate"), s = a === "none" ? "circle" : a, l = e.itemHeight * 0.8, u = lr(s, (e.itemWidth - l) / 2, (e.itemHeight - l) / 2, l, l, e.itemStyle.fill);
...
var ic = (
  ...
  function(r) {
    ...
    return t.prototype._createSymbol = function(e, i, n, a, o) {
      this.removeAll();
      var s = lr(e, -1, -1, 2, 2, null, o);
      s.attr({
        z2: 100,
        culling: !0,
        scaleX: a[0] / 2,
        scaleY: a[1] / 2
      }), s.drift = KD, this._symbolType = e, this.add(s);
      ...
      if (this._updateCommon(e, i, l, n, a), u) {
        ...
        if (!h) {
          ...
          v.scaleX = v.scaleY = 0, v.style.opacity = 0, sr(v, c, s, i);
        }
      }
      ...
      if (a && (u = a.emphasisItemStyle, h = a.blurItemStyle, f = a.selectItemStyle, v = a.focus, c = a.blurScope, g = a.labelStatesModels, d = a.hoverScale, y = a.cursorStyle, p = a.emphasisDisabled), !a || e.hasItemOption) {
        ...
        u = _.getModel("itemStyle").getItemStyle(), f = m.getModel(["select", "itemStyle"]).getItemStyle(), h = m.getModel(["blur", "itemStyle"]).getItemStyle(), v = _.get("focus"), c = _.get("blurScope"), p = _.get("disabled"), g = pn(m), d = _.getShallow("scale"), y = m.getShallow("cursor");
      }
      var S = e.getItemVisual(i, "symbolRotate");
      s.attr("rotation", (S || 0) * Math.PI / 180 || 0);
      var w = zm(e.getItemVisual(i, "symbolOffset"), n);
      ...
      L.scaleX = this._sizeX * P, L.scaleY = this._sizeY * P, this.setSymbolScale(1), Da(this, v, c, p);
      ...
      return VC(e.getItemVisual(i, "symbolSize"));
    }, t;
  }(xt)
);
function KD(r, t) {
...
var QD = (
  ...
  function() {
    function r(t) {
      this.group = new xt(), this._SymbolCtor = t || ic;
    }
    return r.prototype.updateData = function(t, e) {
      this._progressiveEls = null, e = ud(e);
      var i = this.group, n = t.hostModel, a = this._data, o = this._SymbolCtor, s = e.disableAnimation, l = hd(t), u = {
        disableAnimation: s
      ...
      this._seriesScope = hd(t), this._data = null, this.group.removeAll();
    }, r.prototype.incrementalUpdate = function(t, e, i) {
      this._progressiveEls = [], i = ud(i);
      function n(l) {
      ...
      Ua(this._progressiveEls || this.group, t);
    }, r.prototype.remove = function(t) {
...
function R0(r, t, e) {
  var i = r.getBaseAxis(), n = r.getOtherAxis(i), a = jD(n, e), o = i.dim, s = n.dim, l = t.mapDimension(s), u = t.mapDimension(o), h = s === "x" || s === "radius" ? 1 : 0, f = W(r.dimensions, function(p) {
...
function jD(r, t) {
  ...
  return t === "start" ? e = i[0] : t === "end" ? e = i[1] : pt(t) && !isNaN(t) ? e = t : i[0] > 0 ? e = i[0] : i[1] < 0 && (e = i[1]), e;
}
function E0(r, t, e, i) {
  var n = NaN;
...
function tA(r, t, e, i, n, a, o, s) {
  for (var l = JD(r, t), u = [], h = [], f = [], v = [], c = [], p = [], g = [], d = R0(n, t, o), y = r.getLayout("points") || [], m = t.getLayout("points") || [], _ = 0; _ < l.length; _++) {
    var S = l[_], w = !0, b = void 0, x = void 0;
    switch (S.cmd) {
      case "=":
        b = S.idx * 2, x = S.idx1 * 2;
        var M = y[b], D = y[b + 1], A = m[x], T = m[x + 1];
        (isNaN(M) || isNaN(D)) && (M = A, D = T), u.push(M, D), h.push(A, T), f.push(e[b], e[b + 1]), v.push(i[x], i[x + 1]), g.push(t.getRawIndex(S.idx1));
        break;
      case "+":
        var I = S.idx, L = d.dataDimsForPoint, P = n.dataToPoint([t.get(L[0], I), t.get(L[1], I)]);
  ...
  p.sort(function(St, me) {
    return g[St] - g[me];
  });
  for (var E = u.length, H = er(E), O = er(E), $ = er(E), G = er(E), K = [], _ = 0; _ < p.length; _++) {
    var tt = p[_], ut = _ * 2, dt = tt * 2;
    H[ut] = u[dt], H[ut + 1] = u[dt + 1], O[ut] = h[dt], O[ut + 1] = h[dt + 1], $[ut] = f[dt], $[ut + 1] = f[dt + 1], G[ut] = v[dt], G[ut + 1] = v[dt + 1], K[_] = c[tt];
  }
  return {
    current: H,
    next: O,
...
var br = Math.min, wr = Math.max;
function mi(r, t) {
  return isNaN(r) || isNaN(t);
}
function Eh(r, t, e, i, n, a, o, s, l) {
  for (var u, h, f, v, c, p, g = e, d = 0; d < i; d++) {
    ...
    if (g === e)
      ...
      if (o > 0) {
        for (var w = g + a, b = t[w * 2], x = t[w * 2 + 1]; b === y && x === m && d < i; )
          d++, w += a, g += a, b = t[w * 2], x = t[w * 2 + 1], y = t[g * 2], m = t[g * 2 + 1], _ = y - u, S = m - h;
        var M = d + 1;
        if (l)
          for (; mi(b, x) && M < i; )
        ...
        if (M >= i || mi(b, x))
          ...
          A = b - u, T = x - h;
          var P = y - u, R = b - y, E = m - h, H = x - m, O = void 0, $ = void 0;
          if (s === "x") {
            O = Math.abs(P), $ = Math.abs(R);
            var G = A > 0 ? 1 : -1;
            c = y - G * O * o, p = m, I = y + G * $ * o, L = m;
          } else if (s === "y") {
            O = Math.abs(E), $ = Math.abs(H);
            var K = T > 0 ? 1 : -1;
            c = y, p = m - K * O * o, I = y, L = m + K * $ * o;
          } else
            O = Math.sqrt(P * P + E * E), $ = Math.sqrt(R * R + H * H), D = $ / ($ + O), c = y - A * o * (1 - D), p = m - T * o * (1 - D), I = y + A * o * D, L = m + T * o * D, I = br(I, wr(b, y)), L = br(L, wr(x, m)), I = wr(I, br(b, y)), L = wr(L, br(x, m)), A = I - y, T = L - m, c = y - A * O / $, p = m - T * O / $, c = br(c, wr(u, y)), p = br(p, wr(h, m)), c = wr(c, br(u, y)), p = wr(p, br(h, m)), A = y - c, T = m - p, I = y + A * $ / O, L = m + T * $ / O;
        }
...
var O0 = (
  ...
  function(r) {
    ...
    return t.prototype.getDefaultStyle = function() {
      ...
      for (; a < o; )
        a += Eh(e, n, a, o, o, 1, i.smooth, i.smoothMonotone, i.connectNulls) + 1;
    }, t.prototype.getPointOn = function(e, i) {
      this.path || (this.createPathProxy(), this.buildPath(this.path, this.shape));
      for (var n = this.path, a = n.data, o = xi.CMD, s, l, u = i === "x", h = [], f = 0; f < a.length; ) {
        ...
        switch (v) {
          ...
          case o.C:
            ...
            var w = u ? os(s, c, g, y, e, h) : os(l, p, d, m, e, h);
            if (w > 0)
              for (var b = 0; b < w; b++) {
                var x = h[b];
                if (x <= 1 && x >= 0) {
                  var S = u ? Pt(l, p, d, m, x) : Pt(s, c, g, y, x);
                  return u ? [e, S] : [S, e];
                }
              }
            s = y, l = m;
  ...
  function(r) {
    ...
    return t.prototype.getDefaultShape = function() {
      ...
      for (; o < s; ) {
        var u = Eh(e, n, o, s, s, 1, i.smooth, l, i.connectNulls);
        Eh(e, a, o + u - 1, u, s, -1, i.stackedOnSmooth, l, i.connectNulls), o += u + 1, e.closePath();
      }
    }, t;
  }(lt)
);
...
function B0(r, t, e) {
  var i = r.getArea(), n = Tt(i.r0, 1), a = Tt(i.r, 1), o = new Tn({
    shape: {
      cx: Tt(r.cx, 1),
      cy: Tt(r.cy, 1),
      r0: n,
  ...
  if (t) {
    ...
    s ? o.shape.endAngle = i.startAngle : o.shape.r = n, sr(o, {
      shape: {
        endAngle: i.endAngle,
        r: a
      }
...
function vd(r, t) {
  var e = cd(r), i = e[0], n = e[1], a = cd(t), o = a[0], s = a[1];
...
function aA(r, t, e) {
  if (!e.valueDim)
    return [];
  for (var i = t.count(), n = er(i * 2), a = 0; a < i; a++) {
    var o = E0(e, r, t, a);
...
function oA(r, t) {
  ...
  function o(h, f, v) {
    var c = h.coord, p = (v - c) / (f.coord - c), g = lS(p, [h.color, f.color]);
    return {
      coord: v,
      color: g
    };
...
function sA(r, t, e) {
  ...
  if (!(!i || !i.length || !r.count()) && t.type === "cartesian2d") {
    ...
    if (a) {
      ...
      var v = oA(u, n === "x" ? e.getWidth() : e.getHeight()), c = v.length;
      if (!c && h)
...
function fA(r) {
  for (var t = r.length / 2; t > 0 && hA(r[t * 2 - 2], r[t * 2 - 1]); t--)
    ;
  return t - 1;
}
function dd(r, t) {
...
function Mu(r, t, e, i) {
  if (cl(t, "cartesian2d")) {
    ...
    } : null, u = t.getBaseAxis().isHorizontal(), h = k0(t, e, i, function() {
      var c = r._endLabel;
...
var pA = (
  ...
  function(r) {
    ...
    return t.prototype.init = function() {
      ...
      var a = e.coordinateSystem, o = this.group, s = e.getData(), l = e.getModel("lineStyle"), u = e.getModel("areaStyle"), h = s.getLayout("points") || [], f = a.type === "polar", v = this._coordSys, c = this._symbolDraw, p = this._polyline, g = this._polygon, d = this._lineGroup, y = !i.ssr && e.get("animation"), m = !u.isEmpty(), _ = u.get("origin"), S = R0(a, s, _), w = m && aA(a, s, S), b = e.get("showSymbol"), x = e.get("connectNulls"), M = b && !f && lA(e, s, a), D = this._data;
      D && D.eachItemGraphicEl(function(St, me) {
        St.__temp && (o.remove(St), D.setItemGraphicEl(me, null));
      }), b || c.remove(), o.add(d);
      ...
      var I = sA(s, a, n) || s.getVisual("style")[s.getVisual("drawType")];
      if (!(p && v.type === a.type && A === this._step))
        ...
        }), y && this._initSymbolLabelAnimation(s, a, T), A && (w && (w = xr(w, h, a, A, x)), h = xr(h, null, a, A, x)), p = this._newPolyline(h), m ? g = this._newPolygon(h, w) : g && (d.remove(g), g = this._polygon = null), f || this._initOrUpdateEndLabel(e, a, Ti(I)), d.setClipPath(Mu(this, a, !0, e));
      else {
        m && !g ? g = this._newPolygon(h, w) : g && !m && (d.remove(g), g = this._polygon = null), f || this._initOrUpdateEndLabel(e, a, Ti(I));
        var L = d.getClipPath();
        if (L) {
          var P = Mu(this, a, !1, e);
          sr(L, {
        ...
        }), (!fd(this._stackedOnPoints, w) || !fd(this._points, h)) && (y ? this._doUpdateAnimation(s, w, a, n, A, _, x) : (A && (w && (w = xr(w, h, a, A, x)), h = xr(h, null, a, A, x)), p.setShape({
          points: h
        }), g && g.setShape({
          points: h,
          stackedOnPoints: w
      ...
      var R = e.getModel("emphasis"), E = R.get("focus"), H = R.get("blurScope"), O = R.get("disabled");
      if (p.useStyle(ot(
      ...
      )), hh(p, e, "lineStyle"), p.style.lineWidth > 0 && e.get(["emphasis", "lineStyle", "width"]) === "bolder") {
        var $ = p.getState("emphasis").style;
        $.lineWidth = +p.style.lineWidth + 1;
      }
      it(p).seriesIndex = e.seriesIndex, Da(p, E, H, O);
      var G = pd(e.get("smooth")), K = e.get("smoothMonotone");
      if (p.setShape({
        smooth: G,
        smoothMonotone: K,
        connectNulls: x
      }), g) {
        var tt = s.getCalculationInfo("stackedOnSeries"), ut = 0;
        g.useStyle(ot(u.getAreaStyle(), {
          fill: I,
          opacity: 0.7,
          lineJoin: "bevel",
          decal: s.getVisual("style").decal
        })), tt && (ut = pd(tt.get("smooth"))), g.setShape({
          smooth: G,
          stackedOnSmooth: ut,
          smoothMonotone: K,
          connectNulls: x
        }), hh(g, e, "areaStyle"), it(g).seriesIndex = e.seriesIndex, Da(g, E, H, O);
      }
      var dt = this._changePolyState;
      s.eachItemGraphicEl(function(St) {
        St && (St.onHoverStateChange = dt);
      }), this._polyline.onHoverStateChange = dt, this._data = s, this._coordSys = a, this._stackedOnPoints = w, this._points = h, this._step = A, this._valueOrigin = _, e.get("triggerLineEvent") && (this.packEventData(e, p), g && this.packEventData(e, g));
      ...
      if (this._changePolyState("emphasis"), !(s instanceof Array) && s != null && s >= 0) {
        ...
        if (!u) {
          ...
          u = new ic(o, s), u.x = h, u.y = f, u.setZ(v, c);
        ...
        ge.prototype.highlight.call(this, e, i, n, a);
      ...
      if (this._changePolyState("normal"), s != null && s >= 0) {
        ...
        ge.prototype.downplay.call(this, e, i, n, a);
    }, t.prototype._changePolyState = function(e) {
      var i = this._polygon;
      Mv(this._polyline, e), i && Mv(i, e);
    }, t.prototype._newPolyline = function(e) {
      var i = this._polyline;
      return i && this._lineGroup.remove(i), i = new eA({
        shape: {
          points: e
        },
      ...
      if (N0(e)) {
        ...
        u || (u = this._endLabel = new Mt({
          z2: 200
          // should be higher than item symbol
        }), u.ignoreClip = !0, s.setTextContent(this._endLabel), s.disableLabelAnimation = !0);
        var h = fA(l);
        h >= 0 && (Ya(s, pn(e, "endLabel"), {
          inheritColor: n,
          labelFetcher: e,
          labelDataIndex: h,
          defaultText: function(f, v, c) {
            return c != null ? P0(o, c) : rc(o, f);
          },
          enableTextSetter: !0
        }, vA(a, i)), s.textConfig.position = null);
      ...
      if (u) {
        ...
        var f = n.getLayout("points"), v = n.hostModel, c = v.get("connectNulls"), p = s.get("precision"), g = s.get("distance") || 0, d = l.getBaseAxis(), y = d.isHorizontal(), m = d.inverse, _ = i.shape, S = m ? y ? _.x : _.y + _.height : y ? _.x + _.width : _.y, w = (y ? g : 0) * (m ? -1 : 1), b = (y ? 0 : -g) * (m ? -1 : 1), x = y ? "x" : "y", M = cA(f, S, x), D = M.range, A = D[1] - D[0], T = void 0;
        if (A >= 1) {
          if (A > 1 && !c) {
            var I = dd(f, D[0]);
            u.attr({
          ...
          var R = e === 1 || a.lastFrameIndex > 0 ? D[0] : 0, I = dd(f, R);
      ...
      var u = this._polyline, h = this._polygon, f = e.hostModel, v = tA(this._data, e, this._stackedOnPoints, i, this._coordSys, n, this._valueOrigin), c = v.current, p = v.stackedOnCurrent, g = v.next, d = v.stackedOnNext;
      if (o && (p = xr(v.stackedOnCurrent, v.current, n, o, l), c = xr(v.current, null, n, o, l), d = xr(v.stackedOnNext, v.next, n, o, l), g = xr(v.next, null, n, o, l)), vd(c, g) > 3e3 || h && vd(p, d) > 3e3) {
      ...
      v.current !== c && (y.shape.__points = v.next), u.stopAnimation(), re(u, y, f), h && (h.setShape({
        // Reuse the points with polyline.
        points: c,
        stackedOnPoints: p
      }), h.stopAnimation(), re(h, {
        shape: {
          stackedOnPoints: d
        }
      ...
      if (e.pipelineContext, !!n) {
        ...
        return o && {
          progress: function(f, v) {
            for (var c = f.end - f.start, p = er(c * o), g = [], d = [], y = f.start, m = 0; y < f.end; y++) {
              var _ = void 0;
              if (o === 1) {
                var S = l.get(u, y);
                _ = n.dataToPoint(S, null, d);
              } else
    ...
    reset: function(t, e, i) {
      ...
      if (s > 10 && o.type === "cartesian2d" && a) {
        ...
        if (isFinite(c) && c > 1) {
          ...
          var p = void 0;
          F(a) ? p = gA[a] : q(a) && (p = a), p && t.setData(n.downSample(n.mapDimension(u.dim), 1 / c, p, yA));
        }
      }
    }
  };
...
function mA(r) {
  r.registerChartView(pA), r.registerSeriesModel(ZD), r.registerLayout(dA("line")), r.registerVisual({
    seriesType: "line",
    reset: function(t) {
  ...
  }), r.registerProcessor(r.PRIORITY.PROCESSOR.STATISTIC, z0("line"));
}
var Oh = (
  /** @class */
  function(r) {
...
var _A = (
  ...
  function(r) {
    ...
    }, t.type = "series.bar", t.dependencies = ["grid", "polar"], t.defaultOption = Qs(Oh.defaultOption, {
      // If clipped
...
function bA(r, t) {
  ...
  return function(i, n, a) {
    ...
    if (!o || o instanceof Array)
      return fs(i, n, a);
    var s = r(o), l = n.distance != null ? n.distance : 5, u = this.shape, h = u.cx, f = u.cy, v = u.r, c = u.r0, p = (v + c) / 2, g = u.startAngle, d = u.endAngle, y = (g + d) / 2, m = e ? Math.abs(v - c) / 2 : 0, _ = Math.cos, S = Math.sin, w = h + v * _(g), b = f + v * S(g), x = "left", M = "top";
    switch (s) {
      case "startArc":
        w = h + (c - l) * _(y), b = f + (c - l) * S(y), x = "center", M = "top";
        break;
      case "insideStartArc":
        w = h + (c + l) * _(y), b = f + (c + l) * S(y), x = "center", M = "bottom";
        break;
      case "startAngle":
        w = h + p * _(g) + Lo(g, l + m, !1), b = f + p * S(g) + Po(g, l + m, !1), x = "right", M = "middle";
        break;
      case "insideStartAngle":
        w = h + p * _(g) + Lo(g, -l + m, !1), b = f + p * S(g) + Po(g, -l + m, !1), x = "left", M = "middle";
        break;
      case "middle":
        w = h + p * _(y), b = f + p * S(y), x = "center", M = "middle";
        break;
      case "endArc":
        w = h + (v + l) * _(y), b = f + (v + l) * S(y), x = "center", M = "bottom";
        break;
      case "insideEndArc":
        w = h + (v - l) * _(y), b = f + (v - l) * S(y), x = "center", M = "top";
        break;
      case "endAngle":
        w = h + p * _(d) + Lo(d, l + m, !0), b = f + p * S(d) + Po(d, l + m, !0), x = "left", M = "middle";
        break;
      case "insideEndAngle":
        w = h + p * _(d) + Lo(d, -l + m, !0), b = f + p * S(d) + Po(d, -l + m, !0), x = "right", M = "middle";
        break;
      default:
        return fs(i, n, a);
    }
    return i = i || {}, i.x = w, i.y = b, i.align = x, i.verticalAlign = M, i;
  };
}
function wA(r, t, e, i) {
  if (pt(i)) {
...
var CA = (
  ...
  function(r) {
    ...
    return t.prototype.render = function(e, i, n, a) {
      ...
      Ua(this._progressiveEls || this.group, e);
      ...
      var v = e.isAnimationEnabled() ? e : null, c = MA(e, u);
      c && this._enableRealtimeSort(c, s, n);
      var p = e.get("clip", !0) || c, g = TA(u, s);
      o.removeClipPath();
      var d = e.get("roundCap", !0), y = e.get("showBackground", !0), m = e.getModel("backgroundStyle"), _ = m.get("borderRadius") || 0, S = [], w = this._backgroundEls, b = a && a.isInitSort, x = a && a.type === "changeAxisOrder";
      function M(T) {
        var I = Ro[u.type](s, T), L = EA(u, f, I);
      ...
      s.diff(l).add(function(T) {
        var I = s.getItemModel(T), L = Ro[u.type](s, T, I);
        if (y && M(T), !(!s.hasValue(T) || !bd[u.type](L))) {
          var P = !1;
          p && (P = yd[u.type](g, L));
          var R = md[u.type](e, s, T, L, f, v, h.model, !1, d);
          c && (R.forceLabelAnimation = !0), wd(R, s, T, I, L, e, f, u.type === "polar"), b ? R.attr({
            shape: L
          }) : c ? _d(c, v, R, L, T, f, !1, !1) : sr(R, {
            shape: L
          }, e, T), s.setItemGraphicEl(T, R), o.add(R), R.ignore = P;
        }
      }).update(function(T, I) {
        var L = s.getItemModel(T), P = Ro[u.type](s, T, L);
        if (y) {
          var R = void 0;
          w.length === 0 ? R = M(I) : (R = w[I], R.useStyle(m.getItemStyle()), u.type === "cartesian2d" ? R.setShape("r", _) : R.setShape("cornerRadius", _), S[T] = R);
          var E = Ro[u.type](s, T), H = F0(f, E, u);
          re(R, {
            shape: H
          }, v, T);
        }
        var O = l.getItemGraphicEl(I);
        if (!s.hasValue(T) || !bd[u.type](P)) {
          o.remove(O);
          return;
        }
        var $ = !1;
        if (p && ($ = yd[u.type](g, P), $ && o.remove(O)), O ? Oy(O) : O = md[u.type](e, s, T, P, f, v, h.model, !!O, d), c && (O.forceLabelAnimation = !0), x) {
          ...
          wd(O, s, T, L, P, e, f, u.type === "polar");
        b ? O.attr({
          shape: P
        }) : c ? _d(c, v, O, P, T, f, !0, x) : re(O, {
          shape: P
        }, e, T, null), s.setItemGraphicEl(T, O), O.ignore = $, o.add(O);
      }).remove(function(T) {
        var I = l.getItemGraphicEl(T);
        I && ph(I, e, T);
      }).execute();
      var D = this._backgroundGroup || (this._backgroundGroup = new xt());
      D.removeAll();
      for (var A = 0; A < S.length; ++A)
        D.add(S[A]);
      o.add(D), this._backgroundEls = S, this._data = s;
    }, t.prototype._renderLarge = function(e, i, n) {
      this._clear(), Td(e, this.group), this._updateLargeClip(e);
    }, t.prototype._incrementalRenderLarge = function(e, i) {
      this._removeBackground(), Td(i, this.group, this._progressiveEls, !0);
    }, t.prototype._updateLargeClip = function(e) {
      var i = e.get("clip", !0) && nA(e.coordinateSystem, !1, e), n = this.group;
  ...
  cartesian2d: function(r, t) {
    ...
    var n = r.x + r.width, a = r.y + r.height, o = Du(t.x, r.x), s = Au(t.x + t.width, n), l = Du(t.y, r.y), u = Au(t.y + t.height, a), h = s < o, f = u < l;
  ...
  polar: function(r, t) {
    ...
    var n = Au(t.r, r.r), a = Du(t.r0, r.r0);
    t.r = n, t.r0 = a;
    var o = n - a < 0;
    if (e < 0) {
      var i = t.r;
  ...
  polar: function(r, t, e, i, n, a, o, s, l) {
    var u = !n && l ? gd : Tn, h = new u({
      shape: i,
      z2: 1
    });
    h.name = "item";
    var f = $0(n);
    if (h.calculateTextPosition = bA(f, {
      isRoundCap: u === gd
    }), a) {
      var v = h.shape, c = n ? "r" : "endAngle", p = {};
      v[c] = n ? i.r0 : i.startAngle, p[c] = i[c], (s ? re : sr)(h, {
        shape: p
...
var DA = ["x", "y", "width", "height"], AA = ["cx", "cy", "r", "startAngle", "endAngle"], bd = {
  ...
  cartesian2d: function(r, t, e) {
    var i = r.getItemLayout(t), n = e ? LA(e, i) : 0, a = i.width > 0 ? 1 : -1, o = i.height > 0 ? 1 : -1;
    return {
      x: i.x + a * n / 2,
      y: i.y + o * n / 2,
      width: i.width - a * n,
...
function wd(r, t, e, i, n, a, o, s) {
  var l = t.getItemVisual(e, "style");
  if (s) {
    if (!a.get("roundCap")) {
      var h = r.shape, f = xA(i.getModel("itemStyle"), h);
      B(h, f), r.setShape(h);
    }
  } else {
  ...
  v && r.attr("cursor", v);
  var c = s ? o ? n.r >= n.r0 ? "endArc" : "startArc" : n.endAngle >= n.startAngle ? "endAngle" : "startAngle" : o ? n.height >= 0 ? "bottom" : "top" : n.width >= 0 ? "right" : "left", p = pn(i);
  Ya(r, p, {
    labelFetcher: a,
    labelDataIndex: e,
    defaultText: rc(a.getData(), e),
    inheritColor: l.fill,
  ...
  if (s && g) {
    ...
    r.textConfig.inside = d === "middle" ? !0 : null, wA(r, d === "outside" ? c : d, $0(o), i.get(["label", "rotate"]));
  }
  mx(g, p, a.getRawValue(e), function(m) {
    return P0(t, m);
  });
  var y = i.getModel(["emphasis"]);
  Da(r, y.get("focus"), y.get("blurScope"), y.get("disabled")), hh(r, i), IA(n) && (r.style.fill = "none", r.style.stroke = "none", C(r.states, function(m) {
...
function Td(r, t, e, i) {
  ...
  f.baseDimIdx = a, f.largeDataIndices = o, f.barWidth = s, t.add(f), f.useStyle(n.getVisual("style")), f.style.stroke = null, it(f).seriesIndex = r.seriesIndex, r.get("silent") || (f.on("mousedown", Cd), f.on("mousemove", Cd)), e && e.push(f);
}
var Cd = Uf(function(r) {
  var t = this, e = RA(t, r.offsetX, r.offsetY);
...
function OA(r) {
  r.registerChartView(CA), r.registerSeriesModel(_A), r.registerLayout(r.PRIORITY.VISUAL.LAYOUT, Ct(fD, "bar")), r.registerLayout(r.PRIORITY.VISUAL.PROGRESSIVE_LAYOUT, cD("bar")), r.registerProcessor(r.PRIORITY.PROCESSOR.STATISTIC, z0("bar")), r.registerAction({
    type: "changeAxisOrder",
...
function Md(r, t, e, i) {
    ...
    var o = rt(rt({}, $A[a], !0), i, !0), s = (
      ...
      function(l) {
        ...
        return u.prototype.mergeDefaultAndTheme = function(h, f) {
          var v = La(this), c = v ? il(h) : {}, p = f.getTheme();
          rt(h, p.get(a + "Axis")), rt(h, this.getDefaultOption()), h.type = Dd(h), v && gn(h, c, v);
        }, u.prototype.optionUpdated = function() {
          var h = this.option;
          h.type === "category" && (this.__ordinalMeta = Ph.createByAxisModel(this));
  ...
  }), r.registerSubTypeDefaulter(t + "Axis", Dd);
}
function Dd(r) {
...
var VA = (
  ...
  function() {
    ...
    return r.prototype.getAxis = function(t) {
      ...
      return t = t.toLowerCase(), Lt(this.getAxes(), function(e) {
  ...
  function(r) {
    ...
    return t.prototype.calcAffineTransform = function() {
      ...
      if (this._invTransform)
        return pe(n, e, this._invTransform);
...
function Nh(r, t, e) {
  ...
  a.labelDirection = a.tickDirection = a.nameDirection = d[s], a.labelOffset = o ? p[v[s]] - p[v.onZero] : 0, t.get(["axisTick", "inside"]) && (a.tickDirection = -a.tickDirection), vn(e.labelInside, t.get(["axisLabel", "inside"])) && (a.labelDirection = -a.labelDirection);
...
function Ld(r) {
  ...
  return C(t, function(e, i) {
    var n = i.replace(/Model$/, ""), a = r.getReferringComponents(n, Te).models[0];
    t[i] = a;
  }), t;
}
var Iu = Math.log;
function WA(r, t, e) {
  var i = Dn.prototype, n = i.getTicks.call(e), a = i.getTicks.call(e, !0), o = n.length - 1, s = i.getInterval.call(e), l = w0(r, t), u = l.extent, h = l.fixMin, f = l.fixMax;
  if (r.type === "log") {
    var v = Iu(r.base);
    u = [Iu(u[0]) / v, Iu(u[1]) / v];
  }
  ...
  if (h && f)
    ...
    y > o && (p = Tu(p));
    var m = p * o;
    d = Math.ceil(u[1] / p) * p, g = Tt(d - m), g < 0 && u[0] >= 0 ? (g = 0, d = Tt(m)) : d > 0 && u[1] <= 0 && (d = 0, g = -Tt(m));
  }
  var _ = (n[0].value - a[0].value) / s, S = (n[o].value - a[o].value) / s;
  i.setExtent.call(r, g + p * _, d + p * S), i.setInterval.call(r, p), (_ || S) && i.setNiceExtent.call(r, g + p, d - p);
}
var UA = (
  /** @class */
  function() {
    function r(t, e, i) {
      this.type = "grid", this._coordsMap = {}, this._coordsList = [], this._axesMap = {}, this._axesList = [], this.axisPointerEnabled = !0, this.dimensions = Bh, this._initCartesian(t, e, i), this.model = t;
    }
    return r.prototype.getRect = function() {
      ...
      function n(o) {
        ...
        if (u) {
          for (var h = [], f = u - 1; f >= 0; f--) {
            ...
            Rh(g) && p.get("alignTicks") && p.get("interval") == null ? h.push(c) : (ad(g, p), Rh(g) && (s = c));
          }
          h.length && (s || (s = h.pop(), ad(s.scale, s.model)), C(h, function(d) {
            WA(d.scale, d.model, s.scale);
          }));
        }
      }
      n(i.x), n(i.y);
      ...
      function l() {
        C(s, function(u) {
          ...
          u.setExtent(f[v], f[1 - v]), YA(u, h ? o.x : o.y);
        });
      }
      ...
      var e = t.seriesModel, i = t.xAxisModel || e && e.getReferringComponents("xAxis", Te).models[0], n = t.yAxisModel || e && e.getReferringComponents("yAxis", Te).models[0], a = t.gridModel, o = this._coordsList, s, l;
      if (e)
      ...
      function u(h) {
        return function(f, v) {
          if (Lu(f, t)) {
            ...
            var p = new GA(h, LD(f), [0, 0], f.get("type"), c), g = p.type === "category";
      ...
      C(this._axesList, function(n) {
        ...
        if (Id(n)) {
          var a = Ld(n), o = a.xAxisModel, s = a.yAxisModel;
          if (!Lu(o, e) || !Lu(s, e))
            return;
      ...
      return t.eachComponent("grid", function(n, a) {
        ...
        if (Id(n)) {
          var a = Ld(n), o = a.xAxisModel, s = a.yAxisModel, l = o.getCoordSysModel(), u = l.coordinateSystem;
...
function Pd(r, t, e, i) {
  ...
  if (l != null)
    ...
    for (var u in n)
      if (n.hasOwnProperty(u) && Rd(n[u]) && !i[h(n[u])]) {
        a = n[u];
        break;
      }
  a && (i[h(a)] = !0);
...
function Rd(r) {
  return r && r.type !== "category" && r.type !== "time" && PD(r);
}
function YA(r, t) {
...
var Ir = Math.PI, Rr = (
  ...
  function() {
    function r(t, e) {
      this.group = new xt(), this.opt = e, this.axisModel = t, ot(e, {
        labelOffset: 0,
        nameDirection: 1,
        tickDirection: 1,
        labelDirection: 1,
    ...
    return r.prototype.hasBuilder = function(t) {
      ...
      var n = ry(e - t), a, o;
      return cs(n) ? (o = i > 0 ? "top" : "bottom", a = "center") : cs(n - Ir) ? (o = i > 0 ? "bottom" : "top", a = "center") : (o = "middle", n > 0 && n < Ir ? a = i > 0 ? "right" : "left" : a = i > 0 ? "left" : "right"), {
        rotation: n,
        textAlign: a,
        textVerticalAlign: o
      };
  ...
  axisLine: function(r, t, e, i) {
    ...
    if (n === "auto" && r.handleAutoShown && (n = r.handleAutoShown("axisLine")), !!n) {
      ...
      var h = B({
        lineCap: "round"
      }, t.getModel(["axisLine", "lineStyle"]).getLineStyle()), f = new Or({
        shape: {
          x1: s[0],
          y1: s[1],
          x2: l[0],
      ...
      Aa(f.shape, f.style.lineWidth), f.anid = "line", e.add(f);
      var v = t.get(["axisLine", "symbol"]);
      if (v != null) {
        var c = t.get(["axisLine", "symbolSize"]);
        F(v) && (v = [v, v]), (F(c) || pt(c)) && (c = [c, c]);
        var p = zm(t.get(["axisLine", "symbolOffset"]) || 0, c), g = c[0], d = c[1];
        C([{
          ...
          if (v[m] !== "none" && v[m] != null) {
            var _ = lr(v[m], -g / 2, -d / 2, g, d, h.stroke, !0), S = y.r + y.offset, w = u ? l : s;
            _.attr({
              rotation: y.rotate,
  ...
  axisTickLabel: function(r, t, e, i) {
    var n = ZA(e, i, t, r), a = QA(e, i, t, r);
    if (qA(t, a, n), KA(e, i, t, r.tickDirection), t.get(["axisLabel", "hideOverlap"])) {
      var o = XD(W(a, function(s) {
        return {
          label: s,
          priority: s.z2,
          defaultAttr: {
  ...
  axisName: function(r, t, e, i) {
    var n = vn(r.axisName, t.get("name"));
    if (n) {
      var a = t.get("nameLocation"), o = r.nameDirection, s = t.getModel("nameTextStyle"), l = t.get("nameGap") || 0, u = t.axis.getExtent(), h = u[0] > u[1] ? -1 : 1, f = [
        ...
        // Reuse labelOffset.
        kd(a) ? r.labelOffset + o * l : 0
      ], v, c = t.get("nameRotate");
      c != null && (c = c * Ir / 180);
      var p;
      kd(a) ? v = Rr.innerTextLayout(
        r.rotation,
        c ?? r.rotation,
        // Adapt to axis.
        o
      ) : (v = XA(r.rotation, a, c || 0, u), p = r.axisNameAvailableWidth, p != null && (p = Math.abs(p / Math.sin(v.rotation)), !isFinite(p) && (p = null)));
      var g = s.getFont(), d = t.get("nameTruncate", !0) || {}, y = d.ellipsis, m = vn(r.nameTruncateMaxWidth, d.maxWidth, p), _ = new Mt({
        x: f[0],
        y: f[1],
        rotation: v.rotation,
        silent: Rr.isLabelSilent(t),
        style: $e(s, {
          text: n,
          font: g,
          overflow: "truncate",
      ...
      if (Xs({
        ...
        var S = Rr.makeAxisEventDataBase(t);
...
function XA(r, t, e, i) {
  ...
  return cs(n - Ir / 2) ? (o = l ? "bottom" : "top", a = "center") : cs(n - Ir * 1.5) ? (o = l ? "top" : "bottom", a = "center") : (o = "middle", n < Ir * 1.5 && n > Ir / 2 ? a = l ? "left" : "right" : a = l ? "right" : "left"), {
    rotation: n,
    textAlign: a,
    textVerticalAlign: o
  };
...
function qA(r, t, e) {
  if (!x0(r.axis)) {
    ...
    i === !1 ? (ne(a), ne(u)) : Od(a, o) && (i ? (ne(o), ne(h)) : (ne(a), ne(u))), n === !1 ? (ne(s), ne(f)) : Od(l, s) && (n ? (ne(l), ne(v)) : (ne(s), ne(f)));
  }
}
function ne(r) {
  r && (r.ignore = !0);
...
function Od(r, t) {
  ...
  if (!(!e || !i)) {
    var n = uf([]);
    return hf(n, n, -r.rotation), e.applyTransform(nn([], n, r.getLocalTransform())), i.applyTransform(nn([], n, t.getLocalTransform())), e.intersect(i);
  }
}
function kd(r) {
...
function H0(r, t, e, i, n) {
  for (var a = [], o = [], s = [], l = 0; l < r.length; l++) {
    var u = r[l].coord;
    o[0] = u, o[1] = 0, s[0] = u, s[1] = e, t && (pe(o, o, t), pe(s, s, t));
    var h = new Or({
      shape: {
        x1: o[0],
        y1: o[1],
    ...
    Aa(h.shape, h.style.lineWidth), h.anid = n + "_" + r[l].tickValue, a.push(h);
  }
  return a;
}
function ZA(r, t, e, i) {
  ...
  if (o === "auto" && i.handleAutoShown && (o = i.handleAutoShown("axisTick")), !(!o || n.scale.isBlank())) {
    for (var s = a.getModel("lineStyle"), l = i.tickDirection * a.get("length"), u = n.getTicksCoords(), h = H0(u, t.transform, l, ot(s.getLineStyle(), {
  ...
  if (!(!a.get("show") || n.scale.isBlank())) {
    ...
    if (o.length)
      for (var s = a.getModel("lineStyle"), l = i * a.get("length"), u = ot(s.getLineStyle(), ot(e.getModel("axisTick").getLineStyle(), {
        ...
        for (var f = H0(o[h], t.transform, l, u, "minorticks_" + h), v = 0; v < f.length; v++)
          r.add(f[v]);
  }
}
function QA(r, t, e, i) {
  var n = e.axis, a = vn(i.axisLabelShow, e.get(["axisLabel", "show"]));
  if (!(!a || n.scale.isBlank())) {
    var o = e.getModel("axisLabel"), s = o.get("margin"), l = n.getViewLabels(), u = (vn(i.labelRotate, o.get("rotate")) || 0) * Ir / 180, h = Rr.innerTextLayout(i.rotation, u, i.labelDirection), f = e.getCategories && e.getCategories(!0), v = [], c = Rr.isLabelSilent(e), p = e.get("triggerEvent");
    return C(l, function(g, d) {
      ...
      if (f && f[y]) {
        var w = f[y];
        V(w) && w.textStyle && (S = new bt(w.textStyle, o, e.ecModel));
      }
      var b = S.getTextColor() || e.get(["axisLine", "lineStyle", "color"]), x = n.dataToCoord(y), M = S.getShallow("align", !0) || h.textAlign, D = J(S.getShallow("alignMinLabel", !0), M), A = J(S.getShallow("alignMaxLabel", !0), M), T = S.getShallow("verticalAlign", !0) || S.getShallow("baseline", !0) || h.textVerticalAlign, I = J(S.getShallow("verticalAlignMinLabel", !0), T), L = J(S.getShallow("verticalAlignMaxLabel", !0), T), P = new Mt({
        x,
      ...
      if (P.anid = "label_" + y, Xs({
        ...
        var R = Rr.makeAxisEventDataBase(e);
...
function jA(r, t) {
  ...
  return JA(e, r, t), e.seriesInvolved && e2(e, r), e;
}
function JA(r, t, e) {
  ...
  C(e.getCoordinateSystems(), function(s) {
    ...
    if (C(s.getAxes(), Ct(g, !1, null)), s.getTooltipAxes && i && f.get("show")) {
      var v = f.get("trigger") === "axis", c = f.get(["axisPointer", "type"]) === "cross", p = s.getTooltipAxes(f.get(["axisPointer", "axis"]));
      (v || c) && C(p.baseAxes, Ct(g, c ? "cross" : !0, v)), c && C(p.otherAxes, Ct(g, "cross", !1));
    }
    function g(d, y, m) {
      var _ = m.model.getModel("axisPointer", n), S = _.get("show");
      if (!(!S || S === "auto" && !d && !zh(_))) {
        y == null && (y = _.get("triggerTooltip")), _ = d ? t2(m, f, n, t, d, y) : _;
        var w = _.get("snap"), b = _.get("triggerEmphasis"), x = Ba(m.model), M = y || w || m.type === "category", D = r.axesInfo[x] = {
          key: x,
          axis: m,
          coordSys: s,
          axisPointerModel: _,
...
function t2(r, t, e, i, n, a) {
  ...
  return r.model.getModel("axisPointer", new bt(l, e, i));
}
function e2(r, t) {
  t.eachSeries(function(e) {
    var i = e.coordinateSystem, n = e.get(["tooltip", "trigger"], !0), a = e.get(["tooltip", "show"], !0);
    !i || n === "none" || n === !1 || n === "item" || a === !1 || e.get(["axisPointer", "show"], !0) === !1 || C(r.coordSysAxesInfo[Ba(i.model)], function(o) {
      var s = o.axis;
...
function r2(r, t) {
  for (var e = t.model, i = t.dim, n = 0; n < r.length; n++) {
    var a = r[n] || {};
    if (Pu(a[i + "AxisId"], e.id) || Pu(a[i + "AxisIndex"], e.componentIndex) || Pu(a[i + "AxisName"], e.name))
      return n;
  }
}
function Pu(r, t) {
  return r === "all" || z(r) && ht(r, t) >= 0 || r === t;
}
function i2(r) {
  var t = ac(r);
  if (t) {
...
function a2(r, t, e, i) {
  ...
  if (!n.scale.isBlank()) {
    ...
    if (u.length) {
      var h = s.length, f = $h(r).splitAreaColors, v = Q(), c = 0;
      if (f)
      ...
      for (var p = 1; p < u.length; p++) {
        var m = n.toGlobalCoord(u[p].coord), _ = void 0, S = void 0, w = void 0, b = void 0;
        n.isHorizontal() ? (_ = d, S = l.y, w = m - _, b = l.height, d = _ + w) : (_ = l.x, S = d, w = l.width, b = m - S, d = S + b);
      ...
      $h(r).splitAreaColors = v;
    }
  }
}
function o2(r) {
  $h(r).splitAreaColors = null;
}
var s2 = ["axisLine", "axisTickLabel", "axisName"], l2 = ["splitArea", "splitLine", "minorSplitLine"], W0 = (
  /** @class */
  function(r) {
    N(t, r);
    function t() {
    ...
    return t.prototype.render = function(e, i, n, a) {
      ...
      if (this._axisGroup = new xt(), this.group.add(this._axisGroup), !!e.get("show")) {
        var s = e.getCoordSysModel(), l = Nh(s, e), u = new Rr(e, B({
          handleAutoShown: function(f) {
            for (var v = s.coordinateSystem.getCartesians(), c = 0; c < v.length; c++)
              if (Rh(v[c].getOtherAxis(e.axis).scale))
                return !0;
            return !1;
          }
        }, l));
        C(s2, u.add, u), this._axisGroup.add(u.getGroup()), C(l2, function(f) {
          e.get([f, "show"]) && u2[f](this, this._axisGroup, e, s);
        }, this);
        var h = a && a.type === "changeAxisOrder" && a.isInitSort;
        h || $y(o, this._axisGroup, e), r.prototype.render.call(this, e, i, n, a);
      }
    ...
    if (!n.scale.isBlank()) {
      ...
      for (var h = i.coordinateSystem.getRect(), f = n.isHorizontal(), v = 0, c = n.getTicksCoords({
        ...
        if (!(y === 0 && !l || y === c.length - 1 && !u)) {
          ...
          Aa(w.shape, d.lineWidth), t.add(w);
        }
      }
    }
  },
    ...
    if (u.length)
      for (var h = [], f = [], v = o.getLineStyle(), c = 0; c < u.length; c++)
        for (var p = 0; p < u[c].length; p++) {
          ...
          Aa(d.shape, v.lineWidth), t.add(d);
        }
  },
...
function c2(r) {
  r.registerComponentView(f2), r.registerComponentModel(kA), r.registerCoordinateSystem("cartesian2d", UA), Md(r, "x", kh, Nd), Md(r, "y", kh, Nd), r.registerComponentView(U0), r.registerComponentView(h2), r.registerPreprocessor(function(t) {
    t.xAxis && t.yAxis && !t.grid && (t.grid = {});
  });
}
var Na = C, v2 = V, As = -1, Nt = (
  /** @class */
  function() {
    function r(t) {
      var e = t.mappingMethod, i = t.type, n = this.option = X(t);
      this.type = i, this.mappingMethod = e, this._normalizeData = g2[e];
      var a = r.visualHandlers[i];
      this.applyVisual = a.applyVisual, this.getColorMapper = a.getColorMapper, this._normalizedToVisual = a._normalizedToVisual[e], e === "piecewise" ? (Ru(n), p2(n)) : e === "category" ? n.categories ? d2(n) : Ru(n, !0) : (Fe(e !== "linear" || n.dataExtent), Ru(n));
    }
    return r.prototype.mapValueToVisual = function(t) {
      ...
      var e = {}, i;
      return t && Na(r.visualHandlers, function(n, a) {
      ...
      for (var o = 0, s = e.length; o < s; o++) {
        ...
        if (h) {
          if (h[0] === -1 / 0) {
            ...
            if (Oo(f[0], h[0], t))
              return o;
          } else if (Oo(f[0], h[0], t) && Oo(f[1], t, h[1]))
            return o;
          i && v(h[0], o), i && v(h[1], o);
        }
      }
      ...
      color: {
        applyVisual: qn("color"),
        getColorMapper: function() {
          var t = this.option;
          return j(t.mappingMethod === "category" ? function(e, i) {
            return !i && (e = this._normalizeData(e)), ia.call(this, e);
          } : function(e, i, n) {
            var a = !!n;
            return !i && (e = this._normalizeData(e)), n = Dl(e, t.parsedVisual, n), a ? n : ir(n, "rgba");
          }, this);
        },
        _normalizedToVisual: {
          linear: function(t) {
            return ir(Dl(t, this.option.parsedVisual), "rgba");
          },
          category: ia,
          piecewise: function(t, e) {
            var i = Vh.call(this, e);
            return i == null && (i = ir(Dl(t, this.option.parsedVisual), "rgba")), i;
          },
          fixed: ui
        }
      },
      colorHue: Eo(function(t, e) {
        return Al(t, e);
      }),
      colorSaturation: Eo(function(t, e) {
        return Al(t, null, e);
      }),
      colorLightness: Eo(function(t, e) {
        return Al(t, null, null, e);
      }),
      colorAlpha: Eo(function(t, e) {
        return uS(t, e);
      }),
      decal: {
        applyVisual: qn("decal"),
        _normalizedToVisual: {
          linear: null,
          category: ia,
          piecewise: null,
      ...
      opacity: {
        applyVisual: qn("opacity"),
        _normalizedToVisual: Fh([0, 1])
      },
      liftZ: {
        applyVisual: qn("liftZ"),
        _normalizedToVisual: {
          linear: ui,
          category: ui,
          piecewise: ui,
      ...
      symbol: {
        ...
        _normalizedToVisual: {
          ...
          piecewise: function(t, e) {
            var i = Vh.call(this, e);
            return i == null && (i = zd.call(this, t)), i;
          },
          fixed: ui
        }
      },
      symbolSize: {
        applyVisual: qn("symbolSize"),
        _normalizedToVisual: Fh([0, 1])
      }
    }, r;
  }()
...
function d2(r) {
  ...
  if (Na(t, function(o, s) {
    e[o] = s;
  }), !z(i)) {
    var n = [];
    V(i) ? Na(i, function(o, s) {
      var l = e[s];
      n[l ?? As] = o;
    }) : n[As] = i, i = Y0(r, n);
  }
...
function Ru(r, t) {
  ...
  !t && i.length === 1 && !n.hasOwnProperty(r.type) && (i[1] = i[0]), Y0(r, i);
}
function Eo(r) {
  return {
    applyVisual: function(t, e, i) {
...
function zd(r) {
  ...
  return t[Math.round(ar(r, [0, 1], [0, t.length - 1], !0))] || {};
}
function qn(r) {
...
function ia(r) {
  var t = this.option.visual;
  return t[this.option.loop && r !== As ? r % t.length : r];
}
function ui() {
...
function Fh(r) {
  return {
    linear: function(t) {
      return ar(t, r, this.option.visual, !0);
    },
    category: ia,
    piecewise: function(t, e) {
      var i = Vh.call(this, e);
      return i == null && (i = ar(t, r, this.option.visual, !0)), i;
    },
    fixed: ui
  };
}
...
function Y0(r, t) {
  return r.visual = t, r.type === "color" && (r.parsedVisual = W(t, function(e) {
    var i = de(e);
    return i || [0, 0, 0, 1];
  })), t;
}
...
function y2(r, t, e, i, n, a) {
  r = r || 0;
  var o = e[1] - e[0];
  if (n != null && (n = Gi(n, [0, o])), a != null && (a = Math.max(a, n ?? 0)), i === "all") {
    var s = Math.abs(t[1] - t[0]);
    s = Gi(s, [0, o]), n = a = Gi(s, [n, a]), i = 0;
  }
  t[0] = Gi(t[0], e), t[1] = Gi(t[1], e);
  var l = Eu(t, i);
  t[i] += r;
  var u = n || 0, h = e.slice();
  l.sign < 0 ? h[0] += u : h[1] -= u, t[i] = Gi(t[i], h);
  var f;
  return f = Eu(t, i), n != null && (f.sign !== l.sign || f.span < n) && (t[1 - i] = t[i] + l.sign * n), f = Eu(t, i), a != null && f.span > a && (t[1 - i] = t[i] + f.sign * a), t;
}
function Eu(r, t) {
  var e = r[t] - r[1 - t];
  return {
...
var m2 = 256, _2 = (
  ...
  function() {
    ...
    return r.prototype.update = function(t, e, i, n, a, o) {
      ...
      if (!f.width || !f.height)
        return f;
      for (var S = v.getImageData(0, 0, f.width, f.height), w = S.data, b = 0, x = w.length, M = this.minOpacity, D = this.maxOpacity, A = D - M; b < x; ) {
        var _ = w[b + 3] / 256, T = Math.floor(_ * (m2 - 1)) * 4;
        if (_ > 0) {
          var I = o(_) ? l : u;
          _ > 0 && (_ = _ * A + M), w[b++] = I[T], w[b++] = I[T + 1], w[b++] = I[T + 2], w[b++] = I[T + 3] * _ * 256;
        } else
          b += 4;
      }
      return v.putImageData(S, 0, 0), f;
    }, r.prototype._getBrush = function() {
      var t = this._brushCanvas || (this._brushCanvas = Er.createCanvas()), e = this.pointSize + this.blurSize, i = e * 2;
...
var w2 = (
  ...
  function(r) {
    ...
    return t.prototype.render = function(e, i, n) {
      ...
      o.type === "cartesian2d" || o.type === "calendar" ? this._renderOnCartesianAndCalendar(e, n, 0, e.getData().count()) : $d(o) && this._renderOnGeo(o, e, a, n);
      ...
      o && ($d(o) ? this.render(i, n, a) : (this._progressiveEls = [], this._renderOnCartesianAndCalendar(i, a, e.start, e.end, !0)));
    }, t.prototype.eachRendered = function(e) {
      Ua(this._progressiveEls || this.group, e);
    }, t.prototype._renderOnCartesianAndCalendar = function(e, i, n, a, o) {
      var s = e.coordinateSystem, l = cl(s, "cartesian2d"), u, h, f, v;
      if (l) {
        var c = s.getAxis("x"), p = s.getAxis("y");
        u = c.getBandWidth() + 0.5, h = p.getBandWidth() + 0.5, f = c.scale.getExtent(), v = p.scale.getExtent();
      }
      for (var g = this.group, d = e.getData(), y = e.getModel(["emphasis", "itemStyle"]).getItemStyle(), m = e.getModel(["blur", "itemStyle"]).getItemStyle(), _ = e.getModel(["select", "itemStyle"]).getItemStyle(), S = e.get(["itemStyle", "borderRadius"]), w = pn(e), b = e.getModel("emphasis"), x = b.get("focus"), M = b.get("blurScope"), D = b.get("disabled"), A = l ? [d.mapDimension("x"), d.mapDimension("y"), d.mapDimension("value")] : [d.mapDimension("time"), d.mapDimension("value")], T = n; T < a; T++) {
        ...
        if (d.hasItemOption) {
          var H = d.getItemModel(T), O = H.getModel("emphasis");
          y = O.getModel("itemStyle").getItemStyle(), m = H.getModel(["blur", "itemStyle"]).getItemStyle(), _ = H.getModel(["select", "itemStyle"]).getItemStyle(), S = H.get(["itemStyle", "borderRadius"]), x = O.get("focus"), M = O.get("blurScope"), D = O.get("disabled"), w = pn(H);
        }
        I.shape.r = S;
        var $ = e.getRawValue(T), G = "-";
        $ && $[2] != null && (G = $[2] + ""), Ya(I, w, {
          labelFetcher: e,
          labelDataIndex: T,
          defaultOpacity: L.opacity,
          defaultText: G
        }), I.ensureState("emphasis").style = y, I.ensureState("blur").style = m, I.ensureState("select").style = _, Da(I, x, M, D), I.incremental = o, o && (I.states.emphasis.hoverLayer = !0), g.add(I), d.setItemGraphicEl(T, I), this._progressiveEls && this._progressiveEls.push(I);
      }
    }, t.prototype._renderOnGeo = function(e, i, n, a) {
      var o = n.targetVisuals.inRange, s = n.targetVisuals.outOfRange, l = i.getData(), u = this._hmLayer || this._hmLayer || new _2();
      ...
      }), S = n.getExtent(), w = n.type === "visualMap.continuous" ? b2(S, n.option.range) : S2(S, n.getPieceList(), n.option.selected);
  ...
  function(r) {
    ...
    return t.prototype.getInitialData = function(e, i) {
      ...
      var e = nl.get(this.get("coordinateSystem"));
      if (e && e.dimensions)
...
function T2(r) {
  r.registerChartView(w2), r.registerSeriesModel(x2);
}
var hi = Dt(), Fd = X, Ou = j, C2 = (
  /** @class */
  function() {
    function r() {
    ...
    return r.prototype.render = function(t, e, i, n) {
      ...
      if (this._axisModel = t, this._axisPointerModel = e, this._api = i, !(!n && this._lastValue === a && this._lastStatus === o)) {
        ...
        if (!s)
          s = this._group = new xt(), this.createPointerEl(s, u, t, e), this.createLabelEl(s, u, t, e), i.getZr().add(s);
        else {
          var v = Ct(Vd, e, f);
          this.updatePointerEl(s, u, v), this.updateLabelEl(s, u, v, e);
        }
        Gd(s, e, !0), this._renderHandle(a);
      }
    }, r.prototype.remove = function(t) {
      this.clear(t);
      ...
      if (i === "auto" || i == null) {
        ...
        if (a && n.getBandWidth() > s)
          return !0;
        if (o) {
          var l = ac(t).seriesDataCount, u = n.getExtent();
      ...
      var a = e.pointer;
      if (a) {
        var o = hi(t).pointerEl = new vx[a.type](Fd(e.pointer));
        t.add(o);
      }
    }, r.prototype.createLabelEl = function(t, e, i, n) {
      if (e.label) {
        var a = hi(t).labelEl = new Mt(Fd(e.label));
        t.add(a), Hd(a, n);
      }
    }, r.prototype.updatePointerEl = function(t, e, i) {
      var n = hi(t).pointerEl;
      ...
      if (!(this._dragging || !this.updateHandleTransform)) {
        ...
        }), i.add(n)), Gd(n, e, !1), n.setStyle(a.getItemStyle(null, ["color", "borderColor", "borderWidth", "opacity", "shadowColor", "shadowBlur", "shadowOffsetX", "shadowOffsetY"]));
        var l = a.get("size");
        z(l) || (l = [l, l]), n.scaleX = l[0] / 2, n.scaleY = l[1] / 2, Am(this, "_doDispatchAxisPointer", a.get("throttle") || 0, "fixRate"), this._moveHandleToValue(t, s);
      }
    }, r.prototype._moveHandleToValue = function(t, e) {
      Vd(this._axisPointerModel, !e && this._moveAnimation, this._handle, ku(this.getHandleTransform(t, this._axisModel, this._axisPointerModel)));
      ...
      if (i) {
        ...
        this._payloadInfo = n, i.stopAnimation(), i.attr(ku(n)), hi(i).lastProp = null, this._doDispatchAxisPointer();
      }
      ...
      e && i && (this._lastGraphicKey = null, i && e.remove(i), n && e.remove(n), this._group = null, this._handle = null, this._payloadInfo = null), wh(this, "_doDispatchAxisPointer");
...
function Vd(r, t, e, i) {
  X0(hi(e).lastProp, i) || (hi(e).lastProp = i, t ? re(e, i, r) : (e.stopAnimation(), e.attr(i)));
}
function X0(r, t) {
  if (V(r) && V(t)) {
    var e = !0;
...
function D2(r, t, e, i, n) {
  ...
  }), s = e.getModel("label"), l = Xa(s.get("padding") || 0), u = s.getFont(), h = pf(o, u), f = n.position, v = h.width + l[1] + l[3], c = h.height + l[0] + l[2], p = n.align;
  p === "right" && (f[0] -= v), p === "center" && (f[0] -= v / 2);
  var g = n.verticalAlign;
  g === "bottom" && (f[1] -= c), g === "middle" && (f[1] -= c / 2), A2(f, v, c, i);
...
function q0(r, t, e, i, n) {
  ...
  if (o) {
    ...
    }), F(o) ? a = o.replace("{value}", a) : q(o) && (a = o(s));
  }
  return a;
}
function Z0(r, t, e) {
  var i = rn();
  return hf(i, i, e.rotation), Xu(i, i, e.position), on([r.dataToCoord(t), (e.labelOffset || 0) + (e.labelDirection || 1) * (e.labelMargin || 0)], i);
}
function I2(r, t, e, i, n, a) {
  var o = Rr.innerTextLayout(e.rotation, 0, e.labelDirection);
  e.labelMargin = n.get(["label", "margin"]), D2(t, i, n, a, {
    position: Z0(i.axis, r, e),
    align: o.textAlign,
...
var R2 = (
  ...
  function(r) {
    ...
    return t.prototype.makeElOption = function(e, i, n, a, o) {
      var s = n.axis, l = s.grid, u = a.get("type"), h = Wd(l, s).getOtherAxis(s).getGlobalExtent(), f = s.toGlobalCoord(s.dataToCoord(i, !0));
      if (u && u !== "none") {
        var v = M2(a), c = E2[u](s, f, h);
      ...
      var o = n.axis, s = o.grid, l = o.getGlobalExtent(!0), u = Wd(s, o).getOtherAxis(o).getGlobalExtent(), h = o.dim === "x" ? 0 : 1, f = [e.x, e.y];
...
function K0(r, t, e) {
  if (!Y.node) {
    var i = t.getZr();
    rr(i).records || (rr(i).records = {}), B2(i, t);
...
function B2(r, t) {
  if (rr(r).initialized)
    return;
  rr(r).initialized = !0, e("click", Ct(Yd, "click")), e("mousemove", Ct(Yd, "mousemove")), e("globalout", z2);
  function e(i, n) {
    r.on(i, function(a) {
      var o = $2(t);
      k2(rr(r).records, function(s) {
...
function Hh(r, t) {
  if (!Y.node) {
    var e = t.getZr(), i = (rr(e).records || {})[r];
...
var F2 = (
  ...
  function(r) {
    ...
    return t.prototype.render = function(e, i, n) {
      ...
      K0("axisPointer", n, function(s, l, u) {
...
function V2(r, t, e) {
  ...
  if (s) {
    ...
    var l = jo(n), u = a.axesInfo, h = s.axesInfo, f = i === "leave" || jo(n), v = {}, c = {}, p = {
      list: [],
      map: {}
    }, g = {
      showPointer: Ct(G2, c),
    ...
    C(s.coordSysMap, function(y, m) {
      ...
      C(s.coordSysAxesInfo[m], function(S, w) {
        var b = S.axis, x = q2(u, S);
        if (!f && _ && (!u || x)) {
          var M = x && x.value;
          M == null && !l && (M = b.pointToData(n)), M != null && qd(S, M, g, !1, v);
        }
      });
    });
    var d = {};
    return C(h, function(y, m) {
      var _ = y.linkGroup;
      _ && !c[m] && C(_.axesInfo, function(S, w) {
        var b = c[w];
        if (S !== y && b) {
          var x = b.value;
          _.mapper && (x = y.axis.scale.parse(_.mapper(x, Zd(S), Zd(y)))), d[y.key] = x;
        }
      });
    }), C(d, function(y, m) {
      qd(h[m], y, g, !0, v);
    }), U2(c, h, v), Y2(p, n, r, o), X2(h, o, e), v;
  }
}
function qd(r, t, e, i, n) {
  var a = r.axis;
  if (!(a.scale.isBlank() || !a.containData(t))) {
    ...
    var o = H2(t, r), s = o.payloadBatch, l = o.snapToValue;
...
function W2(r, t, e, i) {
  ...
  if (!(!t.triggerTooltip || !n.length)) {
    var l = t.coordSys.model, u = Ba(l), h = r.map[u];
    h || (h = r.map[u] = {
      coordSysId: l.id,
...
function X2(r, t, e) {
  var i = e.getZr(), n = "axisPointerLastHighlights", a = Xd(i)[n] || {}, o = Xd(i)[n] = {};
  C(r, function(u, h) {
...
function j0(r) {
  G0.registerAxisPointerClass("CartesianAxisPointer", R2), r.registerComponentModel(O2), r.registerComponentView(F2), r.registerPreprocessor(function(t) {
    if (t) {
    ...
    t.getComponent("axisPointer").coordSysAxesInfo = jA(t, e);
  }), r.registerAction({
    type: "updateAxisPointer",
...
function K2(r, t) {
  var e = Xa(t.get("padding")), i = t.getItemStyle(["color", "opacity"]);
...
var e_ = t_(["transform", "webkitTransform", "OTransform", "MozTransform", "msTransform"]), j2 = t_(["webkitTransition", "transition", "OTransition", "MozTransition", "msTransition"]);
function r_(r, t) {
  if (!r)
    return t;
  t = tm(t, !0);
...
var tI = r_(j2, "transition"), oc = r_(e_, "transform"), eI = "position:absolute;display:block;border-style:solid;white-space:nowrap;z-index:9999999;" + (Y.transform3dSupported ? "will-change:transform;" : "");
function rI(r) {
...
function iI(r, t, e) {
  ...
  t = Ti(t);
  var a = rI(e), o = Math.max(Math.round(n) * 1.5, 6), s = "", l = oc + ":", u;
...
function nI(r, t) {
  ...
  return t || (i = " " + r + "s " + e, n += Y.transformSupported ? "," + oc + i : ",left" + i + ",top" + i), tI + ":" + n;
}
function Kd(r, t, e) {
  ...
  return e ? "top:0;left:0;" + oc + ":" + o + ";" : [["top", 0], ["left", 0], [e_, o]];
}
function aI(r) {
...
function oI(r, t, e) {
  var i = [], n = r.get("transitionDuration"), a = r.get("backgroundColor"), o = r.get("shadowBlur"), s = r.get("shadowColor"), l = r.get("shadowOffsetX"), u = r.get("shadowOffsetY"), h = r.getModel("textStyle"), f = Mm(r, "html"), v = l + "px " + u + "px " + o + "px " + s;
  return i.push("box-shadow:" + v), t && n && i.push(nI(n, e)), a && i.push("background-color:" + a), C(["width", "color", "radius"], function(c) {
    var p = "border-" + c, g = tm(p), d = r.get(g);
    d != null && i.push(p + ":" + d + (c === "color" ? "" : "px"));
  }), i.push(aI(h)), f != null && i.push("padding:" + Xa(f).join("px ") + "px"), i.join(";") + ";";
}
function Qd(r, t, e, i, n) {
  var a = t && t.painter;
  if (e) {
...
var sI = (
  ...
  function() {
    function r(t, e) {
      ...
      var n = this._zr = t.getZr(), a = e.appendTo, o = a && (F(a) ? document.querySelector(a) : ba(a) ? a : q(a) && a(t.getDom()));
      Qd(this._styleCoord, n, o, t.getWidth() / 2, t.getHeight() / 2), (o || t.getDom()).appendChild(i), this._api = t, this._container = o;
      var s = this;
      i.onmouseenter = function() {
        ...
        if (l = l || window.event, !s._enterable) {
          ...
          oe(h, l, !0), u.dispatch("mousemove", l);
        }
    ...
    return r.prototype.update = function(t) {
      if (!this._container) {
        var e = this._api.getDom(), i = J2(e, "position"), n = e.style;
      ...
      i.innerHTML ? n.cssText = eI + oI(t, !this._firstShow, this._longHide) + Kd(a[0], a[1], !0) + ("border-color:" + Ti(e) + ";") + (t.get("extraCssText") || "") + (";pointer-events:" + (this._enterable ? "auto" : "none")) : n.display = "none", this._show = !0, this._firstShow = !1, this._longHide = !1;
      ...
      var s = "";
      if (F(a) && i.get("trigger") === "item" && !J0(i) && (s = iI(i, n, a)), F(t))
        o.innerHTML = t + s;
      else if (t) {
        o.innerHTML = "", z(t) || (t = [t]);
      ...
      if (this.el) {
        ...
        if (Qd(i, this._zr, this._container, t, e), i[0] != null && i[1] != null) {
          var n = this.el.style, a = Kd(i[0], i[1]);
          C(a, function(o) {
            n[o[0]] = o[1];
          });
        }
  ...
  function() {
    function r(t) {
      this._show = !1, this._styleCoord = [0, 0, 0, 0], this._alwaysShowContent = !1, this._enterable = !0, this._zr = t.getZr(), Jd(this._styleCoord, this._zr, t.getWidth() / 2, t.getHeight() / 2);
    }
    return r.prototype.update = function(t) {
      ...
      var o = this;
      V(t) && Xt(""), this.el && this._zr.remove(this.el);
      ...
      var t = this.el, e = this.el.getBoundingRect(), i = jd(t.style);
      return [e.width + i.left + i.right, e.height + i.top + i.bottom];
    }, r.prototype.moveTo = function(t, e) {
      var i = this.el;
      if (i) {
        var n = this._styleCoord;
        Jd(n, this._zr, t, e), t = n[0], e = n[1];
        var a = i.style, o = Cr(a.borderWidth || 0), s = jd(a);
...
var uI = new _t({
  ...
  function(r) {
    ...
    return t.prototype.init = function(e, i) {
      if (!(Y.node || !i.getDom())) {
        var n = e.getComponent("tooltip"), a = this._renderMode = nb(n.get("renderMode"));
        this._tooltipContent = a === "richText" ? new lI(i) : new sI(i, {
      ...
      if (!(Y.node || !n.getDom())) {
        ...
        a.update(e), a.setEnterable(e.get("enterable")), this._initGlobalListener(), this._keepShow(), this._renderMode !== "richText" && e.get("transitionDuration") ? Am(this, "_updatePosition", 50, "fixRate") : wh(this, "_updatePosition");
      }
    }, t.prototype._initGlobalListener = function() {
      var e = this._tooltipModel, i = e.get("triggerOn");
      K0("itemTooltip", this._api, j(function(n, a, o) {
      ...
      if (!(a.from === this.uid || Y.node || !n.getDom())) {
        var o = tg(a, n);
        this._ticket = "";
        var s = a.dataByCoordSys, l = pI(a, i, n);
        if (l) {
          ...
          if (this._manuallyAxisShowTip(e, i, n, a))
            return;
          var f = Q0(a, i), v = f.point[0], c = f.point[1];
      ...
      if (!(o == null || s == null || l == null)) {
        ...
        if (u) {
          var h = u.getData(), f = Zn([h.getItemModel(s), u, (u.coordinateSystem || {}).model], this._tooltipModel);
      ...
      var n = this._ecModel, a = this._tooltipModel, o = [i.offsetX, i.offsetY], s = Zn([i.tooltipOption], a), l = this._renderMode, u = [], h = Ra("section", {
        blocks: [],
        noHeader: !0
      }), f = [], v = new cu();
      C(e, function(m) {
        C(m.dataByAxis, function(_) {
          ...
          if (!(!S || w == null)) {
            var b = q0(w, S.axis, n, _.seriesDataIndices, _.valueLabelOpt), x = Ra("section", {
              header: b,
              noHeader: !Ne(b),
              sortBlocks: !0,
              blocks: []
            ...
            h.blocks.push(x), C(_.seriesDataIndices, function(M) {
              ...
              if (!(T.dataIndex < 0)) {
                T.axisDim = _.axisDim, T.axisIndex = _.axisIndex, T.axisType = _.axisType, T.axisId = _.axisId, T.axisValue = tc(S.axis, {
                  value: w
                }), T.axisValueLabel = b, T.marker = v.makeTooltipMarker("item", Ti(T.color), l);
                var I = pp(D.formatTooltip(A, !0, null)), L = I.frag;
                if (L) {
                  var P = Zn([D], a).get("valueFormatter");
                  x.blocks.push(P ? B({
                    valueFormatter: P
                  }, L) : L);
                }
      ...
      var c = i.position, p = s.get("order"), g = _p(h, v, l, p, n.get("useUTC"), s.get("textStyle"));
      g && f.unshift(g);
      var d = l === "richText" ? `
...
` : "<br/>", y = f.join(d);
      ...
      var a = this._ecModel, o = it(i), s = o.seriesIndex, l = a.getSeriesByIndex(s), u = o.dataModel || l, h = o.dataIndex, f = o.dataType, v = u.getData(f), c = this._renderMode, p = e.positionDefault, g = Zn([v.getItemModel(h), u, l && (l.coordinateSystem || {}).model], this._tooltipModel, p ? {
        position: p
      } : null), d = g.get("trigger");
      if (!(d != null && d !== "item")) {
        var y = u.getDataParams(h, f), m = new cu();
        y.marker = m.makeTooltipMarker("item", Ti(y.color), c);
        var _ = pp(u.formatTooltip(h, !1, f)), S = g.get("order"), w = g.get("valueFormatter"), b = _.frag, x = b ? _p(w ? B({
          valueFormatter: w
        }, b) : b, m, c, S, a.get("useUTC"), g.get("textStyle")) : _.text, M = "item_" + u.name + "_" + h;
      ...
      var c = e.positionDefault, p = Zn(f, this._tooltipModel, c ? {
        position: c
      } : null), g = p.get("content"), d = Math.random() + "", y = new cu();
      ...
      if (this._ticket = "", !(!e.get("showContent") || !e.get("show"))) {
        ...
        if (v)
          if (F(v)) {
            var d = e.ecModel.get("useUTC"), y = z(n) ? n[0] : n, m = y && y.axisType && y.axisType.indexOf("time") >= 0;
            c = v, m && (c = js(y.axisValue, c, d)), c = em(c, n, !0);
          } else if (q(v)) {
            var _ = j(function(S, w) {
              S === this._ticket && (f.setContent(w, h, e, g, l), this._updatePosition(e, l, o, s, f, n, u));
            }, this);
      ...
      if (l && p.applyTransform(l.transform), q(i) && (i = i([n, a], s, o.el, p, {
        ...
        var y = vI(i, p, f, e.get("borderWidth"));
        n = y[0], a = y[1];
      } else {
        var y = fI(n, a, o, u, h, v ? null : 20, c ? null : 20);
        n = y[0], a = y[1];
      }
      if (v && (n -= eg(v) ? f[0] / 2 : v === "right" ? f[0] : 0), c && (a -= eg(c) ? f[1] / 2 : c === "bottom" ? f[1] : 0), J0(e)) {
        var y = cI(n, a, o, u, h);
        n = y[0], a = y[1];
      }
      o.moveTo(n, a);
      ...
      Y.node || !i.getDom() || (wh(this, "_updatePosition"), this._tooltipContent.dispose(), Hh("itemTooltip", i));
    }, t.type = "tooltip", t;
  }(Ae)
);
function Zn(r, t, e) {
  var i = t.ecModel, n;
  e ? (n = new bt(e, i, i), n = new bt(t.option, n, i)) : n = t;
  for (var a = r.length - 1; a >= 0; a--) {
    var o = r[a];
    o && (o instanceof bt && (o = o.get("tooltip", !0)), F(o) && (o = {
      formatter: o
    }), o && (n = new bt(o, n, i)));
  }
  return n;
...
function pI(r, t, e) {
  var i = mf(r).queryOptionMap, n = i.keys()[0];
  if (!(!n || n === "series")) {
...
function dI(r) {
  Ge(j0), r.registerComponentModel(Q2), r.registerComponentView(hI), r.registerAction({
    type: "showTip",
    event: "showTip",
  ...
  return rg(t, function(a) {
    ...
    rg(r[a], function(s, l) {
      if (Nt.isValidType(l)) {
        ...
        e && e(u, a), o[l] = new Nt(u), l === "opacity" && (u = X(u), u.type = "colorAlpha", o.__hidden.__alphaForOpacity = new Nt(u));
      }
    });
  }), i;
  function n() {
...
function gI(r, t, e) {
  var i;
  C(e, function(n) {
    t.hasOwnProperty(n) && ig(t[n]) && (i = !0);
  }), i && C(e, function(n) {
    t.hasOwnProperty(n) && ig(t[n]) ? r[n] = X(t[n]) : delete r[n];
  });
}
function yI(r, t, e, i) {
  var n = {};
...
var mI = function(r, t) {
    ...
    return t.prototype.init = function(e, i, n) {
      ...
      e.eachRawSeries(function(l) {
        ...
        if (l.legendVisualProvider) {
          ...
          h = !0;
        h && yf(l) && i.push(l.name);
      }), this._availableNames = n;
      var a = this.get("data") || i, o = Q(), s = W(a, function(l) {
        return (F(l) || pt(l)) && (l = {
          name: l
        }), o.get(l.name) ? null : (o.set(l.name, !0), new bt(l, this, this.ecModel));
      }, this);
      this._data = Lt(s, function(l) {
        return !!l;
      });
      ...
      var i = this.option.selected;
      return !(i.hasOwnProperty(e) && !i[e]) && ht(this._availableNames, e) >= 0;
  ...
  function(r) {
    ...
    return t.prototype.init = function() {
      this.group.add(this._contentGroup = new ko()), this.group.add(this._selectorGroup = new ko()), this._isFirstRender = !0;
      ...
      if (this._isFirstRender = !1, this.resetInner(), !!e.get("show", !0)) {
        ...
        var h = e.getBoxLayoutParams(), f = {
          width: n.getWidth(),
          height: n.getHeight()
        }, v = e.get("padding"), c = dn(h, f, v), p = this.layoutInner(e, o, c, a, l, u), g = dn(ot({
          width: p.width,
          height: p.height
        }, h), f, v);
        this.group.x = g.x - p.x, this.group.y = g.y - p.y, this.group.markRedraw(), this.group.add(this._backgroundEl = K2(p, e));
      }
...
`)) {
        ...
        if (!h.get(g))
          if (y) {
            var m = y.getData(), _ = m.getVisual("legendLineStyle") || {}, S = m.getVisual("legendIcon"), w = m.getVisual("style"), b = this._createItem(y, g, p, c, i, e, _, w, S, f, a);
            b.on("click", Wi(ag, g, null, a, v)).on("mouseover", Wi(Uh, y.name, null, a, v)).on("mouseout", Wi(Yh, y.name, null, a, v)), n.ssr && b.eachChild(function(x) {
              var M = it(x);
            ...
            n.eachRawSeries(function(x) {
              if (!h.get(g) && x.legendVisualProvider) {
                ...
                if (!M.containName(g))
                  return;
                var D = M.indexOfName(g), A = M.getItemVisual(D, "style"), T = M.getItemVisual(D, "legendIcon"), I = de(A.fill);
                I && I[3] === 0 && (I[3] = 0.2, A = B(B({}, A), {
                  fill: ir(I, "rgba")
                }));
                var L = this._createItem(x, g, p, c, i, e, {}, A, T, f, a);
                L.on("click", Wi(ag, null, g, a, v)).on("mouseover", Wi(Uh, null, g, a, v)).on("mouseout", Wi(Yh, null, g, a, v)), n.ssr && L.eachChild(function(P) {
                  var R = it(P);
      ...
      h = _ || h || "roundRect";
      var S = _I(h, a, l, u, c, d, v), w = new ko(), b = a.getModel("textStyle");
      ...
      F(A) && A ? T = A.replace("{name}", i ?? "") : q(A) && (T = A(i));
      var I = d ? b.getTextColor() : a.get("inactiveColor");
      w.add(new Mt({
        style: $e(b, {
          text: T,
          x: M,
      ...
      return P.get("show") && Xs({
        ...
        R.silent = !0;
      }), L.silent = !f, this.getContentGroup().add(w), uh(w), w.__legendDataIndex = n, w;
    }, t.prototype.layoutInner = function(e, i, n, a, o, s) {
      var l = this.getContentGroup(), u = this.getSelectorGroup();
      hn(e.get("orient"), l, e.get("itemGap"), n.width, n.height);
...
function _I(r, t, e, i, n, a, o) {
  function s(d, y) {
    d.lineWidth === "auto" && (d.lineWidth = y.lineWidth > 0 ? 2 : 0), Wh(d, function(m, _) {
      d[_] === "inherit" && (d[_] = y[_]);
    });
  }
  var l = t.getModel("itemStyle"), u = l.getItemStyle(), h = r.lastIndexOf("empty", 0) === 0 ? "fill" : "stroke", f = l.getShallow("decal");
  u.decal = !f || f === "inherit" ? i.decal : Dh(f, o), u.fill === "inherit" && (u.fill = i[n]), u.stroke === "inherit" && (u.stroke = i[h]), u.opacity === "inherit" && (u.opacity = (n === "fill" ? i : e).opacity), s(u, i);
...
function SI(r) {
  var t = r.icon || "roundRect", e = lr(t, 0, 0, r.itemWidth, r.itemHeight, r.itemStyle.fill, r.symbolKeepAspect);
...
function Kn(r, t, e) {
  ...
  e.eachComponent({
    ...
    i ? s[r]() : s[r](t.name), og(s, n), a.push(s.componentIndex);
  });
  var o = {};
...
` || n === "")) {
      ...
      bi(e, n) ? e[n] = e[n] && a : e[n] = a;
    }
  }), e;
}
function wI(r) {
  r.registerAction("legendToggleSelect", "legendselectchanged", Ct(Kn, "toggleSelected")), r.registerAction("legendAllSelect", "legendselectall", Ct(Kn, "allSelect")), r.registerAction("legendInverseSelect", "legendinverseselect", Ct(Kn, "inverseSelect")), r.registerAction("legendSelect", "legendselected", Ct(Kn, "select")), r.registerAction("legendUnSelect", "legendunselected", Ct(Kn, "unSelect"));
}
function a_(r) {
  r.registerComponentModel(Gh), r.registerComponentView(i_), r.registerProcessor(r.PRIORITY.PROCESSOR.SERIES_FILTER, bI), r.registerSubTypeDefaulter("legend", function() {
    return "plain";
  }), wI(r);
}
var xI = (
  ...
  function(r) {
    ...
    return t.prototype.setScrollDataIndex = function(e) {
      ...
      var a = il(e);
      r.prototype.init.call(this, e, i, n), sg(this, e, a);
    }, t.prototype.mergeOption = function(e, i) {
      r.prototype.mergeOption.call(this, e, i), sg(this, this.option, e);
    }, t.type = "legend.scroll", t.defaultOption = Qs(Gh.defaultOption, {
      scrollDataIndex: 0,
      pageButtonItemGap: 5,
      pageButtonGap: null,
...
var lg = xt, Bu = ["width", "height"], Nu = ["x", "y"], TI = (
  /** @class */
  function(r) {
    N(t, r);
    function t() {
    ...
    return t.prototype.init = function() {
      ...
      function p(g, d) {
        var y = g + "DataIndex", m = Rf(i.get("pageIcons", !0)[i.getOrient().name][d], {
      ...
      var l = this.getSelectorGroup(), u = e.getOrient().index, h = Bu[u], f = Nu[u], v = Bu[1 - u], c = Nu[1 - u];
      o && hn(
        // Buttons in selectorGroup always layout horizontally
        "horizontal",
        l,
      ...
      hn(e.get("orient"), h, e.get("itemGap"), a ? n.width : null, a ? null : n.height), hn(
      ...
      if (w[o] = g ? n[o] : c[o], w[s] = Math.max(c[s], p[s]), w[l] = Math.min(0, p[l] + m[1 - a]), f.__rectSize = n[o], g) {
        ...
        b[o] = Math.max(n[o] - p[o] - _, 0), b[s] = w[s], f.setClipPath(new _t({
          shape: b
        })), f.__rectSize = b[o];
      } else
      ...
      a && o && a.setStyle("text", F(o) ? o.replace("{current}", l == null ? "" : l + "").replace("{total}", u == null ? "" : u + "") : o({
        current: l,
        total: u
      }));
    }, t.prototype._getPageInfo = function(e) {
      var i = e.get("scrollDataIndex", !0), n = this.getContentGroup(), a = this._containerGroup.__rectSize, o = e.getOrient().index, s = Bu[o], l = Nu[o], u = this._findTargetItemIndex(i), h = n.children(), f = h[u], v = h.length, c = v ? 1 : 0, p = {
      ...
      for (var d = u + 1, y = g, m = g, _ = null; d <= v; ++d)
        _ = S(h[d]), // Half of the last item is out of the window.
      ...
      for (var d = u - 1, y = g, m = g, _ = null; d >= -1; --d)
        _ = S(h[d]), // If the the end item does not intersect with the window started
...
function MI(r) {
  Ge(a_), r.registerComponentModel(xI), r.registerComponentView(TI), CI(r);
}
function DI(r) {
  Ge(a_), Ge(MI);
}
var o_ = {
...
}, ug = Nt.mapVisual, II = Nt.eachVisual, LI = z, hg = C, PI = ey, RI = ar, Is = (
  /** @class */
  function(r) {
    N(t, r);
    function t() {
    ...
    return t.prototype.init = function(e, i, n) {
      ...
      var n = this.option;
      !i && gI(n, e, this.replacableOptionKeys), this.textStyleModel = this.getModel("textStyle"), this.resetItemSize(), this.completeVisualOption();
    }, t.prototype.resetVisual = function(e) {
      var i = this.stateList;
      e = j(e, this), this.controllerVisuals = ng(this.option.controller, i, e), this.targetVisuals = ng(this.option.target, i, e);
      ...
      var e = this.option, i = PI([e.min, e.max]);
      this._dataExtent = i;
      ...
      function l(f) {
        LI(i.color) && !f.inRange && (f.inRange = {
      ...
      function u(f, v, c) {
        var p = f[v], g = f[c];
        p && !g && (g = f[c] = {}, hg(p, function(d, y) {
          if (Nt.isValidType(y)) {
            var m = o_.get(y, "inactive", s);
      ...
      function h(f) {
        ...
        hg(this.stateList, function(y) {
          ...
          _ || (_ = f[y] = {
            color: s ? p : [p]
          }), _.symbol == null && (_.symbol = v && X(v) || (s ? d : [d])), _.symbolSize == null && (_.symbolSize = c && X(c) || (s ? m[0] : [m[0], m[0]])), _.symbol = ug(_.symbol, function(b) {
            return b === "none" ? d : b;
          });
          var S = _.symbolSize;
          if (S != null) {
            ...
            II(S, function(b) {
              b > w && (w = b);
            }), _.symbolSize = ug(S, function(b) {
              return RI(b, [0, w], [0, m[0]], !0);
            });
          }
        }, this);
      }
  ...
  function(r) {
    ...
    return t.prototype.optionUpdated = function(e, i) {
      ...
      var e = this.itemSize;
      (e[0] == null || isNaN(e[0])) && (e[0] = fg[0]), (e[1] == null || isNaN(e[1])) && (e[1] = fg[1]);
      ...
      var e = this.getExtent(), i = ey((this.get("range") || []).slice());
      ...
      var i = cg(this, "outOfRange", this.getExtent()), n = cg(this, "inRange", this.option.range.slice()), a = [];
      function o(c, p) {
        a.push({
          value: c,
          color: e(c, p)
    ...
    }, t.type = "visualMap.continuous", t.defaultOption = Qs(Is.defaultOption, {
      align: "auto",
      calculable: !1,
      hoverLink: !0,
      realtime: !0,
...
var s_ = (
  ...
  function(r) {
    ...
    return t.prototype.init = function(e, i) {
      ...
      var i = this.visualMapModel, n = Xa(i.get("padding") || 0), a = e.getBoundingRect();
      e.add(new _t({
        z2: -1,
        silent: !0,
        shape: {
      ...
      var f = o.controllerVisuals[a || o.getValueState(e)], v = Nt.prepareVisualTypes(f);
      return C(v, function(c) {
        var p = f[c];
        n.convertOpacityToAlpha && c === "opacity" && (c = "colorAlpha", p = f.__alphaForOpacity), Nt.dependsOn(c, i) && p && p.applyVisual(e, u, h);
      }), s[i];
    }, t.prototype.positionGroup = function(e) {
      var i = this.visualMapModel, n = this.api;
      Fx(e, i.getBoxLayoutParams(), {
        width: n.getWidth(),
        height: n.getHeight()
      });
...
function l_(r, t, e) {
  ...
  for (var a = {
    width: t.getWidth(),
    height: t.getHeight()
  }, o = i.orient === "horizontal" ? 1 : 0, s = vg[o], l = [0, null, 10], u = {}, h = 0; h < 3; h++)
    u[vg[1 - o][h]] = l[h], u[s[h]] = h === 2 ? e[0] : i[s[h]];
...
var ke = ar, OI = C, pg = Math.min, zu = Math.max, kI = 12, BI = 6, NI = (
  /** @class */
  function(r) {
    N(t, r);
    function t() {
    ...
    return t.prototype.init = function(e, i) {
      ...
      var i = this.visualMapModel, n = this._shapes, a = i.itemSize, o = this._orient, s = this._useHandle, l = l_(i, this.api, a), u = n.mainGroup = this._createBarGroup(l), h = new xt();
      u.add(h), h.add(n.outOfRange = dg()), h.add(n.inRange = dg(null, s ? yg(this._orient) : null, j(this._dragHandle, this, "all", !1), j(this._dragHandle, this, "all", !0))), h.setClipPath(new _t({
        shape: {
          x: 0,
          y: 0,
          width: a[0],
      ...
      var f = i.textStyleModel.getTextRect("国"), v = zu(f.width, f.height);
      ...
      var l = j(this._dragHandle, this, n, !1), u = j(this._dragHandle, this, n, !0), h = Ve(e.get("handleSize"), a[0]), f = lr(e.get("handleIcon"), -h / 2, -h / 2, h, h, null, !0), v = yg(this._orient);
      f.attr({
        cursor: v,
        draggable: !0,
        drift: l,
        ...
        strokeNoScale: !0,
        strokeFirst: !0
      }), f.style.lineWidth *= 2, f.ensureState("emphasis").style = e.getModel(["emphasis", "handleStyle"]).getItemStyle(), Tf(f, !0), i.add(f);
      var c = this.visualMapModel.textStyleModel, p = new Mt({
        cursor: v,
        draggable: !0,
        drift: l,
        onmousemove: function(y) {
      ...
      var s = Ve(e.get("indicatorSize"), n[0]), l = lr(e.get("indicatorIcon"), -s / 2, -s / 2, s, s, null, !0);
      l.attr({
        cursor: "move",
        invisible: !0,
        silent: !0,
      ...
      if (l instanceof qe) {
        ...
        l.useStyle(u);
      i.add(l);
      var f = this.visualMapModel.textStyleModel, v = new Mt({
        silent: !0,
        invisible: !0,
        style: $e(f, {
          x: 0,
      ...
      this.group.add(v);
      var c = [(o === "horizontal" ? a / 2 : BI) + n[0] / 2, 0], p = this._shapes;
      ...
      if (this._useHandle) {
        ...
        }), i ? !this._hovering && this._clearHoverLinkToSeries() : gg(this.visualMapModel) && this._doHoverLinkToSeries(this._handleEnds[e], !1);
      }
      ...
      this._handleEnds = [ke(i[0], n, a, !0), ke(i[1], n, a, !0)];
      ...
      var s = n.getExtent();
      this._dataInterval = [ke(a[0], o, s, !0), ke(a[1], o, s, !0)];
      ...
      if (this._useHandle) {
        ...
        OI([0, 1], function(f) {
          ...
          var c = ke(e[f], [0, l[1]], u, !0), p = this.getControllerVisual(c, "symbolSize");
          v.scaleX = v.scaleY = p / l[0], v.x = l[0] - p / 2;
          var g = on(n.handleLabelPoints[f], Xo(v, this.group));
      ...
      if (f) {
        ...
        var v = {
          convertOpacityToAlpha: !0
        }, c = this.getControllerVisual(e, "color", v), p = this.getControllerVisual(e, "symbolSize"), g = ke(e, s, u, !0), d = l[0] - p / 2, y = {
          x: f.x,
          y: f.y
        };
        f.y = g, f.x = d;
        var m = on(h.indicatorLabelPoint, Xo(f, this.group)), _ = h.indicatorLabel;
        _.attr("invisible", !1);
        var S = this._applyTransform("left", h.mainGroup), w = this._orient, b = w === "horizontal";
        _.setStyle({
      ...
      this._shapes.mainGroup.on("mousemove", function(i) {
        if (e._hovering = !0, !e._dragging) {
          ...
          a[1] = pg(zu(0, a[1]), n[1]), e._doHoverLinkToSeries(a[1], 0 <= a[0] && a[0] <= n[0]);
        }
      ...
      if (n.option.hoverLink) {
        ...
        e = pg(zu(o[0], e), o[1]);
        var l = zI(n, s, o), u = [e - l, e + l], h = ke(e, o, s, !0), f = [ke(u[0], o, s, !0), ke(u[1], o, s, !0)];
        ...
        (i || gg(n)) && (c = this._hoverLinkDataIndices = n.findTargetDataIndices(f));
        var p = eb(v, c);
        this._dispatchHighDown("downplay", Jo(p[0], n)), this._dispatchHighDown("highlight", Jo(p[1], n));
      }
    }, t.prototype._hoverLinkFromSeriesMouseOver = function(e) {
      var i;
      if (Ji(e.target, function(l) {
        var u = it(l);
        if (u.dataIndex != null)
          return i = u, !0;
      }, !0), !!i) {
      ...
      this._dispatchHighDown("downplay", Jo(e, this.visualMapModel)), e.length = 0;
      ...
      var o = Xo(i, a ? null : this.group);
      return z(e) ? on(e, o, n) : zy(e, o, n);
...
function zI(r, t, e) {
  var i = kI / 2, n = r.get("hoverLinkDataSize");
  return n && (i = ke(n, t, e, !0) / 2), i;
}
function gg(r) {
...
}, VI = [
  {
    ...
    reset: function(r, t) {
      ...
      return t.eachComponent("visualMap", function(i) {
        ...
        !i.isTargetSeries(r) || n && n.large || e.push(yI(i.stateList, i.targetVisuals, j(i.getValueState, i), i.getDataDimensionIndex(r.getData())));
      }), e;
    }
  },
  // Only support color.
    ...
    reset: function(r, t) {
      ...
      t.eachComponent("visualMap", function(n) {
        if (n.isTargetSeries(r)) {
          var a = n.getVisualMeta(j(HI, null, r, n)) || {
            stops: [],
            outerColors: []
...
function GI(r) {
  var t = r && r.visualMap;
  z(t) || (t = t ? [t] : []), mg(t, function(e) {
    if (e) {
      Ui(e, "splitList") && !Ui(e, "pieces") && (e.pieces = e.splitList, delete e.splitList);
      var i = e.pieces;
      i && z(i) && mg(i, function(n) {
        V(n) && (Ui(n, "start") && !Ui(n, "min") && (n.min = n.start), Ui(n, "end") && !Ui(n, "max") && (n.max = n.end));
      });
    }
  });
}
...
var _g = !1;
function u_(r) {
  _g || (_g = !0, r.registerSubTypeDefaulter("visualMap", function(t) {
    return !t.categories && (!(t.pieces ? t.pieces.length > 0 : t.splitNumber > 0) || t.calculable) ? "continuous" : "piecewise";
  }), r.registerAction($I, FI), C(VI, function(t) {
    r.registerVisual(r.PRIORITY.VISUAL.COMPONENT, t);
  }), r.registerPreprocessor(GI));
}
function WI(r) {
  r.registerComponentModel(EI), r.registerComponentView(NI), u_(r);
}
var UI = (
  /** @class */
  function(r) {
    ...
    return t.prototype.optionUpdated = function(e, i) {
      ...
      this._pieceList = [], YI[this._mode].call(this, this._pieceList), this._resetSelected(e, i);
      var a = this.option.categories;
      this.resetVisual(function(o, s) {
        n === "categories" ? (o.mappingMethod = "category", o.categories = X(a)) : (o.dataExtent = this.getExtent(), o.mappingMethod = "piecewise", o.pieceList = W(this._pieceList, function(l) {
          return l = X(l), s !== "inRange" && (l.visual = null), l;
        }));
      });
    }, t.prototype.completeVisualOption = function() {
      var e = this.option, i = {}, n = Nt.listVisualTypes(), a = this.isCategory();
      C(e.pieces, function(s) {
        ...
        C(this.stateList, function(h) {
          ...
          (e[h] || (e[h] = {}))[l] = o_.get(l, h === "inRange" ? "active" : "inactive", a);
        });
      }, this);
      function o(s, l, u) {
      ...
      var i = Nt.findPieceIndex(e, this._pieceList);
    ...
    }, t.type = "visualMap.piecewise", t.defaultOption = Qs(Is.defaultOption, {
      selected: null,
      minOpen: !1,
      maxOpen: !1,
      align: "auto",
  ...
  pieces: function(r) {
    ...
    }, this), Sg(t, r), ev(r), C(r, function(e) {
...
var XI = (
  ...
  function(r) {
    ...
    return t.prototype.doRender = function() {
      var e = this.group;
      e.removeAll();
      var i = this.visualMapModel, n = i.get("textGap"), a = i.textStyleModel, o = a.getFont(), s = a.getTextColor(), l = this._getItemAlign(), u = i.itemSize, h = this._getViewData(), f = h.endsText, v = vn(i.get("showLabel", !0), !f), c = !i.get("selectedMode");
      f && this._renderEndsText(e, f[0], u, v, l), C(h.viewPieceList, function(p) {
        var g = p.piece, d = new xt();
        ...
        e.add(d);
      }, this), f && this._renderEndsText(e, f[1], u, v, l), hn(i.get("orient"), e, i.get("itemGap")), this.renderBackground(e), this.positionGroup(e);
      ...
      var e = this.visualMapModel, i = W(e.getPieceList(), function(s, l) {
        return {
          piece: s,
...
function qI(r) {
  r.registerComponentModel(UI), r.registerComponentView(XI), u_(r);
}
function ZI(r) {
  Ge(WI), Ge(qI);
}
function bg(r, t, e) {
  var i = Er.createCanvas(), n = t.getWidth(), a = t.getHeight(), o = i.style;
...
var $u = function(r) {
  ...
  function t(e, i, n) {
    ...
    var o;
    n = n || hs, typeof e == "string" ? o = bg(e, i, n) : V(e) && (o = e, e = o.id), a.id = e, a.dom = o;
    var s = o.style;
    return s && (Bg(o), o.onselectstart = function() {
      return !1;
  ...
  return t.prototype.getElementCount = function() {
    ...
    var e = this.dpr;
    this.domBack = bg("back-" + this.id, this.painter, e), this.ctxBack = this.domBack.getContext("2d"), e !== 1 && this.ctxBack.scale(e, e);
    ...
    function p(g, d, y, m) {
      if (o.clearRect(g, d, y, m), i && i !== "transparent") {
        ...
        if (ks(i)) {
          ...
          _ = S && i.__canvasGradient || Ch(o, i, {
            x: 0,
            y: 0,
            width: y,
            height: m
          }), i.__canvasGradient = _, i.__width = y, i.__height = m;
        } else p1(i) && (i.scaleX = i.scaleX || f, i.scaleY = i.scaleY || f, _ = Mh(o, i, {
          dirty: function() {
...
}(Xe), wg = 1e5, si = 314159, Bo = 0.01, KI = 1e-3;
function QI(r) {
...
var JI = function() {
  function r(t, e, i, n) {
    ...
    this._opts = i = B({}, i || {}), this.dpr = i.devicePixelRatio || hs, this._singleCanvas = a, this.root = t;
    var o = t.style;
    o && (Bg(t), t.innerHTML = ""), this.storage = e;
    ...
    if (a) {
      ...
      var c = new $u(h, this, this.dpr);
      c.__builtin__ = !0, c.initContext(), l[si] = c, c.zlevel = si, s.push(si), this._domRoot = t;
    } else {
      this._width = wo(t, 0, i), this._height = wo(t, 1, i);
      var u = this._domRoot = jI(this._width, this._height);
      t.appendChild(u);
    }
  }
  return r.prototype.getType = function() {
    ...
    if (i && i.clear(), !!e) {
      for (var n = {
        ...
        var s = t[o];
        s.__inHover && (i || (i = this._hoverlayer = this.getLayer(wg)), a || (a = i.ctx, a.save()), pi(a, s, n, o === e - 1));
      }
      a && a.restore();
    }
    ...
    var t = this.getLayer(si).ctx, e = this._domRoot.width, i = this._domRoot.height;
    ...
    for (var h = !0, f = !1, v = function(g) {
      var d = a[g], y = d.ctx, m = o && d.createRepaintRects(t, e, c._width, c._height), _ = i ? d.__startIndex : d.__drawIndex, S = !i && d.incremental && Date.now, w = S && Date.now(), b = d.zlevel === c._zlevelList[0] ? c._backgroundColor : null;
      if (d.__startIndex === d.__endIndex)
        d.clear(!1, b, m);
      else if (_ === d.__startIndex) {
        var x = t[_];
        (!x.incremental || !x.notClear || i) && d.clear(!1, b, m);
      }
      ...
      var M, D = function(L) {
        ...
        for (M = _; M < d.__endIndex; M++) {
          var R = t[M];
          if (R.__inHover && (f = !0), n._doPaintEl(R, d, o, L, P, M === d.__endIndex - 1), S) {
            var E = Date.now() - w;
            if (E > 15)
              break;
          }
    ...
    if (i) {
      ...
      (!n || l && l.intersect(n)) && (pi(s, t, a, o), t.setPrevPaintRect(l));
    } else
      pi(s, t, a, o);
  }, r.prototype.getLayer = function(t, e) {
    this._singleCanvas && !this._needsManuallyCompositing && (t = si);
    var i = this._layers[t];
    return i || (i = new $u("zr_" + t, this, this.dpr), i.zlevel = t, i.__builtin__ = !0, this._layerConfig[t] ? rt(i, this._layerConfig[t], !0) : this._layerConfig[t - Bo] && rt(i, this._layerConfig[t - Bo], !0), e && (i.virtual = e), this.insertLayer(t, i), i.initContext()), i;
    ...
    for (l = 0; l < t.length; l++) {
      ...
      s !== u && (s = u, o = 0), n.incremental ? (h = this.getLayer(u + KI, this._needsManuallyCompositing), h.incremental = !0, o = 1) : h = this.getLayer(u + (o > 0 ? Bo : 0), this._needsManuallyCompositing), h.__builtin__ || of("ZLevel " + u + " has been used by unkown layer " + h.id), h !== a && (h.__used = !0, h.__startIndex !== l && (h.__dirty = !0), h.__startIndex = l, h.incremental ? h.__drawIndex = -1 : h.__drawIndex = l, e(l), a = h), n.__dirty & te && !n.__inHover && (h.__dirty = !0, h.incremental && h.__drawIndex < 0 && (h.__drawIndex = l));
    }
    ...
    if (this._domRoot.style) {
      ...
      if (t != null && (n.width = t), e != null && (n.height = e), t = wo(a, 0, n), e = wo(a, 1, n), i.style.display = "", this._width !== t || e !== this._height) {
      ...
      if (t == null || e == null)
        return;
      this._width = t, this._height = e, this.getLayer(si).resize(t, e);
    }
    return this;
...
var rL = Object.defineProperty, iL = Object.getOwnPropertyDescriptor, sc = (r, t, e, i) => {
  for (var n = i > 1 ? void 0 : i ? iL(t, e) : t, a = r.length - 1, o; a >= 0; a--)
    (o = r[a]) && (n = (i ? o(t, e, n) : o(n)) || n);
  return i && n && rL(t, e, n), n;
};
Ge(eL);
let za = class extends ve {
  constructor() {
    super(...arguments), this.height = "280px";
  }
  firstUpdated() {
    const r = this.renderRoot.querySelector(".canvas");
    this.chart = wM(r, void 0, { renderer: "canvas" }), this.observer = new ResizeObserver(() => this.chart?.resize()), this.observer.observe(r), this.applyOption();
  }
  updated() {
    this.applyOption();
  }
  ...
  render() {
    return k`<div class="canvas" style="height:${this.height}"></div>`;
  }
};
za.styles = fr`
    :host { display: block; }
...
sc([
  yt({ attribute: !1 })
], za.prototype, "option", 2);
sc([
  yt({ type: String })
], za.prototype, "height", 2);
za = sc([
  kr("ia-chart")
], za);
const lc = fr`
...
`;
var nL = Object.defineProperty, aL = Object.getOwnPropertyDescriptor, vl = (r, t, e, i) => {
  for (var n = i > 1 ? void 0 : i ? aL(t, e) : t, a = r.length - 1, o; a >= 0; a--)
    (o = r[a]) && (n = (i ? o(t, e, n) : o(n)) || n);
  return i && n && nL(t, e, n), n;
};
let _n = class extends ve {
  constructor() {
  ...
  render() {
    ...
    return k`
      <section>
        ...
        ${r.sign_looks_inverted ? k`<p class="warn">
        ...
        <div class="cards">
          <div class="card">
            ...
            <span class="value">${gt(r.mean_charge_w, this.locale)}</span>
            <span class="row">
              <span>Of the time</span><span>${ct(r.share_charging, this.locale)}</span>
            </span>
          </div>
          <div class="card">
            <span class="name">Mean discharge power</span>
            <span class="value">${gt(r.mean_discharge_w, this.locale)}</span>
            <span class="row">
              <span>Of the time</span>
              <span>${ct(r.share_discharging, this.locale)}</span>
            </span>
          </div>
          <div class="card">
            <span class="name">Resting</span>
            <span class="value">${ct(r.share_idle, this.locale)}</span>
            <span class="row">
              <span>Below</span><span>${gt(r.idle_w, this.locale)}</span>
            </span>
          </div>
          <div class="card">
            <span class="name">Discharged</span>
            <span class="value">${wc(r.energy_out_kwh, this.locale)}</span>
            <span class="row">
              <span>Charged</span><span>${wc(r.energy_in_kwh, this.locale)}</span>
            </span>
          </div>
          <div class="card">
      ...
      r.cycles_per_day
            ...
            ${r.cycles_per_day === null ? k`<span class="row"><span>Needs the battery capacity</span></span>` : U}
          </div>
        </div>

        ${r.cycles_per_day === null && !this.hasCapacity ? k`<p class="note">
...
_n.styles = [lc, fr`:host { display: block; }`];
vl([
  yt({ attribute: !1 })
], _n.prototype, "flow", 2);
vl([
  yt({ type: Boolean })
], _n.prototype, "hasCapacity", 2);
vl([
  yt({ type: String })
], _n.prototype, "locale", 2);
_n = vl([
  kr("ia-charge-section")
], _n);
var oL = Object.defineProperty, sL = Object.getOwnPropertyDescriptor, Mi = (r, t, e, i) => {
  for (var n = i > 1 ? void 0 : i ? sL(t, e) : t, a = r.length - 1, o; a >= 0; a--)
    (o = r[a]) && (n = (i ? o(t, e, n) : o(n)) || n);
  return i && n && oL(t, e, n), n;
};
let ur = class extends ve {
  constructor() {
  ...
  async load() {
    ...
    try {
      const { start: t, end: e } = tf(this.range, /* @__PURE__ */ new Date()), i = await B_(this.hass, this.entryId, t, e);
  ...
  renderKpi(r) {
    const t = this.hass.locale.language, e = r.dips_measurable, i = "—", n = [
      ["Mean charge", ct(li(r.kpi.mean_soc), t), "over the whole period"],
      [
        "Lowest charge",
        e ? ct(li(r.kpi.min_soc), t) : i,
        e ? "exact data only" : "needs exact data"
      ],
      [
        `Below ${ct(li(r.low_pct), t)}`,
        e ? tn(r.kpi.seconds_below_low) : i,
        e ? "exact data only" : "needs exact data"
      ],
      [
        "Dips",
      ...
      [
        "Mean low point",
        e ? ct(li(r.kpi.mean_low_point), t) : i,
        e ? "across those dips" : "needs exact data"
      ]
    ];
    return k`<div class="kpi">
      ${n.map(
      ([a, o, s]) => k`<div class="cell">
  ...
  renderEpisodes(r) {
    ...
    return r.dips_measurable ? r.episodes.length ? k`<table>
      <thead>
      ...
      (e) => k`<tr>
            ...
            <td>${tn(e.seconds)}</td>
            <td>${ct(li(e.lowest), t)}</td>
            <td>${ct(li(e.recovered_to), t)}</td>
          </tr>`
    )}
      </tbody>
    </table>` : k`<p class="empty">
        The charge never stayed below ${ct(li(r.low_pct), t)} for more than
  ...
  render() {
    if (this.error)
      return k`<div class="notice">
        Could not load data: ${this.error}
        <button @click=${() => this.load()}>Try again</button>
      </div>`;
    if (!this.payload)
      return k`<div class="notice">Computing…</div>`;
    const r = this.payload, t = this.hass.locale.language, e = rs(r.coverage, t);
    return k`
      <div class="status">
        <span class="badge">${Jh(r.precision, r.boundary, t)}</span>
        ${e ? k`<span class="warn">${e}</span>` : U}
        ${r.clamped ? k`<span class="warn">Period shortened to the maximum allowed</span>` : U}
        ${r.raw_from && r.dips_restricted && r.dips_measurable ? k`<span class="warn">
              Dips counted from ${new Date(r.raw_from).toLocaleDateString(t)}, where
              exact data begins
            </span>` : U}
        ${this.loading ? k`<span class="warn">Refreshing…</span>` : U}
      </div>
      ...
      <section>
        ...
        <ia-chart .option=${Z_(r.bands)} height="220px"></ia-chart>
      </section>
      ...
      ${r.power ? k`<ia-charge-section
            .flow=${r.power}
            .hasCapacity=${r.has_capacity}
            .locale=${t}
          ></ia-charge-section>` : k`<section>
            <h2>Charging and discharging</h2>
            <p class="empty">
...
var lL = Object.defineProperty, uL = Object.getOwnPropertyDescriptor, pl = (r, t, e, i) => {
  for (var n = i > 1 ? void 0 : i ? uL(t, e) : t, a = r.length - 1, o; a >= 0; a--)
    (o = r[a]) && (n = (i ? o(t, e, n) : o(n)) || n);
...
let Sn = class extends ve {
  ...
  renderCards() {
    ...
    return k`<div class="cards">
      ${this.phases.per_phase.map((t) => {
      const e = this.series[t.key]?.coverage;
      return k`<div class="card">
          <span class="name">${t.label}</span>
          <span class="value">${gt(t.mean, this.locale)}</span>
          <span class="row"><span>Peak</span><span>${gt(t.peak, this.locale)}</span></span>
          <span class="row"><span>P95</span><span>${gt(t.p95, this.locale)}</span></span>
          <span class="row"><span>Share of load</span><span>${ct(t.share, this.locale)}</span></span>
          <span class="row">
            <span>Peak vs ${gt(r, this.locale)}</span>
            <span>${ct(t.headroom, this.locale)}</span>
          </span>
          ${e !== void 0 && e < 0.95 ? k`<span class="warn">Covers ${aa(e, this.locale)} of the period</span>` : U}
        </div>`;
    })}
    </div>`;
  }
  renderImbalance() {
    ...
    return r.mean === null ? k`<p class="empty">
        Total load never rose above ${gt(r.floor_w, this.locale)}, so there was
      ...
      <ia-chart .option=${Y_(r)}></ia-chart>
      <p class="note">
        Measured over ${tn(r.analysed_seconds)}
        (${aa(r.coverage, this.locale)} of the period).${r.below_floor_seconds > 0 ? k` A further ${tn(r.below_floor_seconds)} sat below
              ${gt(r.floor_w, this.locale)} of total load and is excluded: at
              standby power a few watts of difference is a large percentage and means nothing.` : U}
      </p>
    `;
  }
  renderEpisodes() {
    const { episodes: r, per_phase: t } = this.phases;
    return r.length ? k`<table>
      <thead>
        <tr>
          <th>Start</th>
          <th>Duration</th>
          <th>Worst</th>
          ${t.map((e) => k`<th>${e.label}</th>`)}
        </tr>
      </thead>
      <tbody>
        ${r.map(
      (e) => k`<tr>
            ...
            ${e.phases.map((i) => k`<td>${gt(i, this.locale)}</td>`)}
          </tr>`
    )}
      </tbody>
    </table>` : k`<p class="empty">No sustained imbalance in this period.</p>`;
  }
  render() {
...
Sn.styles = [lc, fr`:host { display: block; }`];
pl([
  yt({ attribute: !1 })
], Sn.prototype, "phases", 2);
pl([
  yt({ attribute: !1 })
], Sn.prototype, "series", 2);
pl([
  yt({ type: String })
], Sn.prototype, "locale", 2);
Sn = pl([
  kr("ia-phases-section")
], Sn);
var hL = Object.defineProperty, fL = Object.getOwnPropertyDescriptor, dl = (r, t, e, i) => {
  for (var n = i > 1 ? void 0 : i ? fL(t, e) : t, a = r.length - 1, o; a >= 0; a--)
    (o = r[a]) && (n = (i ? o(t, e, n) : o(n)) || n);
  return i && n && hL(t, e, n), n;
};
  ...
  render() {
    ...
    return k`
      ...
      return k`<div class="card">
              ...
              <span class="value">${gt(e.mean, this.locale)}</span>
              <span class="row"><span>Peak</span><span>${gt(e.peak, this.locale)}</span></span>
              <span class="row"><span>Share of PV</span><span>${ct(e.share, this.locale)}</span></span>
              ${i !== void 0 && i < 0.95 ? k`<span class="warn">Covers ${aa(i, this.locale)} of the period</span>` : U}
            </div>`;
    })}
        </div>
        <ia-chart .option=${X_(r, mt.pv)}></ia-chart>
        ${t < 0.95 ? k`<p class="warn">
              All strings had data at the same moment for only
              ${aa(t, this.locale)} of the period, so the shares are of
...
bn.styles = [lc, fr`:host { display: block; }`];
dl([
  yt({ attribute: !1 })
], bn.prototype, "strings", 2);
dl([
  yt({ attribute: !1 })
], bn.prototype, "series", 2);
dl([
  yt({ type: String })
], bn.prototype, "locale", 2);
bn = dl([
  kr("ia-strings-section")
], bn);
var cL = Object.defineProperty, vL = Object.getOwnPropertyDescriptor, Br = (r, t, e, i) => {
  for (var n = i > 1 ? void 0 : i ? vL(t, e) : t, a = r.length - 1, o; a >= 0; a--)
    (o = r[a]) && (n = (i ? o(t, e, n) : o(n)) || n);
...
let We = class extends ve {
  ...
  async load() {
    ...
    this.loading = !0, this.error = void 0;
    try {
      const { start: t, end: e } = tf(this.range, /* @__PURE__ */ new Date()), i = await k_(this.hass, this.entryId, t, e);
      if (r !== this.requestId) return;
      this.payload = i;
    } catch (t) {
      if (r !== this.requestId) return;
  ...
  renderConsistency(r, t, e) {
    if (!r?.beyond_margin) return U;
    const i = this.hass.locale.language;
    return k`<span class="warn">
      ${t} averages ${gt(r.total_mean, i)} while ${e} add up to
      ${gt(r.parts_mean, i)}. Is one of them mapped to the wrong sensor?
    </span>`;
  }
  renderKpi(r) {
    const t = this.hass.locale.language, e = (n) => n === null ? "" : ct(n / r.rated_power, t) + " of rated", i = [
      ["Mean", gt(r.kpi.mean, t), e(r.kpi.mean)],
      ["Median", gt(r.kpi.median, t), ""],
      ["P95", gt(r.kpi.p95, t), ""],
      ["Peak", gt(r.kpi.max, t), e(r.kpi.max)],
      ["Sustained 15 min", gt(r.kpi.max_sustained_15m, t), ""],
      [">80% of rated", ct(r.kpi.fraction_above_80pct, t), "of time"]
    ];
    return k`<div class="kpi">
      ${i.map(
      ([n, a, o]) => k`<div class="cell">
  ...
  renderOverloads(r) {
    if (!r.overloads.length)
      return k`<p class="empty">No overloads in this period.</p>`;
    const t = this.hass.locale.language;
    return k`<table>
      <thead>
  ...
  render() {
    ...
    return k`
      <div class="status">
        <span class="badge">${Jh(r.precision, r.boundary, t)}</span>
        ${rs(r.coverage, t) ? k`<span class="warn">${rs(r.coverage, t)}</span>` : U}
        ${r.clamped ? k`<span class="warn">Period shortened to the maximum allowed</span>` : U}
        ${r.histogram.clipped_low_seconds + r.histogram.clipped_high_seconds > 0 ? k`<span class="warn">
      ...
      this.mode = this.mode === "watts" ? "percent" : "watts";
        ...
        <ia-chart .option=${G_(r, this.mode)}></ia-chart>
      </section>

      <section>
        <h2>Load duration curve</h2>
        <ia-chart .option=${W_(r)}></ia-chart>
      </section>

      <section>
        <h2>Distribution across rated-power bands</h2>
        <ia-chart .option=${U_(r)} height="220px"></ia-chart>
      </section>
      ...
      ${r.phases ? k`<ia-phases-section
            .phases=${r.phases}
            .series=${r.series}
            .locale=${t}
          ></ia-phases-section>` : U}

      ${r.strings ? k`<ia-strings-section
            .strings=${r.strings}
            .series=${r.series}
            .locale=${t}
          ></ia-strings-section>` : U}
    `;
  }
};
We.styles = fr`
...
Br([
  yt({ type: String })
], We.prototype, "entryId", 2);
Br([
  yt({ type: String })
], We.prototype, "range", 2);
Br([
  Ht()
], We.prototype, "payload", 2);
Br([
  Ht()
...
var pL = Object.defineProperty, dL = Object.getOwnPropertyDescriptor, Di = (r, t, e, i) => {
...
let hr = class extends ve {
  ...
  async load() {
    ...
    this.loading = !0, this.error = void 0;
    try {
      const { start: t, end: e } = tf(this.range, /* @__PURE__ */ new Date()), i = await N_(this.hass, this.entryId, t, e);
      if (r !== this.requestId) return;
      this.payload = i;
    } catch (t) {
      if (r !== this.requestId) return;
    ...
    return k`<table>
      <thead>
        <tr>
          ...
          <th>Mean load</th>
          <th>Busiest hour</th>
          ${r.has_pv ? k`<th>Mean PV</th>` : U}
          <th>Of the month</th>
        </tr>
      </thead>
      <tbody>
        ${r.months.map(
      (i, n) => k`<tr class=${i.complete ? "" : "partial"}>
            <td>${ef(i.key, e[n - 1])}</td>
            <td>${gt(i.load_mean, t)}</td>
            <td>${gt(i.load_peak_hourly, t)}</td>
            ${r.has_pv ? k`<td>${gt(i.pv_mean, t)}</td>` : U}
            <td>${ct(i.coverage, t)}</td>
          </tr>`
    )}
      </tbody>
    </table>`;
  ...
  render() {
    ...
    if (!this.payload)
      return k`<div class="notice">Computing…</div>`;
    const r = this.payload, t = this.hass.locale.language, e = rs(r.coverage, t), i = r.months.filter((a) => !a.complete && a.load_mean !== null), n = r.months.filter((a) => a.load_mean === null);
    return k`
      <div class="status">
        <span class="badge">${Jh(r.precision, r.boundary, t)}</span>
      ...
      <section>
        ...
        <ia-chart .option=${K_(r.months, r.has_pv)}></ia-chart>
        ${i.length ? k`<p class="note">
              ${i.length === 1 ? k`One month is covered by less than
                    ${ct(r.incomplete_below, t)} of its days and is drawn in
                    grey.` : k`${i.length} months are covered by less than
                    ${ct(r.incomplete_below, t)} of their days and are drawn
                    in grey.`}
              A month the recorder only saw part of is not a lower month; the figures stand, the
              comparison does not.
            </p>` : U}
        ${n.length ? k`<p class="note">
      ...
      <section>
        ...
        <ia-chart .option=${Q_(r.hours, r.has_pv)}></ia-chart>
        <p class="note">
...
Di([
  yt({ type: String })
], hr.prototype, "entryId", 2);
Di([
  yt({ type: String })
], hr.prototype, "range", 2);
Di([
  Ht()
], hr.prototype, "payload", 2);
Di([
  Ht()
], hr.prototype, "error", 2);
Di([
  Ht()
], hr.prototype, "loading", 2);
hr = Di([
  kr("ia-seasonality-tab")
], hr);
var gL = Object.defineProperty, yL = Object.getOwnPropertyDescriptor, pr = (r, t, e, i) => {
  for (var n = i > 1 ? void 0 : i ? yL(t, e) : t, a = r.length - 1, o; a >= 0; a--)
    (o = r[a]) && (n = (i ? o(t, e, n) : o(n)) || n);
  return i && n && gL(t, e, n), n;
};
const mL = "/inverter-analytics", xg = [
  { id: "load", label: "Load" },
...
let Ie = class extends ve {
  constructor() {
    ...
    }, this.loadConfig = $_(() => this.requestConfig());
  }
  connectedCallback() {
  ...
  async requestConfig() {
    try {
      this.config = await O_(this.hass), this.config.entries.some((t) => t.entry_id === this.entryId) || (this.entryId = this.config.entries[0]?.entry_id), this.writeLocation();
    } catch (r) {
      this.error = Es(r);
    }
  }
  ...
  render() {
    return this.error ? k`<div class="notice">
      ...
      </div>` : this.config ? this.config.entries.length ? k`
      <div class="header">
        <h1>Inverter Analytics</h1>
        ${this.config.entries.length > 1 ? k`<select
              @change=${(r) => {
      ...
      <main>
        ${this.tab === "load" ? k`<ia-load-tab
              .hass=${this.hass}
              .entryId=${this.entryId}
              .range=${this.range}
            ></ia-load-tab>` : U}
        ${this.tab === "battery" ? k`<ia-battery-tab
              .hass=${this.hass}
              .entryId=${this.entryId}
              .range=${this.range}
            ></ia-battery-tab>` : U}
        ${this.tab === "seasonal" ? k`<ia-seasonality-tab
              .hass=${this.hass}
              .entryId=${this.entryId}
              .range=${this.range}
            ></ia-seasonality-tab>` : U}
        ${["load", "battery", "seasonal"].includes(this.tab) ? U : k`<div class="notice">This tab is not built yet.</div>`}
      </main>
    ` : k`<div class="notice">
        No inverter is configured yet. Add the Inverter Analytics integration in settings.
      </div>` : k`<div class="notice">Loading…</div>`;
  }
};
Ie.styles = fr`
    :host {
...
pr([
  yt({ type: Boolean })
], Ie.prototype, "narrow", 2);
pr([
  yt({ attribute: !1 })
], Ie.prototype, "route", 2);
pr([
  Ht()
...
pr([
  Ht()
], Ie.prototype, "entryId", 2);
pr([
  Ht()
], Ie.prototype, "tab", 2);
pr([
  Ht()
], Ie.prototype, "range", 2);
Ie = pr([
  kr("inverter-analytics-panel")
], Ie);
export {
  Ie as InverterAnalyticsPanel
};
